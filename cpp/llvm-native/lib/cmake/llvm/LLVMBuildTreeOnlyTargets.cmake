...
foreach(_expectedTarget LLVMHello LLVMTestingSupport FileCheck llvm-PerfectShuffle count not UnicodeNameMappingGenerator yaml-bench split-file llvm_gtest llvm_gtest_main SampleAnalyzerPlugin CheckerDependencyHandlingAnalyzerPlugin CheckerOptionHandlingAnalyzerPlugin BugpointPasses lli-child-target llvm-jitlink-executor obj2yaml yaml2obj Bye TestPlugin DoublerPlugin)
...
set_target_properties(llvm_gtest PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "/home/luca/learnhardcode/cpp/emception/upstream/llvm-project/llvm/utils/unittest/googletest/include;/home/luca/learnhardcode/cpp/emception/upstream/llvm-project/llvm/utils/unittest/googlemock/include"
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/LLVMHello.so"
...
set_target_properties(LLVMTestingSupport PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/libLLVMTestingSupport.a"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/not"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/UnicodeNameMappingGenerator"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/yaml-bench"
  )
...
set_target_properties(split-file PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/split-file"
  )
...
set_target_properties(llvm_gtest PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/libllvm_gtest.a"
  )
...
set_target_properties(llvm_gtest_main PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/libllvm_gtest_main.a"
  )
...
set_target_properties(SampleAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/SampleAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerDependencyHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/CheckerDependencyHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerOptionHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/CheckerOptionHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/bin/yaml2obj"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/lib/Bye.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(DoublerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/luca/learnhardcode/cpp/emception/build/llvm-native/unittests/Passes/DoublerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
