...
execute_process(
  COMMAND "/usr/bin/git" show-ref 9cee4b4d27271d54b95f6f42bfdc534ebeaaeb72
  WORKING_DIRECTORY "/home/luca/learnhardcode/cpp/emception/build/quicknode/_deps/upstream_quickjspp-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/9cee4b4d27271d54b95f6f42bfdc534ebeaaeb72")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "9cee4b4d27271d54b95f6f42bfdc534ebeaaeb72")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "9cee4b4d27271d54b95f6f42bfdc534ebeaaeb72")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 9cee4b4d27271d54b95f6f42bfdc534ebeaaeb72
  WORKING_DIRECTORY "/home/luca/learnhardcode/cpp/emception/build/quicknode/_deps/upstream_quickjspp-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/ftk/quickjspp.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/luca/learnhardcode/cpp/emception/build/quicknode/_deps/upstream_quickjspp-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/luca/learnhardcode/cpp/emception/build/quicknode/_deps/upstream_quickjspp-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
