/* Generated automatically from /home/luca/learnhardcode/cpp/emception/upstream/cpython/Modules/config.c.in by makesetup. */
/* -*- C -*- ***********************************************
...
extern PyObject* PyInit__emception(void);
