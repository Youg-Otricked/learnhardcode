...
const ih = 8205;
function Fm(i, e, t = !0, n = !0) {
  return (t ? _f : jm)(i, e, n);
}
function _f(i, e, t) {
  if (e == i.length) return e;
  e && Bf(i.charCodeAt(e)) && If(i.charCodeAt(e - 1)) && e--;
  let n = Vo(i, e);
  for (e += nh(n); e < i.length; ) {
    let r = Vo(i, e);
    if (n == ih || r == ih || (t && qm(r))) ((e += nh(r)), (n = r));
    else if (th(r)) {
      let s = 0,
        o = e - 2;
      for (; o >= 0 && th(Vo(i, o)); ) (s++, (o -= 2));
      if (s % 2 == 0) break;
      e += 2;
    } else break;
  }
...
function Vo(i, e) {
  ...
  if (!If(t) || e + 1 == i.length) return t;
  let n = i.charCodeAt(e + 1);
  return Bf(n) ? ((t - 55296) << 10) + (n - 56320) + 65536 : t;
}
function Bf(i) {
...
class ee {
  ...
  replace(e, t, n) {
    ...
    return (
      ...
      _t.from(r, this.length - (t - e) + n.length)
    );
  }
  append(e) {
...
class Ce extends ee {
  ...
  decompose(e, t, n, r) {
    ...
    if (r & 1) {
      let o = n.pop(),
        l = Ws(s.text, o.text.slice(), 0, s.length);
  ...
  replace(e, t, n) {
    ...
    [e, t] = yn(this, e, t);
    let r = Ws(this.text, Ws(n.text, rh(this.text, 0, e)), t),
      s = this.length + n.length - (t - e);
    return r.length <= 32 ? new Ce(r, s) : _t.from(Ce.split(r, []), s);
  }
  sliceString(
    e,
    t = this.length,
...
`,
  ...
  static split(e, t) {
    ...
    for (let s of e)
      (n.push(s),
        (r += s.length + 1),
        n.length == 32 && (t.push(new Ce(n, r)), (n = []), (r = -1)));
...
class _t extends ee {
  ...
  replace(e, t, n) {
    if ((([e, t] = yn(this, e, t)), n.lines < this.lines))
      for (let r = 0, s = 0; r < this.children.length; r++) {
        let o = this.children[r],
          l = s + o.length;
        if (e >= s && t <= l) {
          let a = o.replace(e - s, t - s, n),
            c = this.lines - o.lines + a.lines;
          if (a.lines < c >> 4 && a.lines > c >> 6) {
            let h = this.children.slice();
            return ((h[r] = a), new _t(h, this.length - (t - e) + n.length));
          }
...
`,
    ...
    for (let s = 0, o = 0; s < this.children.length && o <= t; s++) {
      let l = this.children[s],
        a = o + l.length;
      (o > e && s && (r += n),
        e < a && t > o && (r += l.sliceString(e - o, t - o, n)),
        (o = a + 1));
    }
    return r;
  }
  ...
  static from(e, t = e.reduce((n, r) => n + r.length + 1, -1)) {
    ...
    function u(d) {
      let g;
      if (d.lines > s && d instanceof _t) for (let p of d.children) u(p);
      else
        d.lines > o && (a > o || !a)
          ? (f(), l.push(d))
          : d instanceof Ce &&
              a &&
              (g = h[h.length - 1]) instanceof Ce &&
              d.lines + g.lines <= 32
            ? ((a += d.lines),
              (c += d.length + 1),
              (h[h.length - 1] = new Ce(
    ...
    function f() {
      a != 0 &&
        (l.push(h.length == 1 ? h[0] : _t.from(h, c)),
        (c = -1),
        (a = h.length = 0));
    }
    for (let d of e) u(d);
  ...
  nextInner(e, t) {
    for (this.done = this.lineBreak = !1; ; ) {
      let n = this.nodes.length - 1,
        ...
        s = this.offsets[n],
        o = s >> 1,
        l = r instanceof Ce ? r.text.length : r.children.length;
      if (o == (t > 0 ? l : 0)) {
        ...
        e > a.length
          ...
          : (t < 0 && this.offsets[n]--,
            ...
            this.offsets.push(
              t > 0
                ? 1
                : (a instanceof Ce ? a.text.length : a.children.length) << 1,
            ));
      }
    }
  }
...
typeof Symbol < "u" &&
  ...
  (fr.prototype[Symbol.iterator] =
    qf.prototype[Symbol.iterator] =
    Ff.prototype[Symbol.iterator] =
      function () {
        return this;
      }));
class Wm {
...
function tt(i, e) {
  let t = i.charCodeAt(e);
  if (!zm(t) || e + 1 == i.length) return t;
  let n = i.charCodeAt(e + 1);
  return Vm(n) ? ((t - 55296) << 10) + (n - 56320) + 65536 : t;
}
function yc(i) {
  return i <= 65535
...
class Ht {
  ...
  composeDesc(e) {
    return this.empty ? e : e.empty ? this : jf(this, e);
  }
  mapDesc(e, t = !1) {
    return e.empty ? this : Sl(this, e, t);
  }
  mapPos(e, t = -1, n = Xe.Simple) {
    let r = 0,
      s = 0;
...
class Te extends Ht {
  ...
  apply(e) {
    ...
    return (
      wl(this, (t, n, r, s, o) => (e = e.replace(r, r + (n - t), o)), !1),
      e
    );
  }
  mapDesc(e, t = !1) {
  ...
  invert(e) {
    ...
    for (let r = 0, s = 0; r < t.length; r += 2) {
      ...
      if (l >= 0) {
        ((t[r] = l), (t[r + 1] = o));
        let a = r >> 1;
        for (; n.length < a; ) n.push(ee.empty);
        n.push(o ? e.slice(s, s + o) : ee.empty);
      }
      s += o;
    }
    return new Te(t, n);
  ...
  compose(e) {
    return this.empty ? e : e.empty ? this : jf(this, e, !0);
  }
  map(e, t = !1) {
  ...
  filter(e) {
    ...
    e: for (let o = 0, l = 0; ; ) {
      ...
      for (; l < a || (l == a && s.len == 0); ) {
        ...
        (We(t, h, u), u > 0 && yi(n, t, s.text), s.forward(h), (l += h));
      }
      let c = e[o++];
      for (; l < c; ) {
        if (s.done) break e;
        ...
        (We(t, h, -1),
          We(r, h, s.ins == -1 ? -1 : s.off == 0 ? s.ins : 0),
          s.forward(h),
          (l += h));
      }
    }
    return { changes: new Te(t, n), filtered: Ht.create(r) };
  }
  toJSON() {
    let e = [];
    for (let t = 0; t < this.sections.length; t += 2) {
  ...
  static of(e, t, n) {
    ...
    function c(h) {
      if (Array.isArray(h)) for (let u of h) c(u);
        ...
        if (u > f || u < 0 || f > t)
          throw new RangeError(
            `Invalid change range ${u} to ${f} (in doc of length ${t})`,
          );
        let g = d
            ? typeof d == "string"
              ? ee.of(d.split(n || vl))
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      if (typeof s == "number") t.push(s, -1);
        ...
        if (s.length == 1) t.push(s[0], 0);
          ...
          for (; n.length < r; ) n.push(ee.empty);
          ((n[r] = ee.of(s.slice(1))), t.push(s[0], n[r].length));
        }
      }
    }
    return new Te(t, n);
...
function yi(i, e, t) {
  ...
  if (n < i.length) i[i.length - 1] = i[i.length - 1].append(t);
    ...
    for (; i.length < n; ) i.push(ee.empty);
    i.push(t);
  }
}
function wl(i, e, t) {
...
function Sl(i, e, t, n = !1) {
  ...
  for (let a = -1; ; ) {
    ...
    if (o.ins == -1 && l.ins == -1) {
      ...
      (We(r, c, -1), o.forward(c), l.forward(c));
    } else if (
      l.ins >= 0 &&
      (o.ins < 0 ||
        a == o.i ||
      ...
      for (We(r, l.ins, -1); c; ) {
        ...
        (o.ins >= 0 &&
          a < o.i &&
          o.len <= h &&
          (We(r, 0, o.ins), s && yi(s, r, o.text), (a = o.i)),
          o.forward(h),
          (c -= h));
      }
      l.next();
      ...
      (We(r, c, a < o.i ? o.ins : 0),
        s && a < o.i && yi(s, r, o.text),
        (a = o.i),
        o.forward(o.len - h));
    } else {
      if (o.done && l.done) return s ? Te.createSet(r, s) : Ht.create(r);
      throw new Error("Mismatched change set lengths");
    }
  }
}
function jf(i, e, t = !1) {
  let n = [],
    ...
    o = new br(e);
  for (let l = !1; ; ) {
    if (s.done && o.done) return r ? Te.createSet(n, r) : Ht.create(n);
    if (s.ins == 0) (We(n, s.len, 0, l), s.next());
    else if (o.len == 0 && !o.done)
      (We(n, 0, o.ins, l), r && yi(r, n, o.text), o.next());
    else {
      if (s.done || o.done) throw new Error("Mismatched change set lengths");
      {
        ...
        if (s.ins == -1) {
          ...
          (We(n, a, h, l), r && h && yi(r, n, o.text));
        } else
          o.ins == -1
            ? (We(n, s.off ? 0 : s.len, a, l), r && yi(r, n, s.textBit(a)))
            : (We(n, s.off ? 0 : s.len, o.off ? 0 : o.ins, l),
              r && !o.off && yi(r, n, o.text));
        ((l = (s.ins > a || (o.ins >= 0 && o.len > a)) && (l || n.length > c)),
          s.forward2(a),
          o.forward(a));
      }
    }
...
let gs = class kl {
  ...
  map(e, t = -1) {
    ...
    return (
      ...
      n == this.from && r == this.to ? this : new kl(n, r, this.flags)
    );
  }
  extend(e, t = e) {
...
class M {
  ...
  static create(e, t = 0) {
    ...
    for (let n = 0, r = 0; r < e.length; r++) {
      let s = e[r];
      if (s.empty ? s.from <= n : s.from < n) return M.normalized(e.slice(), t);
      n = s.to;
    }
    return new M(e, t);
  }
  ...
  static normalized(e, t = 0) {
    ...
    for (let r = 1; r < e.length; r++) {
      ...
      if (s.empty ? s.from <= o.to : s.from < o.to) {
        ...
        (r <= t && t--,
          e.splice(--r, 2, s.anchor > s.head ? M.range(a, l) : M.range(l, a)));
      }
    }
    return new M(e, t);
  }
...
class I {
  ...
  static define(e = {}) {
    return new I(
      ...
      e.compare || (e.combine ? (t, n) => t === n : vc),
      !!e.static,
      e.enables,
    );
  }
  of(e) {
    return new Vs([], this, 0, e);
  }
  compute(e, t) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new Vs(e, this, 1, t);
  }
  computeN(e, t) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new Vs(e, this, 2, t);
  }
  from(e, t) {
  ...
  dynamicSlot(e) {
    ...
    return {
      ...
      update(u, f) {
        if (
          (a && f.docChanged) ||
          (c && (f.docChanged || f.selection)) ||
          Cl(u, h)
        ) {
          let d = n(u);
          if (l ? !sh(d, u.values[o], r) : !r(d, u.values[o]))
          ...
          if (
            this.dependencies.every((b) =>
              b instanceof I
                ? f.facet(b) === u.facet(b)
                : b instanceof Ee
                  ? f.field(b, !1) == u.field(b, !1)
                  : !0,
            ) ||
            (l ? sh((d = n(u)), p, r) : r((d = n(u)), p))
          )
  ...
  return {
    ...
    reconfigure(a, c) {
      let h = Cl(a, n),
        ...
        f = c.facet(e);
      if (u && !h && vc(t, u)) return ((a.values[o] = f), 0);
      let d = l(a);
      return e.compare(d, f) ? ((a.values[o] = f), 0) : ((a.values[o] = d), 1);
    },
  };
}
const ms = I.define({ static: !0 });
class Ee {
  constructor(e, t, n, r, s) {
    ((this.id = e),
      (this.createF = t),
    ...
    return {
      ...
      reconfigure: (n, r) => {
        ...
        return (l = s.find((a) => a.field == this)) &&
          ...
          ? ((n.values[t] = l.create(n)), 1)
          : r.config.address[this.id] != null
            ? ((n.values[t] = r.field(this)), 0)
...
const Ti = {
  highest: Vn(zi.highest),
  high: Vn(zi.high),
  default: Vn(zi.default),
  low: Vn(zi.low),
  lowest: Vn(zi.lowest),
};
class Wf {
...
class Ao {
  ...
  reconfigure(e) {
    return Ao.reconfigure.of({ compartment: this, extension: e });
  }
  get(e) {
  ...
  static resolve(e, t, n) {
    ...
    for (let f in s) {
      ...
      if (d.every((b) => b.type == 0))
        if (((l[g.id] = (a.length << 1) | 1), vc(p, d))) a.push(n.facet(g));
        else {
          let b = g.combine(d.map((v) => v.value));
          a.push(n && g.compare(b, n.facet(g)) ? n.facet(g) : b);
        }
      else {
        for (let b of d)
          b.type == 0
            ? ((l[b.id] = (a.length << 1) | 1), a.push(b.value))
            : ((l[b.id] = c.length << 1), c.push((v) => b.dynamicSlot(v)));
        ((l[g.id] = c.length << 1), c.push((b) => $m(b, g, d)));
      }
    }
    let u = c.map((f) => f(l));
...
function Um(i, e, t) {
  ...
  function s(o, l) {
    ...
    if (a != null) {
      if (a <= l) return;
      let c = n[a].indexOf(o);
      (c > -1 && n[a].splice(c, 1), o instanceof xl && t.delete(o.compartment));
    }
    ...
    } else if (o instanceof Wf) s(o.inner, o.prec);
    else if (o instanceof Ee) (n[l].push(o), o.provides && s(o.provides, l));
    else if (o instanceof Vs)
      (n[l].push(o), o.facet.extensions && s(o.facet.extensions, zi.default));
    else {
      let c = o.extension;
      if (!c)
        throw new Error(
  ...
  return (s(i, zi.default), n.reduce((o, l) => o.concat(l)));
}
function dr(i, e) {
  if (e & 1) return 2;
  let t = e >> 1,
...
const Vf = I.define(),
  Ml = I.define({ combine: (i) => i.some((e) => e), static: !0 }),
  zf = I.define({ combine: (i) => (i.length ? i[0] : void 0), static: !0 }),
  $f = I.define(),
  Uf = I.define(),
  Kf = I.define(),
  Gf = I.define({ combine: (i) => (i.length ? i[0] : !1) });
class ui {
  constructor(e, t) {
...
class Re {
  constructor(e, t, n, r, s, o) {
    ((this.startState = e),
      ...
      (this._state = null),
      n && Hf(n, t.newLength),
      s.some((l) => l.type == Re.time) ||
        (this.annotations = s.concat(Re.time.of(Date.now()))));
  }
  static create(e, t, n, r, s, o) {
    return new Re(e, t, n, r, s, o);
  }
  get newDoc() {
...
Re.time = ui.define();
Re.userEvent = ui.define();
Re.addToHistory = ui.define();
Re.remote = ui.define();
function Jm(i, e) {
  let t = [];
  for (let n = 0, r = 0; ; ) {
...
function Jf(i, e, t) {
  ...
  return (
    t
      ? ((r = e.changes),
        (s = Te.empty(e.changes.length)),
        (o = i.changes.compose(e.changes)))
      : ((r = e.changes.map(i.changes)),
        (s = i.changes.mapDesc(e.changes, !0)),
        (o = i.changes.compose(r))),
    {
      changes: o,
      selection: e.selection
        ...
        : (n = i.selection) === null || n === void 0
          ? void 0
          : n.map(r),
      effects: G.mapEffects(i.effects, r).concat(G.mapEffects(e.effects, s)),
...
function Dl(i, e, t) {
  let n = e.selection,
    r = fn(e.annotations);
  return (
    e.userEvent && (r = r.concat(Re.userEvent.of(e.userEvent))),
    {
      changes:
        e.changes instanceof Te
          ? e.changes
          : Te.of(e.changes || [], t, i.facet(zf)),
      selection: n && (n instanceof M ? n : M.single(n.anchor, n.head)),
      effects: fn(e.effects),
      annotations: r,
...
function Yf(i, e, t) {
  let n = Dl(i, e.length ? e[0] : {}, i.doc.length);
  e.length && e[0].filter === !1 && (t = !1);
  for (let s = 1; s < e.length; s++) {
    e[s].filter === !1 && (t = !1);
    let o = !!e[s].sequential;
    n = Jf(n, Dl(i, e[s], o ? n.changes.newLength : i.doc.length), o);
  }
  let r = Re.create(
    i,
    n.changes,
...
function Ym(i) {
  let e = i.startState,
    t = !0;
  for (let r of e.facet($f)) {
    let s = r(i);
    if (s === !1) {
      t = !1;
      break;
    }
    Array.isArray(s) && (t = t === !0 ? s : Jm(t, s));
  }
  if (t !== !0) {
    let r, s;
    if (t === !1) ((s = i.changes.invertedDesc), (r = Te.empty(e.doc.length)));
    else {
    ...
    i = Re.create(
      e,
      r,
      i.selection && i.selection.map(s),
      G.mapEffects(i.effects, s),
      i.annotations,
      i.scrollIntoView,
    );
  }
  ...
  for (let r = n.length - 1; r >= 0; r--) {
    ...
    s instanceof Re
      ? (i = s)
      : Array.isArray(s) && s.length == 1 && s[0] instanceof Re
        ? (i = s[0])
        : (i = Yf(e, fn(s), !1));
  }
  return i;
...
function Xm(i) {
  ...
  for (let r = t.length - 1; r >= 0; r--) {
    ...
    s &&
      ...
      (n = Jf(n, Dl(e, s, i.changes.newLength), !0));
  }
  return n == i
    ? i
    : Re.create(
...
const Qm = [];
function fn(i) {
  return i == null ? Qm : Array.isArray(i) ? i : [i];
}
var ue = (function (i) {
  return (
    (i[(i.Word = 0)] = "Word"),
...
let Tl;
try {
  Tl = new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {}
function ep(i) {
  if (Tl) return Tl.test(i);
  for (let e = 0; e < i.length; e++) {
    let t = i[e];
    if (
      /\w/.test(t) ||
      (t > "" && (t.toUpperCase() != t.toLowerCase() || Zm.test(t)))
    )
      return !0;
  }
  return !1;
...
function tp(i) {
  return (e) => {
    ...
    if (ep(e)) return ue.Word;
    for (let t = 0; t < i.length; t++) if (e.indexOf(i[t]) > -1) return ue.Word;
    return ue.Other;
  };
}
class Q {
  ...
  applyTransaction(e) {
    ...
    for (let l of e.effects)
      l.is(Ao.reconfigure)
        ? (t &&
            ((r = new Map()),
            t.compartments.forEach((a, c) => r.set(c, a)),
            (t = null)),
          r.set(l.value.compartment, l.value.extension))
        : l.is(G.reconfigure)
          ? ((t = null), (n = l.value))
          : l.is(G.appendConfig) && ((t = null), (n = fn(n).concat(l.value)));
    let s;
    t
      ? (s = e.startState.values.slice())
      : ((t = Qs.resolve(n, r, this)),
        (s = new Q(
          t,
          this.doc,
          this.selection,
    ...
    let o = e.startState.facet(Ml) ? e.newSelection : e.newSelection.asSingle();
  ...
  changeByRange(e) {
    ...
    for (let l = 1; l < t.ranges.length; l++) {
      ...
      let u = r.mapDesc(c, !0);
      (s.push(a.range.map(u)),
        (r = r.compose(h)),
        (o = G.mapEffects(o, h).concat(G.mapEffects(fn(a.effects), u))));
    }
    return { changes: r, selection: M.create(s, t.mainIndex), effects: o };
  }
  changes(e = []) {
    return e instanceof Te
      ? e
      : Te.of(e, this.doc.length, this.facet(Q.lineSeparator));
  }
  toText(e) {
    return ee.of(e.split(this.facet(Q.lineSeparator) || vl));
  }
  ...
  facet(e) {
    ...
    return t == null ? e.default : (dr(this, t), Zs(this, t));
  }
  toJSON(e) {
  ...
  static create(e = {}) {
    let t = Qs.resolve(e.extensions || [], new Map()),
      n =
        e.doc instanceof ee
          ? e.doc
          : ee.of((e.doc || "").split(t.staticFacet(Q.lineSeparator) || vl)),
      r = e.selection
  ...
  get lineBreak() {
    return (
      this.facet(Q.lineSeparator) ||
      `
`
    );
  }
  get readOnly() {
    return this.facet(Gf);
  }
  phrase(e, ...t) {
    for (let n of this.facet(Q.phrases))
...
Q.allowMultipleSelections = Ml;
Q.tabSize = I.define({ combine: (i) => (i.length ? i[0] : 4) });
Q.lineSeparator = zf;
Q.readOnly = Gf;
Q.phrases = I.define({
  compare(i, e) {
...
Q.languageData = Vf;
Q.changeFilter = $f;
Q.transactionFilter = Uf;
Q.transactionExtender = Kf;
Ao.reconfigure = G.define();
function $t(i, e, t = {}) {
  let n = {};
  for (let r of i)
...
class wc {
  ...
  findIndex(e, t, n, r = 0) {
    ...
    for (let o = r, l = s.length; ; ) {
      ...
      let a = (o + l) >> 1,
        c =
          s[a] - e || (n ? this.value[a].endSide : this.value[a].startSide) - t;
  ...
  between(e, t, n, r) {
    for (
      let s = this.findIndex(t, -1e9, !0), o = this.findIndex(n, 1e9, !1, s);
      s < o;
      s++
    )
    ...
    for (let a = 0; a < this.value.length; a++) {
      ...
      if (h == u) {
        ...
        if (
          g == null ||
          ((f = d = g),
          c.startSide != c.endSide && ((d = t.mapPos(h, c.endSide)), d < f))
        )
          continue;
      } else if (
      ...
      (d - f || c.endSide - c.startSide) < 0 ||
        (o < 0 && (o = f),
        c.point && (l = Math.max(l, d - f)),
        n.push(c),
        r.push(f - o),
        s.push(d - o));
    }
    return { mapped: n.length ? new wc(r, s, n, l) : null, pos: o };
  }
}
class Z {
  constructor(e, t, n, r) {
  ...
  update(e) {
    ...
    if ((n && (t = t.slice().sort(Al)), this.isEmpty))
      return t.length ? Z.of(t) : this;
    let l = new Qf(this, null, -1).goto(0),
      a = 0,
      c = [],
      h = new Vt();
        ...
        h.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex])
          ...
          : ((!o || r > l.to || s < l.from || o(l.from, l.to, l.value)) &&
              (h.addInner(l.from, l.to, l.value) ||
                c.push(Rl.create(l.from, l.to, l.value))),
            l.next());
  ...
  static compare(e, t, n, r, s = -1) {
    let o = e.filter((u) => u.maxPoint > 0 || (!u.isEmpty && u.maxPoint >= s)),
      l = t.filter((u) => u.maxPoint > 0 || (!u.isEmpty && u.maxPoint >= s)),
      a = oh(o, l, n),
      c = new zn(o, a, s),
      h = new zn(l, a, s);
    (n.iterGaps((u, f, d) => lh(c, u, h, f, d, r)),
      n.empty && n.length == 0 && lh(c, 0, h, 0, 0, r));
  }
  static eq(e, t, n = 0, r) {
    r == null && (r = 999999999);
    ...
    let l = oh(s, o),
      a = new zn(s, l, 0).goto(n),
      c = new zn(o, l, 0).goto(n);
    for (;;) {
      if (
        a.to != c.to ||
        !Pl(a.active, c.active) ||
          ...
          u =
            o.pointFrom < t
              ...
              : o.point.startSide < 0
                ? h.length
                : Math.min(h.length, a);
        (r.point(l, c, o.point, h, u, o.pointRank),
  ...
  static of(e, t = !1) {
    let n = new Vt();
    for (let r of e instanceof Rl ? [e] : t ? ip(e) : e)
...
function ip(i) {
  if (i.length > 1)
    for (let e = i[0], t = 1; t < i.length; t++) {
      let n = i[t];
      if (Al(e, n) > 0) return i.slice().sort(Al);
      e = n;
    }
  return i;
}
...
class Vt {
  finishChunk(e) {
    (this.chunks.push(new wc(this.from, this.to, this.value, this.maxPoint)),
  ...
  add(e, t, n) {
    this.addInner(e, t, n) ||
      (this.nextLayer || (this.nextLayer = new Vt())).add(e, t, n);
  }
  addInner(e, t, n) {
...
class vr {
  ...
  static from(e, t = null, n = -1) {
    ...
    for (let s = 0; s < e.length; s++)
      for (let o = e[s]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= n && r.push(new Qf(o, t, n, s));
  ...
  goto(e, t = -1e9) {
    ...
    for (let n = this.heap.length >> 1; n >= 0; n--) zo(this.heap, n);
...
function zo(i, e) {
  for (let t = i[e]; ; ) {
    ...
    let r = i[n];
    if (
      (n + 1 < i.length && r.compare(i[n + 1]) >= 0 && ((r = i[n + 1]), n++),
      t.compare(r) < 0)
    )
      break;
    ((i[n] = t), (i[e] = r), (e = n));
...
class zn {
  ...
  removeActive(e) {
    (ps(this.active, e),
      ps(this.activeTo, e),
      ps(this.activeRank, e),
      (this.minActive = ah(this.active, this.activeTo)));
  }
  addActive(e) {
    let t = 0,
      { value: n, to: r, rank: s } = this.cursor;
    for (
      ;
      ...
      t++;
    (ys(this.active, t, n),
      ys(this.activeTo, t, r),
      ys(this.activeRank, t, s),
      e && ys(e, t, this.cursor.from),
      (this.minActive = ah(this.active, this.activeTo)));
  }
  next() {
    let e = this.to,
    ...
    if (
      (i.point || t.point
        ? (i.point &&
            ...
            Pl(i.activeForPoint(i.to), t.activeForPoint(t.to))) ||
          s.comparePoint(l, f, i.point, t.point)
        : f > l &&
          !Pl(i.active, t.active) &&
          s.compareRange(l, f, i.active, t.active),
      u > o)
    )
      break;
    ((c || i.openEnd != t.openEnd) && s.boundChange && s.boundChange(u),
      (l = u),
      h <= 0 && i.next(),
      h >= 0 && t.next());
  }
...
const El = "ͼ",
  ch = typeof Symbol > "u" ? "__" + El : Symbol.for(El),
  Ll =
    typeof Symbol > "u"
      ? "__styleSet" + Math.floor(Math.random() * 1e8)
      : Symbol("styleSet"),
  hh = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {};
class ki {
  constructor(e, t) {
    this.rules = [];
    let { finish: n } = t || {};
      ...
      for (let d in l) {
        ...
        if (/&/.test(d))
          s(
            d
              .split(/,\s*/)
              .map((p) => o.map((b) => p.replace(/&/, b)))
              .reduce((p, b) => p.concat(b)),
            g,
            a,
          );
...
`);
  ...
  static newName() {
    let e = hh[ch] || 1;
    return ((hh[ch] = e + 1), El + e.toString(36));
  }
  static mount(e, t, n) {
    let r = e[Ll],
      s = n && n.nonce;
    (r ? s && r.setNonce(s) : (r = new np(e, s)),
  ...
  mount(e, t) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if (
        ...
        if ((this.modules.splice(s++, 0, l), n))
...
var Ci = {
  ...
  rp = typeof navigator < "u" && /Mac/.test(navigator.platform),
  sp =
    typeof navigator < "u" &&
    /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var Ie = 0; Ie < 10; Ie++) Ci[48 + Ie] = Ci[96 + Ie] = String(Ie);
for (var Ie = 1; Ie <= 24; Ie++) Ci[Ie + 111] = "F" + Ie;
for (var Ie = 65; Ie <= 90; Ie++)
  ((Ci[Ie] = String.fromCharCode(Ie + 32)), (wr[Ie] = String.fromCharCode(Ie)));
for (var $o in Ci) wr.hasOwnProperty($o) || (wr[$o] = Ci[$o]);
function op(i) {
  var e =
      (rp && i.metaKey && i.shiftKey && !i.ctrlKey && !i.altKey) ||
      (sp && i.shiftKey && i.key && i.key.length == 1) ||
      i.key == "Unidentified",
    t =
      (!e && i.key) ||
      (i.shiftKey ? wr : Ci)[i.keyCode] ||
      i.key ||
      "Unidentified";
  return (
    t == "Esc" && (t = "Escape"),
...
function re() {
  ...
  for (; e < arguments.length; e++) Zf(i, arguments[e]);
  return i;
}
function Zf(i, e) {
  if (typeof e == "string") i.appendChild(document.createTextNode(e));
    ...
    else if (Array.isArray(e)) for (var t = 0; t < e.length; t++) Zf(i, e[t]);
...
function kr(i) {
  return i.nodeType == 3
    ? Qi(i, 0, i.nodeValue.length).getClientRects()
    : i.nodeType == 1
      ? i.getClientRects()
      : [];
}
function gr(i, e, t, n) {
  return t ? fh(i, e, t, n, -1) || fh(i, e, t, n, 1) : !1;
}
function Xi(i) {
  ...
  for (let h = i, u = !1; h && !u; )
    if (h.nodeType == 1) {
      ...
      if (d) f = lp(c);
        ...
        (({ scaleX: g, scaleY: p } = ed(h, S)),
          (f = {
            left: S.left,
            right: S.left + h.clientWidth * g,
            top: S.top,
      ...
      if (r == "nearest")
        e.top < f.top
          ? ((v = e.top - (f.top + o)),
            t > 0 && e.bottom > f.bottom + v && (v = e.bottom - f.bottom + o))
          : e.bottom > f.bottom &&
            ((v = e.bottom - f.bottom + o),
            t < 0 && e.top - v < f.top && (v = e.top - (f.top + o)));
      else {
      ...
      if (
        (n == "nearest"
          ? e.left < f.left
            ? ((b = e.left - (f.left + s)),
              t > 0 && e.right > f.right + b && (b = e.right - f.right + s))
            : e.right > f.right &&
              ((b = e.right - f.right + s),
              t < 0 && e.left < f.left + b && (b = e.left - (f.left + s)))
          : (b =
              (n == "center"
        ...
        if (d) c.scrollBy(b, v);
          ...
          if (v) {
            let R = h.scrollTop;
            ((h.scrollTop += v / p), (C = (h.scrollTop - R) * p));
          }
          if (b) {
            let R = h.scrollLeft;
            ((h.scrollLeft += b / g), (S = (h.scrollLeft - R) * g));
          }
          ((e = {
            left: e.left - S,
            top: e.top - C,
            ...
            S && Math.abs(S - b) < 1 && (n = "nearest"),
            C && Math.abs(C - v) < 1 && (r = "nearest"));
        }
      if (d) break;
      ((e.top < f.top ||
        e.bottom > f.bottom ||
...
class hp {
  ...
  setRange(e) {
    ...
    this.set(
      t,
      Math.min(e.anchorOffset, t ? zt(t) : 0),
      n,
      Math.min(e.focusOffset, n ? zt(n) : 0),
    );
  }
  set(e, t, n, r) {
    ((this.anchorNode = e),
...
let dh;
function Qi(i, e, t = e) {
  let n = dh || (dh = document.createRange());
...
function fp(i, e) {
  ...
  for (n = Math.min(n, zt(t)); ; )
    if (n) {
      if (t.nodeType != 1) return !1;
      let r = t.childNodes[n - 1];
      r.contentEditable == "false" ? n-- : ((t = r), (n = zt(t)));
    } else {
      if (t == i) return !0;
...
function rd(i, e) {
  for (let t = i, n = e; ; ) {
    ...
    if (t.nodeType == 1 && n > 0) {
      ...
      ((t = t.childNodes[n - 1]), (n = zt(t)));
    } else if (t.parentNode && !eo(t)) ((n = Xi(t)), (t = t.parentNode));
    else return null;
  }
}
function sd(i, e) {
  for (let t = i, n = e; ; ) {
    ...
    } else if (t.parentNode && !eo(t)) ((n = Xi(t) + 1), (t = t.parentNode));
    else return null;
  }
}
class Ve {
  ...
  static before(e, t) {
    return new Ve(e.parentNode, Xi(e), t);
  }
  static after(e, t) {
    return new Ve(e.parentNode, Xi(e) + 1, t);
  }
}
const Sc = [];
class oe {
    ...
    if (this.flags & 2) {
      ...
      for (let o of this.children) {
        ...
        if (
          ...
          t && !t.written && t.node == n && s != o.dom && (t.written = !0),
          o.dom.parentNode == n)
        )
          for (; s && s != o.dom; ) s = gh(s);
        else n.insertBefore(o.dom, s);
        r = o.dom;
      }
      for (
        s = r ? r.nextSibling : n.firstChild,
          s && t && t.node == n && (t.written = !0);
        s;
      )
        s = gh(s);
...
function ld(i, e, t, n, r, s, o, l, a) {
  ...
  if (
    !(
      ...
      !f &&
      s.length < 2 &&
      h.merge(t, r, s.length ? u : null, t == 0, l, a)
    )
  ) {
    if (n < c.length) {
      let d = c[n];
      (d && (r < d.length || (d.breakAfter && u != null && u.breakAfter))
        ? (e == n && ((d = d.split(r)), (r = 0)),
          !f && u && d.merge(0, r, u, !0, 0, a)
            ? (s[s.length - 1] = d)
            : ((r || (d.children.length && !d.children[0].length)) &&
                d.merge(0, r, null, !1, 0, a),
              s.push(d)))
        : d != null && d.breakAfter && (u ? (u.breakAfter = 1) : (o = 1)),
        n++);
    }
    for (
      h &&
    ...
    (!s.length &&
      ...
      n < c.length &&
      !c[e - 1].breakAfter &&
      c[n].merge(0, 0, c[e - 1], !1, l, a) &&
      e--,
      (e < n || s.length) && i.replaceChildren(e, n, s));
  }
}
function ad(i, e, t, n, r, s) {
  let o = i.childCursor(),
    { i: l, off: a } = o.findPos(t, 1),
    { i: c, off: h } = o.findPos(e, -1),
    u = e - t;
  for (let f of n) u += f.length;
  ((i.length += u), ld(i, c, h, l, a, n, 0, r, s));
}
let it =
    typeof navigator < "u"
      ? navigator
      : { userAgent: "", vendor: "", platform: "" },
  _l = typeof document < "u" ? document : { documentElement: { style: {} } };
const Bl = /Edge\/(\d+)/.exec(it.userAgent),
  cd = /MSIE \d/.test(it.userAgent),
  Il = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(it.userAgent),
  Oo = !!(cd || Il || Bl),
  mh = !Oo && /gecko\/(\d+)/i.test(it.userAgent),
  Uo = !Oo && /Chrome\/(\d+)/.exec(it.userAgent),
  dp = "webkitFontSmoothing" in _l.documentElement.style,
  hd = !Oo && /Apple Computer/.test(it.vendor),
  ph = hd && (/Mobile\/\w+/.test(it.userAgent) || it.maxTouchPoints > 2);
var F = {
  mac: ph || /Mac/.test(it.platform),
  windows: /Win/.test(it.platform),
  linux: /Linux|X11/.test(it.platform),
  ie: Oo,
  ie_version: cd ? _l.documentMode || 6 : Il ? +Il[1] : Bl ? +Bl[1] : 0,
  gecko: mh,
  gecko_version: mh ? +(/Firefox\/(\d+)/.exec(it.userAgent) || [0, 0])[1] : 0,
  chrome: !!Uo,
  ...
  safari: hd,
  webkit_version: dp
    ? +(/\bAppleWebKit\/(\d+)/.exec(it.userAgent) || [0, 0])[1]
    : 0,
  tabSize:
    _l.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size",
};
const gp = 256;
class xt extends oe {
  constructor(e) {
...
class ci extends oe {
  ...
  merge(e, t, n, r, s, o) {
    return n &&
      (!(n instanceof ci && n.mark.eq(this.mark)) ||
        (e && s <= 0) ||
        (t < this.length && o <= 0))
      ? !1
      : (ad(this, e, t, n ? n.children.slice() : [], s - 1, o - 1),
        this.markDirty(),
        !0);
  }
  split(e) {
...
function mp(i, e, t) {
  ...
  let r = e,
    ...
    o = 0;
  (e == 0 && t < 0) || (e == n && t >= 0)
    ? F.chrome || F.gecko || (e ? (r--, (o = 1)) : s < n && (s++, (o = -1)))
    : t < 0
      ? r--
      : s < n && s++;
  let l = Qi(i, r, s).getClientRects();
...
class bi extends oe {
  ...
  get overrideDOMText() {
    if (this.length == 0) return ee.empty;
    let e = this;
    for (; e.parent; ) e = e.parent;
    let { view: t } = e,
      n = t && t.state.doc,
      r = this.posAtStart;
    return n ? n.slice(r, r + this.length) : ee.empty;
  }
  domAtPos(e) {
    return (this.length ? e == 0 : this.side > 0)
      ? Ve.before(this.dom)
      : Ve.after(this.dom, e == this.length);
  }
  domBoundsAround() {
    return null;
  }
...
class bn extends oe {
  ...
  become(e) {
    return e instanceof bn && e.side == this.side;
  }
  split() {
    return new bn(this.side);
  }
  sync() {
    if (!this.dom) {
...
xt.prototype.children = bi.prototype.children = bn.prototype.children = Sc;
function ud(i, e) {
  let t = i.dom,
    { children: n } = i,
    r = 0;
...
function fd(i, e, t) {
  ...
  e instanceof ci &&
  r.length &&
  (n = r[r.length - 1]) instanceof ci &&
  n.mark.eq(e.mark)
    ? fd(n, e.children[0], t - 1)
    : (r.push(e), e.setParent(i)),
    (i.length += e.length));
}
function dd(i, e, t) {
  let n = null,
  ...
  function l(c, h) {
    for (let u = 0, f = 0; u < c.children.length && f <= h; u++) {
      ...
      (g >= h &&
        (d.children.length
          ? l(d, h - f)
          : (!s || (s.isHidden && (t > 0 || yp(s, d)))) &&
              (g > h || (f == g && d.getSide() > 0))
            ? ((s = d), (o = h - f))
            : (f < h || (f == g && d.getSide() < 0 && !d.isHidden)) &&
              ((n = d), (r = h - f))),
        (f = g));
    }
  }
  l(i, e);
  let a = (t < 0 ? n : s) || n || s;
  return a ? a.coordsAt(Math.max(0, a == n ? r : o), t) : pp(i);
}
function pp(i) {
...
function to(i, e, t) {
  ...
  if (
    ...
    return !1;
  for (let s of n)
    if (s != t && (r.indexOf(s) == -1 || i[s] !== e[s])) return !1;
  return !0;
}
function Fl(i, e, t) {
  let n = !1;
  if (e)
    for (let r in e)
      (t && r in t) ||
        ((n = !0),
        r == "style" ? (i.style.cssText = "") : i.removeAttribute(r));
  if (t)
    for (let r in t)
      (e && e[r] == t[r]) ||
        ((n = !0),
        r == "style" ? (i.style.cssText = t[r]) : i.setAttribute(r, t[r]));
  return n;
}
function bp(i) {
...
class $ extends Yi {
  ...
  static widget(e) {
    ...
    return (
      ...
      new xi(e, t, t, n, e.widget || null, !1)
    );
  }
  static replace(e) {
    let t = !!e.block,
    ...
    return new xi(e, n, r, t, e.widget || null, !0);
  }
  static line(e) {
    return new Wr(e);
  }
...
Wr.prototype.mapMode = Xe.TrackBefore;
...
class Me extends oe {
  ...
  merge(e, t, n, r, s, o) {
    ...
    return (
      ...
      ad(this, e, t, n ? n.children.slice() : [], s, o),
      !0
    );
  }
  split(e) {
  ...
  addLineDeco(e) {
    let t = e.spec.attributes,
      n = e.spec.class;
    (t && (this.attrs = ql(t, this.attrs || {})),
      n && (this.attrs = ql({ class: n }, this.attrs || {})));
  }
  domAtPos(e) {
    return ud(this, e);
  }
  ...
  sync(e, t) {
    ...
    (this.dom
      ...
      : (this.setDOM(document.createElement("div")),
        ...
        (this.prevAttrs = this.attrs ? null : void 0)),
      this.prevAttrs !== void 0 &&
        (Fl(this.dom, this.prevAttrs, this.attrs),
        this.dom.classList.add("cm-line"),
        (this.prevAttrs = void 0)),
      super.sync(e, t));
    let r = this.dom.lastChild;
    for (; r && oe.get(r) instanceof ci; ) r = r.lastChild;
    if (
      !r ||
      !this.length ||
      (r.nodeName != "BR" &&
        ((n = oe.get(r)) === null || n === void 0 ? void 0 : n.isEditable) ==
          !1 &&
        (!F.ios || !this.children.some((s) => s instanceof xt)))
    ) {
  ...
  measureTextSize() {
    ...
    let e = 0,
      t;
    for (let n of this.children) {
      if (!(n instanceof xt) || /[^ -~]/.test(n.text)) return null;
      let r = kr(n.dom);
...
class li extends oe {
  ...
  split(e) {
    let t = this.length - e;
    this.length = e;
    let n = new li(this.widget, t, this.deco);
  ...
  become(e) {
    return e instanceof li && e.widget.constructor == this.widget.constructor
  ...
  coordsAt(e, t) {
    ...
    return (
      n ||
      (this.widget instanceof jl
        ? null
        : Po(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0))
    );
  }
  destroy() {
    (super.destroy(), this.dom && this.widget.destroy(this.dom));
...
class mr {
  ...
  getLine() {
    return (
      this.curLine ||
        (this.content.push((this.curLine = new Me())), (this.atCursorPos = !0)),
      this.curLine
    );
  }
  flushBuffer(e = this.bufferMarks) {
    this.pendingBuffer &&
      (this.curLine.append(bs(new bn(-1), e), e.length),
      (this.pendingBuffer = 0));
  }
  addBlockWidget(e) {
    ...
    (this.pendingBuffer && e <= this.bufferMarks.length
      ...
      !this.posCovered() &&
        !(
          e &&
          this.content.length &&
          this.content[this.content.length - 1] instanceof li
        ) &&
        this.getLine());
  }
  buildText(e, t, n) {
    for (; e > 0; ) {
      ...
      (this.flushBuffer(t.slice(t.length - n)),
        this.getLine().append(
          bs(new xt(this.text.slice(this.textOff, this.textOff + r)), t),
          n,
        ),
        (this.atCursorPos = !0),
        (this.textOff += r),
  ...
  point(e, t, n, r, s, o) {
    if (this.disallowBlockEffectsFor[o] && n instanceof xi) {
      if (n.block)
        throw new RangeError(
    ...
    if (n instanceof xi)
      if (n.block)
        (n.startSide > 0 && !this.posCovered() && this.getLine(),
          this.addBlockWidget(new li(n.widget || vn.block, l, n)));
      else {
        let a = bi.create(n.widget || vn.inline, l, l ? 0 : n.startSide),
          c =
            this.atCursorPos &&
            !a.isEditable &&
            s <= r.length &&
            (e < t || n.startSide > 0),
          h = !a.isEditable && (e < t || s > r.length || n.startSide <= 0),
          u = this.getLine();
  ...
  static build(e, t, n, r, s) {
    let o = new mr(e, t, n, s);
    return (
      (o.openEnd = Z.spans(r, t, n, o)),
...
function bs(i, e) {
  for (let t of e) i = new ci(t, [i], i.length);
  return i;
}
class vn extends Ri {
  constructor(e) {
...
function Cp(i, e, t, n, r) {
  for (let s = 0; s <= n.length; s++) {
    let o = s ? n[s - 1].to : e,
      l = s < n.length ? n[s].from : t,
      a = s ? 256 : r;
    for (let c = o, h = a, u = a; c < l; c++) {
      let f = pd(i.charCodeAt(c));
    ...
    for (let c = o, h = a, u = a; c < l; c++) {
      ...
      if (f == 128)
        ...
        let d = c + 1;
        for (; d < l && se[d] == 64; ) d++;
        let g = (c && h == 8) || (d < t && se[d] == 8) ? (u == 1 ? 1 : 8) : 256;
        for (let p = c; p < d; p++) se[p] = g;
        c = d - 1;
      } else f == 8 && u == 1 && (se[c] = 1);
      ((h = f), f & 7 && (u = f));
    }
...
function xp(i, e, t, n, r) {
  ...
  for (let o = 0, l = 0, a = 0; o <= n.length; o++) {
    let c = o ? n[o - 1].to : e,
      h = o < n.length ? n[o].from : t;
    for (let u = c, f, d, g; u < h; u++)
      if ((d = Hl[(f = i.charCodeAt(u))]))
        if (d < 0) {
          for (let p = l - 3; p >= 0; p -= 3)
            if (Ot[p + 1] == -d) {
              let b = Ot[p + 2],
                v = b & 2 ? r : b & 4 ? (b & 1 ? s : r) : 0;
              (v && (se[u] = se[Ot[p]] = v), (l = p));
              break;
            }
        } else {
          if (Ot.length == 189) break;
          ((Ot[l++] = u), (Ot[l++] = f), (Ot[l++] = a));
        }
      else if ((g = se[u]) == 2 || g == 1) {
        let p = g == r;
        a = p ? 0 : 1;
    ...
    for (let a = o; a < l; ) {
      ...
      if (c == 256) {
        ...
        let u = s == 1,
          f = (h < e ? se[h] : n) == 1,
          d = u == f ? (u ? 1 : 2) : n;
        for (let g = h, p = r, b = p ? t[p - 1].to : i; g > a; )
          (g == b && ((g = t[--p].from), (b = p ? t[p - 1].to : i)),
            (se[--g] = d));
        a = h;
      } else ((s = c), a++);
    }
    ...
    for (let a = e, c = 0; a < t; ) {
      ...
      e: for (;;)
        if (c < s.length && g == s[c].from) {
          ...
          let p = s[c];
          if (!h)
            for (let b = p.to, v = c + 1; ; ) {
              if (b == t) break e;
              if (v < s.length && s[v].from == b) b = s[v++].to;
              else {
                if (se[b] == l) break e;
                break;
              }
          ...
          if ((c++, f)) f.push(p);
            ...
            p.from > a && o.push(new vi(a, p.from, d));
            let b = (p.direction == Zi) != !(d % 2);
            (Vl(i, b ? n + 1 : n, r, p.inner, p.from, p.to, o), (a = p.to));
          }
          g = p.to;
        } else {
          if (g == t || (h ? se[g] != l : se[g] == l)) break;
          g++;
        }
      (f ? Wl(i, a, g, n + 1, r, f, o) : a < g && o.push(new vi(a, g, d)),
        (a = g));
    }
  else
    for (let a = t, c = s.length; a > e; ) {
      ...
      e: for (;;)
        if (c && g == s[c - 1].to) {
          ...
          let p = s[--c];
          if (!h)
            for (let b = p.from, v = c; ; ) {
              if (b == e) break e;
              if (v && s[v - 1].to == b) b = s[--v].from;
              else {
                if (se[b - 1] == l) break e;
                break;
              }
          ...
          if (f) f.push(p);
            ...
            p.to < a && o.push(new vi(p.to, a, d));
            let b = (p.direction == Zi) != !(d % 2);
            (Vl(i, b ? n + 1 : n, r, p.inner, p.from, p.to, o), (a = p.from));
          }
          g = p.from;
        } else {
          if (g == e || (h ? se[g - 1] != l : se[g - 1] == l)) break;
          g--;
        }
      (f ? Wl(i, g, a, n + 1, r, f, o) : g < a && o.push(new vi(g, a, d)),
        (a = g));
    }
}
function Vl(i, e, t, n, r, s, o) {
  let l = e % 2 ? 2 : 1;
  (Cp(i, r, s, n, l),
    xp(i, r, s, n, l),
    Mp(r, s, n, l),
...
function Dp(i, e, t) {
  if (!i) return [new vi(0, 0, e == kc ? 1 : 0)];
  if (e == Zi && !t.length && !kp.test(i)) return bd(i.length);
  if (t.length) for (; i.length > se.length; ) se[se.length] = 256;
  let n = [],
    r = e == Zi ? 0 : 1;
  return (Vl(i, r, r, t, 0, i.length, n), n);
}
function bd(i) {
  return [new vi(0, i, 0)];
}
...
function Tp(i, e, t, n, r) {
  ...
  let o = n.head - i.from,
    l = vi.find(
      e,
      o,
      (s = n.bidiLevel) !== null && s !== void 0 ? s : -1,
      n.assoc,
    ),
    a = e[l],
    c = a.side(r, t);
  if (o == c) {
    ...
    ((a = e[(l = f)]), (o = a.side(!r, t)), (c = a.side(r, t)));
  }
  let h = je(i.text, o, a.forward(r, t));
  ((h < a.from || h > a.to) && (h = c),
    (vd = i.text.slice(Math.min(o, h), Math.max(o, h))));
  let u = l == (r ? e.length - 1 : 0) ? null : e[l + (r ? 1 : -1)];
  return u && h == c && u.level + (r ? 0 : 1) < a.level
    ? M.cursor(u.side(!r, t) + i.from, u.forward(r, t) ? 1 : -1, u.level)
    : M.cursor(h + i.from, a.forward(r, t) ? -1 : 1, a.level);
}
function Rp(i, e, t) {
  for (let n = e; n < t; n++) {
    let r = pd(i.charCodeAt(n));
    if (r == 1) return Zi;
    if (r == 2 || r == 4) return kc;
  }
  return Zi;
}
const wd = I.define(),
  ...
  Cc = I.define(),
  xc = I.define(),
  Dd = I.define({ combine: (i) => i.some((e) => e) }),
  Td = I.define({ combine: (i) => i.some((e) => e) }),
  Rd = I.define();
class gn {
...
const vs = G.define({ map: (i, e) => i.map(e) }),
  Ad = G.define();
function rt(i, e, t) {
  let n = i.facet(Cd);
  n.length
...
const si = I.define({ combine: (i) => (i.length ? i[0] : !0) });
let Ap = 0;
const cn = I.define({
  combine(i) {
    return i.filter((e, t) => {
      for (let n = 0; n < t; n++) if (i[n].plugin == e.plugin) return !1;
      return !0;
    });
  },
});
class xe {
  constructor(e, t, n, r, s) {
    ((this.id = e),
      ...
      (this.extension = this.baseExtensions.concat(
        cn.of({ plugin: this, arg: void 0 }),
      )));
  }
  of(e) {
    return this.baseExtensions.concat(cn.of({ plugin: this, arg: e }));
  }
  static define(e, t) {
    const {
      eventHandlers: n,
  ...
  static fromClass(e, t) {
    return xe.define((n, r) => new e(n, r), t);
  }
}
class Ko {
  constructor(e) {
      ...
      if (this.mustUpdate) {
        ...
        if (((this.mustUpdate = null), this.value.update))
          try {
            ...
            if (
              (rt(t.state, n, "CodeMirror plugin crashed"), this.value.destroy)
            )
              try {
                this.value.destroy();
              } catch {}
  ...
  destroy(e) {
    ...
    if (!((t = this.value) === null || t === void 0) && t.destroy)
      try {
        ...
        rt(e.state, n, "CodeMirror plugin crashed");
      }
  }
  deactivate() {
...
const Pd = I.define(),
  ...
  Ed = I.define();
function bh(i, e) {
  let t = i.state.facet(Ed);
  if (!t.length) return t;
  let n = t.map((s) => (s instanceof Function ? s(i) : s)),
    r = [];
  return (
    Z.spans(n, e.from, e.to, {
      point() {},
      span(s, o, l, a) {
        let c = s - e.from,
          h = o - e.from,
    ...
    for (let r = 0, s = 0, o = 0, l = 0; ; r++) {
      ...
      for (; s < t.length && t[s] < h; ) {
        let u = t[s],
          ...
          d = Math.max(l, u),
          g = Math.min(h, f);
        if ((d <= g && new pt(d + c, g + c, d, g).addToSet(n), f > h)) break;
        s += 2;
      }
      if (!a) return n;
      (new pt(a.fromA, a.toA, a.fromB, a.toB).addToSet(n),
        (o = a.toA),
        (l = a.toB));
    }
  }
...
class io {
  constructor(e, t, n) {
    ((this.view = e),
      ...
      (this.changes = Te.empty(this.startState.doc.length)));
    for (let s of n) this.changes = this.changes.compose(s.changes);
    let r = [];
    (this.changes.iterChangedRanges((s, o, l, a) => r.push(new pt(s, o, l, a))),
...
class vh extends oe {
  ...
  constructor(e) {
    (super(),
      ...
      (this.editContextFormatting = $.none),
      ...
      this.updateDeco(),
      this.updateInner([new pt(0, 0, 0, e.state.doc.length)], 0, null));
  }
  update(e) {
    var t;
    ...
    this.view.inputState.composing >= 0 &&
      ...
      (!((t = this.domChanged) === null || t === void 0) && t.newSel
        ...
        : !Bp(e.changes, this.hasComposition) &&
          !e.selectionSet &&
    ...
    let o = this.decorations,
      ...
      a = Np(o, l, e.changes);
    return (
      (n = pt.extendWithRanges(n, a)),
      !(this.flags & 7) && n.length == 0
        ? !1
        : (this.updateInner(n, e.startState.doc.length, s),
  ...
  updateInner(e, t, n) {
    ...
    if (
      ...
      for (let o of this.children)
        o instanceof li && o.widget instanceof jl && s.push(o.dom);
    r.updateGaps(s);
  }
  updateChildren(e, t, n) {
    ...
    for (let o = r.length - 1; ; o--) {
      let l = o >= 0 ? r[o] : null;
      if (!l) break;
      let { fromA: a, toA: c, fromB: h, toB: u } = l,
        f,
        d,
        g,
        p;
      if (n && n.range.fromB < u && n.range.toB > h) {
        ...
        ((d = R.breakAtStart), (g = R.openStart), (p = D.openEnd));
        let T = this.compositionView(n);
        (D.breakAtStart
          ? (T.breakAfter = 1)
          : D.content.length &&
            T.merge(T.length, T.length, D.content[0], !1, D.openStart, 0) &&
            ((T.breakAfter = D.content[0].breakAfter), D.content.shift()),
          R.content.length &&
            T.merge(0, 0, R.content[R.content.length - 1], !0, 0, R.openEnd) &&
            R.content.pop(),
          (f = R.content.concat(T).concat(D.content)));
      } else
        ({
          content: f,
          breakAtStart: d,
      ...
      let { i: b, off: v } = s.findPos(c, 1),
        { i: S, off: C } = s.findPos(a, -1);
      ld(this, S, C, b, v, f, d, g, p);
    }
  ...
  updateEditContextFormatting(e) {
    ...
    for (let t of e.transactions)
      for (let n of t.effects)
        n.is(Ad) && (this.editContextFormatting = n.value);
  }
  compositionView(e) {
    let t = new xt(e.text.nodeValue);
    t.flags |= 8;
    for (let { deco: r } of e.marks) t = new ci(r, [t], t.length);
    let n = new Me();
  ...
  updateSelection(e = !1, t = !1) {
    ...
    let n = this.view.root.activeElement,
      ...
      s =
        !r &&
        !(this.view.state.facet(si) || this.dom.tabIndex > -1) &&
    ...
    if (F.gecko && l.empty && !this.hasComposition && Pp(a)) {
      let u = document.createTextNode("");
      (this.view.observer.ignore(() =>
        a.node.insertBefore(u, a.node.childNodes[a.offset] || null),
      ),
        (a = c = new Ve(u, 0)),
        (o = !0));
    }
    ...
    ((o ||
      !h.focusNode ||
      ((!gr(a.node, a.offset, h.anchorNode, h.anchorOffset) ||
        !gr(c.node, c.offset, h.focusNode, h.focusOffset)) &&
        !this.suppressWidgetCursorChange(h, l))) &&
      (this.view.observer.ignore(() => {
        F.android &&
          F.chrome &&
          this.dom.contains(h.focusNode) &&
          _p(h.focusNode, this.dom) &&
          (this.dom.blur(), this.dom.focus({ preventScroll: !0 }));
        let u = Sr(this.view.root);
        if (u)
          if (l.empty) {
            if (F.gecko) {
              let f = Ep(a.node, a.offset);
              if (f && f != 3) {
                let d = (f == 1 ? rd : sd)(a.node, a.offset);
      ...
      (this.impreciseAnchor = a.precise
        ? null
        : new Ve(h.anchorNode, h.anchorOffset)),
      (this.impreciseHead = c.precise
        ? null
        : new Ve(h.focusNode, h.focusOffset)));
  }
  ...
  moveToLine(e) {
    ...
    for (let r = e.offset; !n && r < t.childNodes.length; r++) {
      ...
      s instanceof Me && (n = s.domAtPos(0));
    }
    for (let r = e.offset - 1; !n && r >= 0; r--) {
      let s = oe.get(t.childNodes[r]);
      s instanceof Me && (n = s.domAtPos(s.length));
    }
  ...
  domAtPos(e) {
    ...
    for (; t < this.children.length - 1; ) {
      ...
      if (n < r.length || r instanceof Me) break;
      (t++, (n = 0));
    }
  ...
  coordsAt(e, t) {
    ...
    for (let s = this.length, o = this.children.length - 1; o >= 0; o--) {
      ...
      if (
        ...
        (c < e || l.covers(-1)) &&
        (a > e || l.covers(1)) &&
        (!n || (l instanceof Me && !(n instanceof Me && t >= 0)))
      )
        ((n = l), (r = c));
      else if (n && c == e && a == e && l instanceof li && Math.abs(t) < 2) {
  ...
  coordsForChar(e) {
    ...
    if (!(r instanceof xt)) return null;
    let s = je(r.text, n);
    if (s == n) return null;
    let o = Qi(r.dom, n, s).getClientRects();
    ...
    for (let c = 0, h = 0; h < this.children.length; h++) {
      ...
      if (c >= n) {
        ...
        if ((t.push(d.height), o)) {
          let g = u.dom.lastChild,
            p = g ? kr(g) : [];
          if (p.length) {
            let b = p[p.length - 1],
              v = a ? b.right - d.left : d.right - b.left;
            v > l &&
              ((l = v),
              (this.minWidth = s),
              (this.minWidthFrom = c),
  ...
  updateDeco() {
    let e = 1,
      ...
      n = !1,
      r = this.view.state.facet(Od).map((s, o) => {
        let l = typeof s == "function";
        return (l && (n = !0), l ? s(this.view) : s);
      });
    for (
      r.length && ((this.dynamicDecorationMap[e++] = n), t.push(Z.join(r))),
        this.decorations = [
  ...
  scrollIntoView(e) {
    ...
    for (let c of this.view.state.facet(Rd))
      try {
...
function Nd(i, e) {
  ...
  let n = rd(t.focusNode, t.focusOffset),
    r = sd(t.focusNode, t.focusOffset),
    s = n || r;
  if (r && n && r.node != n.node) {
    let l = oe.get(r.node);
    if (!l || (l instanceof xt && l.text != r.node.nodeValue)) s = r;
    else if (i.docView.lastCompositionAfterCursor) {
      let a = oe.get(n.node);
      !a || (a instanceof xt && a.text != n.node.nodeValue) || (s = r);
    }
  }
  if (((i.docView.lastCompositionAfterCursor = s != n), !s)) return null;
  let o = e - s.offset;
...
function Op(i, e, t) {
  ...
  let a = e.invertedDesc,
    c = new pt(a.mapPos(s), a.mapPos(o), s, o),
    h = [];
  for (let u = r.parentNode; ; u = u.parentNode) {
    let f = oe.get(u);
    if (f instanceof ci) h.push({ node: u, deco: f.mark });
    else {
      if (
        f instanceof Me ||
        (u.nodeName == "DIV" && u.parentNode == i.contentDOM)
      )
...
function Ip(i, e, t = 1) {
  let n = i.charCategorizer(e),
    r = i.doc.lineAt(e),
    s = e - r.from;
  if (r.length == 0) return M.cursor(e);
  s == 0 ? (t = 1) : s == r.length && (t = -1);
  let o = s,
    l = s;
  t < 0 ? (o = je(r.text, s, !1)) : (l = je(r.text, s));
...
function $l(i, e, t) {
  ...
  for (let g = i.firstChild; g; g = g.nextSibling) {
    ...
    for (let b = 0; b < p.length; b++) {
      let v = p[b];
      r && Go(r, v) && (v = wh(Sh(v, r.bottom), r.top));
      let S = qp(e, v),
        C = Fp(t, v);
      if (S == 0 && C == 0) return g.nodeType == 3 ? kh(g, e, t) : $l(g, e, t);
      if (!n || o > C || (o == C && s > S)) {
        ((n = g), (r = v), (s = S), (o = C));
        let R = C ? (t < v.top ? -1 : 1) : S ? (e < v.left ? -1 : 1) : 0;
        l = !R || (R > 0 ? b < p.length - 1 : b > 0);
      }
      S == 0
        ? t > v.bottom && (!h || h.bottom < v.bottom)
          ? ((a = g), (h = v))
          : t < v.top && (!u || u.top > v.top) && ((c = g), (u = v))
        : h && Go(h, v)
          ? (h = Sh(h, v.bottom))
          : u && Go(u, v) && (u = wh(u, v.top));
    }
  }
  if (
    (h && h.bottom >= t
  ...
  if (n.nodeType == 3) return kh(n, f, t);
  if (l && n.contentEditable != "false") return $l(n, f, t);
  let d =
...
function kh(i, e, t) {
  let n = i.nodeValue.length,
    ...
    o = 0;
  for (let l = 0; l < n; l++) {
    let a = Qi(i, l, l + 1).getClientRects();
    for (let c = 0; c < a.length; c++) {
      ...
      if (h.left - 1 <= e && h.right + 1 >= e && u < s) {
        ...
        if (
          ((F.chrome || F.gecko) &&
            Qi(i, l).getBoundingClientRect().left == h.right &&
            (d = !f),
          u <= 0)
        )
...
function _d(i, e, t, n = -1) {
  var r, s;
  let o = i.contentDOM.getBoundingClientRect(),
    l = o.top + i.viewState.paddingTop,
    a,
    { docHeight: c } = i.viewState,
    { x: h, y: u } = e,
    f = u - l;
  if (f < 0) return 0;
  if (f > c) return i.state.doc.length;
  for (
    let R = i.viewState.heightOracle.textHeight / 2, D = !1;
    (a = i.elementAtHeight(f)), a.type != Qe.Text;
  )
    for (; (f = n > 0 ? a.bottom + R : a.top - R), !(f >= 0 && f <= c); ) {
      if (D) return t ? null : 0;
      ((D = !0), (n = -n));
    }
  u = l + f;
  let d = a.from;
  if (d < i.viewport.from)
    return i.viewport.from == 0 ? 0 : t ? null : Ch(i, o, a, h, u);
  if (d > i.viewport.to)
    return i.viewport.to == i.state.doc.length
      ...
      : t
        ? null
        : Ch(i, o, a, h, u);
  let g = i.dom.ownerDocument,
    p = i.root.elementFromPoint ? i.root : g,
    b = p.elementFromPoint(h, u);
  (b && !i.contentDOM.contains(b) && (b = null),
    b ||
  ...
  if (
    b &&
    ((r = i.docView.nearest(b)) === null || r === void 0
      ? void 0
      : r.isEditable) != !1
  ) {
    if (g.caretPositionFromPoint) {
      let R = g.caretPositionFromPoint(h, u);
      R && ({ offsetNode: v, offset: S } = R);
    } else if (g.caretRangeFromPoint) {
      let R = g.caretRangeFromPoint(h, u);
      R &&
        (({ startContainer: v, startOffset: S } = R),
        (!i.contentDOM.contains(v) ||
          (F.safari && jp(v, S, h)) ||
          (F.chrome && Hp(v, S, h))) &&
          (v = void 0));
    }
  ...
  if (!v || !i.docView.dom.contains(v)) {
    let R = Me.find(i.docView, d);
    if (!R) return f > a.top + a.height / 2 ? a.to : a.from;
    ({ node: v, offset: S } = $l(R.dom, h, u));
  }
  let C = i.docView.nearest(v);
  if (!C) return null;
  if (
    C.isWidget &&
    ((s = C.dom) === null || s === void 0 ? void 0 : s.nodeType) == 1
  ) {
    let R = C.dom.getBoundingClientRect();
    return e.y < R.top || (e.y <= R.bottom && e.x <= (R.left + R.right) / 2)
      ? C.posAtStart
      : C.posAtEnd;
  } else return C.localPosFromDOM(v, S) + C.posAtStart;
}
function Ch(i, e, t, n, r) {
  ...
  if (i.lineWrapping && t.height > i.defaultLineHeight * 1.5) {
    let l = i.viewState.heightOracle.textHeight,
      a = Math.floor((r - t.top - (i.defaultLineHeight - l) * 0.5) / l);
    s += a * i.viewState.heightOracle.lineLength;
  }
  let o = i.state.sliceDoc(t.from, t.to);
  return t.from + Ol(o, s, i.state.tabSize);
}
function jp(i, e, t) {
  let n;
  ...
  return Qi(i, n - 1, n).getBoundingClientRect().left > t;
}
function Hp(i, e, t) {
  if (e != 0) return !1;
  for (let r = i; ; ) {
  ...
  let n =
    i.nodeType == 1
      ...
      : Qi(i, 0, Math.max(i.nodeValue.length, 1)).getBoundingClientRect();
  return t - n.left > 5;
}
function Ul(i, e, t) {
...
function Wp(i, e, t, n) {
  let r = Ul(i, e.head, e.assoc || -1),
    s =
      !n || r.type != Qe.Text || !(i.lineWrapping || r.widgetLineBreaks)
        ? null
        : i.coordsAtPos(e.assoc < 0 && e.head > r.from ? e.head - 1 : e.head);
  if (s) {
    let o = i.dom.getBoundingClientRect(),
      l = i.textDirectionAt(r.from),
      a = i.posAtCoords({
        x: t == (l == he.LTR) ? o.right - 1 : o.left + 1,
        y: (s.top + s.bottom) / 2,
      });
    if (a != null) return M.cursor(a, t ? -1 : 1);
  }
  return M.cursor(t ? r.to : r.from, t ? -1 : 1);
}
function xh(i, e, t, n) {
  let r = i.state.doc.lineAt(e.head),
    s = i.bidiSpans(r),
    o = i.textDirectionAt(r.from);
  for (let l = e, a = null; ; ) {
    let c = Tp(r, s, o, l, t),
      h = vd;
    if (!c) {
      ...
      ((h = `
`),
        (r = i.state.doc.line(r.number + (t ? 1 : -1))),
        (s = i.bidiSpans(r)),
        (c = i.visualLineSide(r, !t)));
    }
    if (a) {
      if (!a(h)) return l;
    } else {
...
function zp(i, e, t, n) {
  let r = e.head,
    s = t ? 1 : -1;
  if (r == (t ? i.state.doc.length : 0)) return M.cursor(r, e.assoc);
  let o = e.goalColumn,
    l,
    a = i.contentDOM.getBoundingClientRect(),
    c = i.coordsAtPos(r, e.assoc || -1),
    h = i.documentTop;
  if (c) (o == null && (o = c.left - a.left), (l = s < 0 ? c.top : c.bottom));
  else {
    let d = i.viewState.lineBlockAt(r);
    (o == null &&
      (o = Math.min(a.right - a.left, i.defaultCharacterWidth * (r - d.from))),
      (l = (s < 0 ? d.top : d.bottom) + h));
  }
  let u = a.left + o,
    f = n ?? i.viewState.heightOracle.textHeight >> 1;
  for (let d = 0; ; d += 10) {
    let g = l + (f + d) * s,
      p = _d(i, { x: u, y: g }, !1, s);
    if (g < a.top || g > a.bottom || (s < 0 ? p < r : p > r)) {
      let b = i.docView.coordsForChar(p),
        v = !b || g < b.top ? -1 : 1;
      return M.cursor(p, v, void 0, o);
    }
  }
}
function Us(i, e, t) {
...
class $p {
  constructor(e, t) {
    ((this.points = e),
      (this.text = ""),
      (this.lineSeparator = t.facet(Q.lineSeparator)));
  }
  append(e) {
    this.text += e;
  }
  ...
  findPointInside(e, t) {
    for (let n of this.points)
      (e.nodeType == 3 ? n.node == e : e.contains(n.node)) &&
        (n.pos = this.text.length + (Up(e, n.node, n.offset) ? t : 0));
  }
}
function Up(i, e, t) {
  for (;;) {
  ...
  constructor(e, t, n, r) {
    ...
    if (e.state.readOnly && t > -1) this.newSel = null;
      ...
      (a.readRange(this.bounds.startDOM, this.bounds.endDOM),
        (this.text = a.text),
        (this.newSel = Xp(l, this.bounds.from)));
    } else {
      ...
      if (
        ...
        let u = Math.min(a, c),
          ...
          g = h.to - f;
        (d == 0 || d == 1 || u == 0) &&
          (g == 0 || g == -1 || f == e.state.doc.length) &&
          ((a = 0), (c = e.state.doc.length));
      }
...
function Bd(i, e) {
  ...
  if (e.bounds) {
    ...
    (s === 8 || (F.android && e.text.length < l - o)) &&
      ((a = r.to), (c = "end"));
    let h = Jp(i.state.doc.sliceString(o, l, ar), e.text, a - o, c);
    h &&
      (F.chrome &&
        s == 13 &&
        h.toB == h.from + 2 &&
        e.text.slice(h.from, h.toB) == ar + ar &&
        h.toB--,
      (t = {
        from: o + h.from,
        to: o + h.toA,
        insert: ee.of(e.text.slice(h.from, h.toB).split(ar)),
      }));
  } else
    n && ((!i.hasFocus && i.state.facet(si)) || n.main.eq(r)) && (n = null);
  if (!t && !n) return !1;
  if (
    (!t && e.typeOver && !r.empty && n && n.main.empty
      ? (t = {
          from: r.from,
          to: r.to,
      ...
      : (F.mac || F.android) &&
        ...
        ? (n &&
            t.insert.length == 2 &&
            (n = M.single(n.main.anchor - 1, n.main.head - 1)),
          (t = {
            from: t.from,
            to: t.to,
            insert: ee.of([t.insert.toString().replace(".", " ")]),
          }))
        : t &&
            t.from >= r.from &&
            t.to <= r.to &&
          ...
          ? (t = {
              ...
              insert: i.state.doc
                .slice(r.from, t.from)
                .append(t.insert)
                .append(i.state.doc.slice(t.to, r.to)),
            })
          : F.chrome &&
            t &&
            t.from == t.to &&
 ...
 ` &&
            i.lineWrapping &&
            (n && (n = M.single(n.main.anchor - 1, n.main.head - 1)),
            (t = { from: r.from, to: r.to, insert: ee.of([" "]) })),
    t)
  )
    return Rc(i, t, n, s);
  if (n && !n.main.eq(r)) {
...
function Rc(i, e, t, n = -1) {
  if (F.ios && i.inputState.flushIOSKey(e)) return !0;
  let r = i.state.selection.main;
  if (
    F.android &&
    ((e.to == r.to &&
      (e.from == r.from ||
        (e.from == r.from - 1 && i.state.sliceDoc(e.from, r.from) == " ")) &&
      e.insert.length == 1 &&
      e.insert.lines == 2 &&
      dn(i.contentDOM, "Enter", 13)) ||
      (((e.from == r.from - 1 && e.to == r.to && e.insert.length == 0) ||
        (n == 8 && e.insert.length < e.to - e.from && e.to > r.head)) &&
        dn(i.contentDOM, "Backspace", 8)) ||
      (e.from == r.from &&
        e.to == r.to + 1 &&
        e.insert.length == 0 &&
        dn(i.contentDOM, "Delete", 46)))
  )
    return !0;
  ...
  let o,
    l = () => o || (o = Gp(i, e, t));
  return (
    i.state.facet(xd).some((a) => a(i, e.from, e.to, s, l)) || i.dispatch(l()),
    !0
  );
}
function Gp(i, e, t) {
  ...
  if (
    ...
    n = r.replaceSelection(
      i.state.toText(
        l + e.insert.sliceString(0, void 0, i.state.lineBreak) + a,
      ),
    );
  } else {
    let l = r.changes(e),
    ...
    if (
      ...
      let c = i.state.sliceDoc(e.from, e.to),
        h,
        u = t && Nd(i, t.main.head);
      if (u) {
        let g = e.insert.length - (e.to - e.from);
        h = { from: u.from, to: u.to - g };
      ...
      n = r.changeByRange((g) => {
        ...
        if (
          g.to - g.from != d ||
          i.state.sliceDoc(b, p) != c ||
          (g.to >= h.from && g.from <= h.to)
        )
          return { range: g };
        let v = r.changes({ from: b, to: p, insert: e.insert }),
          S = g.to - s.to;
        return {
          changes: v,
          range: a
            ? M.range(Math.max(0, a.anchor + S), Math.max(0, a.head + S))
            : g.map(v),
        };
      });
    } else n = { changes: l, selection: a && r.selection.replaceRange(a) };
  }
  let o = "input.type";
  return (
    (i.composing ||
...
function Jp(i, e, t, n) {
  let r = Math.min(i.length, e.length),
    s = 0;
...
function Yp(i) {
  ...
  return (
    t && (e.push(new Mh(t, n)), (r != t || s != n) && e.push(new Mh(r, s))),
    e
  );
}
function Xp(i, e) {
...
class Qp {
  ...
  constructor(e) {
    ((this.view = e),
      ...
      F.gecko && g0(e.contentDOM.ownerDocument));
  }
  handleEvent(e) {
    !o0(this.view, e) ||
  ...
  keydown(e) {
    ...
    return F.ios &&
      ...
      !e.altKey &&
      !e.metaKey &&
      (((t = Id.find((n) => n.keyCode == e.keyCode)) && !e.ctrlKey) ||
        (e0.indexOf(e.key) > -1 && e.ctrlKey && !e.shiftKey))
...
function Zp(i) {
  ...
  for (let n of i) {
    ...
    if (s)
      for (let l in s) {
        let a = s[l];
        a && t(l).handlers.push(Dh(n.value, a));
      }
    if (o)
      for (let l in o) {
        let a = o[l];
        a && t(l).observers.push(Dh(n.value, a));
      }
  }
  for (let n in Mt) t(n).handlers.push(Mt[n]);
  for (let n in bt) t(n).observers.push(bt[n]);
  return e;
}
const Id = [
...
class i0 {
  constructor(e, t, n, r) {
    ((this.view = e),
      ...
      (this.scrolling = -1),
      (this.lastEvent = t),
      (this.scrollParents = cp(e.contentDOM)),
      (this.atoms = e.state.facet(Dc).map((o) => o(e))));
    ...
    (s.addEventListener("mousemove", (this.move = this.move.bind(this))),
      ...
      (this.multiple = e.state.facet(Q.allowMultipleSelections) && n0(e, t)),
      (this.dragging = s0(e, t) && Hd(t) == 1 ? null : !1));
  }
  start(e) {
  ...
  move(e) {
    ...
    if (this.dragging || (this.dragging == null && t0(this.startEvent, e) < 10))
      return;
    ...
    let a = Tc(this.view);
    (e.clientX - a.left <= r + ws
      ? (t = -Ss(r - e.clientX))
      : e.clientX + a.right >= o - ws && (t = Ss(e.clientX - o)),
      e.clientY - a.top <= s + ws
        ? (n = -Ss(s - e.clientY))
        : e.clientY + a.bottom >= l - ws && (n = Ss(e.clientY - l)),
  ...
  skipAtoms(e) {
    ...
    for (let n = 0; n < e.ranges.length; n++) {
      let r = e.ranges[n],
        s = null;
      if (r.empty) {
        let o = Us(this.atoms, r.from, 0);
        o != r.from && (s = M.cursor(o, -1));
      } else {
        let o = Us(this.atoms, r.from, -1),
          l = Us(this.atoms, r.to, 1);
        (o != r.from || l != r.to) &&
          (s = M.range(r.from == r.anchor ? o : l, r.from == r.head ? o : l));
      }
...
const Mt = Object.create(null),
  ...
  Fd = (F.ie && F.ie_version < 15) || (F.ios && F.webkit_version < 604);
function l0(i) {
  ...
  ((t.style.cssText = "position: fixed; left: -10000px; top: 10px"),
    t.focus(),
    setTimeout(() => {
      (i.focus(), t.remove(), jd(i, t.value));
    }, 50));
}
function Eo(i, e, t) {
  for (let n of i.facet(e)) t = n(t, i);
  return t;
}
function jd(i, e) {
  e = Eo(i.state, Cc, e);
...
Mt.mousedown = (i, e) => {
  if ((i.observer.flush(), i.inputState.lastTouchTime > Date.now() - 2e3))
    return !1;
  let t = null;
  for (let n of i.state.facet(kd)) if (((t = n(i, e)), t)) break;
  if ((!t && e.button == 0 && (t = h0(i, e)), t)) {
    let n = !i.hasFocus;
    (i.inputState.startMouseSelection(new i0(i, e, t, n)),
      n &&
        i.observer.ignore(() => {
          td(i.contentDOM);
...
function Th(i, e, t, n) {
  if (n == 1) return M.cursor(e, t);
  if (n == 2) return Ip(i.state, e, t);
  {
    let r = Me.find(i.docView, e),
      s = i.state.doc.lineAt(r ? r.posAtEnd : e),
      o = r ? r.posAtStart : s.from,
      l = r ? r.posAtEnd : s.to;
    return (l < i.state.doc.length && l == s.to && l++, M.range(o, l));
  }
}
let Rh = (i, e, t) =>
  e >= t.top && e <= t.bottom && i >= t.left && i <= t.right;
function a0(i, e, t, n) {
  let r = Me.find(i.docView, e);
  if (!r) return 1;
  ...
  if (o && Rh(t, n, o)) return -1;
  let l = r.coordsAt(s, 1);
  return l && Rh(t, n, l) ? 1 : o && o.bottom >= n ? -1 : 1;
}
function Ah(i, e) {
  let t = i.posAtCoords({ x: e.clientX, y: e.clientY }, !1);
  return { pos: t, bias: a0(i, t, e.clientX, e.clientY) };
}
const c0 = F.ie && F.ie_version <= 11;
let Ph = null,
  Oh = 0,
  Eh = 0;
function Hd(i) {
  if (!c0) return i.detail;
  let e = Ph,
    t = Eh;
  return (
    (Ph = i),
...
function h0(i, e) {
  ...
  return {
    ...
    get(s, o, l) {
      let a = Ah(i, s),
        c,
        h = Th(i, a.pos, a.bias, n);
      if (t.pos != a.pos && !o) {
        let u = Th(i, t.pos, t.bias, n),
      ...
      return o
        ...
        : l && n == 1 && r.ranges.length > 1 && (c = u0(r, a.pos))
          ? c
          : l
            ? r.addRange(h)
            : M.create([h]);
  ...
  return (
    ...
    e.dataTransfer &&
      (e.dataTransfer.setData(
        "Text",
        Eo(i.state, xc, i.state.sliceDoc(t.from, t.to)),
      ),
      (e.dataTransfer.effectAllowed = "copyMove")),
    !1
  );
};
Mt.dragend = (i) => ((i.inputState.draggedContent = null), !1);
function Lh(i, e, t, n) {
  if (((t = Eo(i.state, Cc, t)), !t)) return;
  let r = i.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
    { draggedContent: s } = i.inputState,
    o = n && s && r0(i, e) ? { from: s.from, to: s.to } : null,
    l = { from: r, insert: t },
...
Mt.drop = (i, e) => {
  ...
  if (t && t.length) {
    let n = Array(t.length),
      ...
      s = () => {
        ++r == t.length &&
          Lh(i, e, n.filter((o) => o != null).join(i.state.lineBreak), !1);
      };
...
Mt.paste = (i, e) => {
  if (i.state.readOnly) return !0;
  i.observer.flush();
  let t = Fd ? null : e.clipboardData;
  return t
    ? (jd(i, t.getData("text/plain") || t.getData("text/uri-list")), !0)
    : (l0(i), !1);
};
function f0(i, e) {
...
function d0(i) {
  ...
  return { text: Eo(i, xc, e.join(i.lineBreak)), ranges: t, linewise: n };
}
let Kl = null;
Mt.copy = Mt.cut = (i, e) => {
  let { text: t, ranges: n, linewise: r } = d0(i.state);
  if (!t && !r) return !1;
  ((Kl = r ? t : null),
    e.type == "cut" &&
      !i.state.readOnly &&
      i.dispatch({ changes: n, scrollIntoView: !0, userEvent: "delete.cut" }));
  let s = Fd ? null : e.clipboardData;
  return s ? (s.clearData(), s.setData("text/plain", t), !0) : (f0(i, t), !1);
};
const Wd = ui.define();
function Vd(i, e) {
  let t = [];
  for (let n of i.facet(Md)) {
    let r = n(i, e);
    r && t.push(r);
  }
  return t.length ? i.update({ effects: t, annotations: Wd.of(!0) }) : null;
}
function zd(i) {
  setTimeout(() => {
    let e = i.hasFocus;
...
bt.blur = (i) => {
  (i.observer.clearSelectionRange(), zd(i));
};
...
Mt.beforeinput = (i, e) => {
  ...
  if (e.inputType == "insertReplacementText" && i.observer.editContext) {
    ...
    if (s && o.length) {
      let l = o[0],
        a = i.posAtDOM(l.startContainer, l.startOffset),
        c = i.posAtDOM(l.endContainer, l.endOffset);
      return (Rc(i, { from: a, to: c, insert: i.state.toText(s) }, null), !0);
    }
  }
  let r;
  if (
    F.chrome &&
    F.android &&
    (r = Id.find((s) => s.inputType == e.inputType)) &&
  ...
  return (
    F.ios && e.inputType == "deleteContentForward" && i.observer.flushSoon(),
    F.safari &&
      e.inputType == "insertText" &&
      i.inputState.composing >= 0 &&
      setTimeout(() => bt.compositionend(i, e), 20),
    !1
  );
};
const Nh = new Set();
...
class Ze {
  ...
  setHeight(e) {
    this.height != e &&
      (Math.abs(this.height - e) > Ks && (wn = !0), (this.height = e));
  }
  replace(e, t, n) {
    return Ze.of(n);
  }
  ...
  applyChanges(e, t, n, r) {
    ...
    for (let l = r.length - 1; l >= 0; l--) {
      let { fromA: a, toA: c, fromB: h, toB: u } = r[l],
        f = s.lineAt(a, ce.ByPosNoHeight, n.setDoc(t), 0, 0),
        d = f.to >= c ? f : s.lineAt(c, ce.ByPosNoHeight, n, 0, 0);
      for (u += d.to - c, c = d.to; l > 0 && f.from <= r[l - 1].toA; )
        ((a = r[l - 1].fromA),
          (h = r[l - 1].fromB),
          l--,
          a < f.from && (f = s.lineAt(a, ce.ByPosNoHeight, n, 0, 0)));
      ((h += f.from - a), (a = f.from));
      let g = Ac.build(n.setDoc(o), e, h, u);
      s = no(s, s.replace(a, c, g));
    }
  ...
  static of(e) {
    ...
    return (
      ...
      new y0(Ze.of(e.slice(0, t)), o, Ze.of(e.slice(n)))
    );
  }
}
function no(i, e) {
  return i == e ? i : (i.constructor != e.constructor && (wn = !0), e);
}
Ze.prototype.size = 1;
class $d extends Ze {
  constructor(e, t, n) {
...
class at extends $d {
  ...
  replace(e, t, n) {
    let r = n[0];
    return n.length == 1 &&
      (r instanceof at || (r instanceof Be && r.flags & 4)) &&
      Math.abs(this.length - r.length) < 10
      ? (r instanceof Be
          ? (r = new at(r.length, this.height))
...
class Be extends Ze {
  ...
  blockAt(e, t, n, r) {
    ...
    if (t.lineWrapping) {
      ...
      let c = Math.max(0, Math.min(o - s, Math.floor((e - n) / l))),
        { from: h, length: u } = t.doc.line(s + c);
      return new It(h, u, n + l * c, l, 0);
    }
  }
  lineAt(e, t, n, r, s) {
    if (t == ce.ByHeight) return this.blockAt(e, n, r, s);
    if (t == ce.ByPosNoHeight) {
      let { from: d, to: g } = n.doc.lineAt(e);
      return new It(d, g - d, 0, 0, 0);
    }
    let { firstLine: o, perLine: l, perChar: a } = this.heightMetrics(n, s),
      c = n.doc.lineAt(e),
      h = l + c.length * a,
      u = c.number - o,
      f = r + l * u + a * (c.from - s - u);
    return new It(
      c.from,
      c.length,
  ...
  replace(e, t, n) {
    ...
    if (r > 0) {
      let s = n[n.length - 1];
      s instanceof Be
        ? (n[n.length - 1] = new Be(s.length + r))
        : n.push(null, new Be(r - 1));
    }
    if (e > 0) {
      let s = n[0];
      s instanceof Be
        ? (n[0] = new Be(e + s.length))
        : n.unshift(new Be(e - 1), null);
    }
    return Ze.of(n);
  }
  decomposeLeft(e, t) {
  ...
  updateHeight(e, t = 0, n = !1, r) {
    ...
    if (r && r.from <= t + this.length && r.more) {
      let o = [],
        ...
        a = -1;
      for (
        r.from > t && o.push(new Be(r.from - t - 1).updateHeight(e, t));
        l <= s && r.more;
      ) {
        let h = e.doc.lineAt(l).length;
        o.length && o.push(null);
        let u = r.heights[r.index++];
        a == -1 ? (a = u) : Math.abs(u - a) >= Ks && (a = -2);
        let f = new at(h, u);
      ...
      return (
        (a < 0 ||
          Math.abs(c.height - this.height) >= Ks ||
          Math.abs(a - this.heightMetrics(e, t).perLine) >= Ks) &&
          (wn = !0),
        no(this, c)
      );
    } else
...
class y0 extends Ze {
  ...
  lineAt(e, t, n, r, s) {
    let o = r + this.left.height,
      ...
      a = t == ce.ByHeight ? e < o : e < l,
      c = a
        ? this.left.lineAt(e, t, n, r, s)
        : this.right.lineAt(e, t, n, o, l);
    if (this.break || (a ? c.to < l : c.from > l)) return c;
    let h = t == ce.ByPosNoHeight ? ce.ByPosNoHeight : ce.ByPos;
    return a
      ? c.join(this.right.lineAt(l, h, n, o, l))
      : this.left.lineAt(l, h, n, r, s).join(c);
  }
  forEachLine(e, t, n, r, s, o) {
    let l = r + this.left.height,
      a = s + this.left.length + this.break;
    if (this.break)
      (e < a && this.left.forEachLine(e, t, n, r, s, o),
        t >= a && this.right.forEachLine(e, t, n, l, a, o));
    else {
      let c = this.lineAt(a, ce.ByPos, n, r, s);
      (e < c.from && this.left.forEachLine(e, c.from - 1, n, r, s, o),
        c.to >= e && c.from <= t && o(c),
        t > c.to && this.right.forEachLine(c.to + 1, t, n, l, a, o));
    }
  }
  replace(e, t, n) {
    ...
    if ((e > 0 && Ih(s, o - 1), t < this.length)) {
      let l = s.length;
      (this.decomposeRight(t, s), Ih(s, l));
    }
    return Ze.of(s);
  }
  decomposeLeft(e, t) {
  ...
  balanced(e, t) {
    return e.size > 2 * t.size || t.size > 2 * e.size
      ...
      : ((this.left = no(this.left, e)),
        (this.right = no(this.right, t)),
  ...
  updateHeight(e, t = 0, n = !1, r) {
    ...
    return (
      r && r.from <= t + s.length && r.more
        ? (a = s = s.updateHeight(e, t, n, r))
        : s.updateHeight(e, t, n),
      r && r.from <= l + o.length && r.more
        ? (a = o = o.updateHeight(e, l, n, r))
...
function Ih(i, e) {
  let t, n;
  i[e] == null &&
    (t = i[e - 1]) instanceof Be &&
    (n = i[e + 1]) instanceof Be &&
    i.splice(e - 1, 3, new Be(t.length + 1 + n.length));
}
const b0 = 5;
class Ac {
  constructor(e, t) {
    ...
    if (this.lineStart > -1) {
      ...
      (r instanceof at
        ...
        : (n > this.pos || !this.isCovered) &&
          this.nodes.push(new at(n - this.pos, -1)),
        (this.writtenTo = n),
        t > n &&
  ...
  point(e, t, n) {
    if (e < t || n.heightRelevant) {
      ...
      let o = t - e;
      n.block
        ? this.addBlock(new $d(o, r, n))
        : (o || s || r >= b0) && this.addLineDeco(r, s, o);
  ...
  enterLine() {
    ...
    ((this.lineStart = e),
      ...
      this.pos > e && this.nodes.push(new at(this.pos - e, -1)),
  ...
  finish(e) {
    ...
    this.lineStart > -1 && !(t instanceof at) && !this.isCovered
      ? this.nodes.push(new at(0, -1))
      : (this.writtenTo < this.pos || t == null) &&
        this.nodes.push(this.blankContent(this.writtenTo, this.pos));
    let n = e;
    for (let r of this.nodes)
      (r instanceof at && r.updateHeight(this.oracle, n),
        (n += r ? r.length : 1));
    return this.nodes;
  }
    ...
    if (c.nodeType == 1) {
      ...
      if (
        ...
        ((s = Math.max(s, f.left)),
          ...
          (l = Math.max(l, f.top)),
          (a = Math.min(c == i.parentNode ? r.innerHeight : a, f.bottom)));
      }
      c =
...
class qh {
  constructor(e) {
    ...
    ((this.heightOracle = new m0(t)),
      (this.stateDeco = e.facet(Cr).filter((n) => typeof n != "function")),
      (this.heightMap = Ze.empty().applyChanges(
        this.stateDeco,
        ee.empty,
        this.heightOracle.setDoc(e.doc),
        [new pt(0, 0, 0, e.doc.length)],
      )));
    for (
      let n = 0;
      n < 2 &&
    ...
    (this.updateViewportLines(),
      ...
      (this.lineGapDeco = $.set(this.lineGaps.map((n) => n.draw(this, !1)))),
  ...
  updateForViewport() {
    ...
    return (
      (this.viewports = e.sort((n, r) => n.from - r.from)),
      this.updateScaler()
    );
  }
  updateScaler() {
    ...
    return (
      (this.scaler =
        this.heightMap.height <= 7e6
          ? Fh
          : new Pc(this.heightOracle, this.heightMap, this.viewports)),
  ...
  updateViewportLines() {
    ((this.viewportLines = []),
      this.heightMap.forEachLine(
        ...
        0,
        (e) => {
          this.viewportLines.push(cr(e, this.scaler));
        },
      ));
  }
  update(e, t = null) {
    ...
    this.stateDeco = this.state.facet(Cr).filter((h) => typeof h != "function");
    let r = e.changedRanges,
      s = pt.extendWithRanges(
        r,
        v0(n, this.stateDeco, e ? e.changes : Te.empty(this.state.doc.length)),
      ),
    ...
    (Bh(),
      ...
      (this.heightMap.height != o || wn) && (e.flags |= 2),
      l
  ...
  measure(e) {
    ...
    let c = 0,
      h = 0;
    if (l.width && l.height) {
      let { scaleX: R, scaleY: D } = ed(t, l);
      ((R > 0.005 && Math.abs(this.scaleX - R) > 0.005) ||
        (D > 0.005 && Math.abs(this.scaleY - D) > 0.005)) &&
        ((this.scaleX = R), (this.scaleY = D), (c |= 16), (o = a = !0));
    }
    ...
    (this.scrollTop != d &&
      ...
      (this.scrolledToBottom = nd(e.scrollDOM)));
    let g = (this.printing ? C0 : S0)(t, this.paddingTop),
      p = g.top - this.pixelViewport.top,
    ...
    if (
      (v != this.inView && ((this.inView = v), v && (a = !0)),
      !this.inView && !this.scrollTarget && !k0(e.dom))
    )
      return 0;
    let S = l.width;
    if (
      ...
      if (
        (r.mustRefreshForHeights(R) && (o = !0),
        o ||
          (r.lineWrapping && Math.abs(S - this.contentDOMWidth) > r.charWidth))
      ) {
        let {
          lineHeight: D,
          charWidth: T,
        ...
        ((o = D > 0 && r.refresh(s, D, T, A, S / T, R)),
          o && ((e.docView.minWidth = 0), (c |= 16)));
      }
      (p > 0 && b > 0
        ? (h = Math.max(p, b))
        : p < 0 && b < 0 && (h = Math.min(p, b)),
        Bh());
      for (let D of this.viewports) {
        let T =
          D.from == this.viewport.from
            ? R
            : e.docView.measureVisibleLineHeights(D);
        this.heightMap = (
          o
            ? Ze.empty().applyChanges(
                ...
                ee.empty,
                this.heightOracle,
                [new pt(0, 0, 0, e.state.doc.length)],
              )
            : this.heightMap
        ).updateHeight(r, 0, o, new p0(D.from, T));
      }
      wn && (c |= 2);
    }
    let C =
    ...
    return (
      ...
      (c & 2 || C) && this.updateViewportLines(),
      (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
  ...
  getViewport(e, t) {
    let n = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)),
      ...
      a = new ks(
        r.lineAt(o - n * 1e3, ce.ByHeight, s, 0, 0).from,
        r.lineAt(l + (1 - n) * 1e3, ce.ByHeight, s, 0, 0).to,
      );
    if (t) {
      let { head: c } = t.range;
      if (c < a.from || c > a.to) {
        ...
        (t.y == "center"
          ...
          : t.y == "start" || (t.y == "nearest" && c < a.from)
            ? (f = u.top)
            : (f = u.bottom - h),
          (a = new ks(
  ...
  mapViewport(e, t) {
    let n = t.mapPos(e.from, -1),
      r = t.mapPos(e.to, 1);
    return new ks(
      this.heightMap.lineAt(n, ce.ByPos, this.heightOracle, 0, 0).from,
  ...
  viewportIsAppropriate({ from: e, to: t }, n = 0) {
    ...
    let { top: r } = this.heightMap.lineAt(
      ...
      { visibleTop: o, visibleBottom: l } = this;
    return (
      (e == 0 || r <= o - Math.max(10, Math.min(-n, 250))) &&
      (t == this.state.doc.length || s >= l + Math.max(10, Math.min(n, 250))) &&
      r > o - 2 * 1e3 &&
      s < l + 2 * 1e3
    );
  }
  mapLineGaps(e, t) {
    ...
    for (let r of e)
      t.touchesRange(r.from, r.to) ||
        n.push(new Yo(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize));
    return n;
  }
  ensureLineGaps(e, t) {
    let n = this.heightOracle.lineWrapping,
      ...
      s = r >> 1,
      o = r << 1;
    if (this.defaultTextDirection != he.LTR && !n) return [];
    let l = [],
      a = (h, u, f, d) => {
        if (u - h < s) return;
        ...
        if (!b) {
          if (
            ...
            t &&
            n &&
            t.visibleRanges.some((C) => C.from <= u && C.to >= u)
          ) {
            let C = t.moveToLineBoundary(M.cursor(u), !1, !0).head;
            C > h && (u = C);
          }
          let v = this.gapSize(f, h, u, d),
            S = n || v < 2e6 ? v : 2e6;
          b = new Yo(h, u, v, S);
        }
        l.push(b);
      ...
      c = (h) => {
        if (h.length < o || h.type != Qe.Text) return;
        let u = M0(h.from, h.to, this.stateDeco);
        if (u.total < o) return;
        ...
        if (n) {
          ...
          if (f != null) {
            let S = xs(u, f),
              C = ((this.visibleBottom - this.visibleTop) / 2 + p) / h.height;
            ((b = S - C), (v = S + C));
          } else
            ((b = (this.visibleTop - h.top - p) / h.height),
              (v = (this.visibleBottom - h.top + p) / h.height));
          ((d = Cs(u, b)), (g = Cs(u, v)));
        } else {
          let p = u.total * this.heightOracle.charWidth,
            b = r * this.heightOracle.charWidth,
            v = 0;
          if (p > 2e6)
            for (let T of e)
              T.from >= h.from &&
                T.from < h.to &&
                T.size != T.displaySize &&
                T.from * this.heightOracle.charWidth + v <
                  this.pixelViewport.left &&
                (v = T.size - T.displaySize);
          let S = this.pixelViewport.left + v,
            C = this.pixelViewport.right + v,
            R,
            D;
          if (f != null) {
            let T = xs(u, f),
              A = ((C - S) / 2 + b) / p;
            ((R = T - A), (D = T + A));
          } else ((R = (S - b) / p), (D = (C + b) / p));
          ((d = Cs(u, R)), (g = Cs(u, D)));
        }
        (d > h.from && a(h.from, d, h, u), g < h.to && a(g, h.to, h, u));
      };
  ...
  updateLineGaps(e) {
    Yo.same(e, this.lineGaps) ||
      ((this.lineGaps = e),
      (this.lineGapDeco = $.set(
  ...
  lineBlockAt(e) {
    return (
      ...
      cr(
        this.heightMap.lineAt(e, ce.ByPos, this.heightOracle, 0, 0),
        this.scaler,
      )
    );
  }
...
function Cs({ total: i, ranges: e }, t) {
...
class Pc {
  constructor(e, t, n) {
    ...
    ((this.viewports = n.map(({ from: l, to: a }) => {
      let c = t.lineAt(l, ce.ByPos, e, 0, 0).top,
        h = t.lineAt(a, ce.ByPos, e, 0, 0).bottom;
      return (
        (r += h - c),
...
function cr(i, e) {
  ...
  return new It(
    ...
    t,
    n - t,
    Array.isArray(i._content) ? i._content.map((r) => cr(r, e)) : i._content,
  );
}
const Ms = I.define({ combine: (i) => i.join(" ") }),
  Gl = I.define({ combine: (i) => i.indexOf(!0) > -1 }),
  Jl = ki.newName(),
  Ud = ki.newName(),
  Kd = ki.newName(),
  Gd = { "&light": "." + Ud, "&dark": "." + Kd };
...
const T0 = Yl(
  ...
  Xo = F.ie && F.ie_version <= 11;
class A0 {
  constructor(e) {
    ((this.view = e),
      (this.active = !1),
      (this.editContext = null),
      (this.selectionRange = new hp()),
  ...
  onSelectionChange(e) {
    ...
    if (n.state.facet(si) ? n.root.activeElement != this.dom : !zs(this.dom, r))
      return;
    ...
    r.focusNode &&
    gr(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset)
      ? this.flushSoon()
      : this.flush(!1);
  }
  readSelectionRange() {
  ...
  start() {
    this.active ||
      (this.observer.observe(this.dom, R0),
      Xo &&
    ...
    if (!this.delayedAndroidKey) {
      let r = () => {
        ...
        s &&
          ...
          !this.flush() && s.force && dn(this.dom, s.key, s.keyCode));
      };
  ...
  readChange() {
    let { from: e, to: t, typeOver: n } = this.processRecords(),
      r = this.selectionChanged && zs(this.dom, this.selectionRange);
    if (e < 0 && !r) return null;
    (e > -1 && (this.lastChange = Date.now()),
      (this.view.inputState.lastFocusTime = 0),
      (this.selectionChanged = !1));
    let s = new Kp(this.view, e, t, n);
    return (
  ...
  readMutation(e) {
    ...
    if (
      ...
      let n = jh(t, e.previousSibling || e.target.previousSibling, -1),
        r = jh(t, e.nextSibling || e.target.nextSibling, 1);
      return {
  ...
  update(e) {
    this.editContext &&
      ...
      e.startState.facet(si) != e.state.facet(si) &&
        (e.view.contentDOM.editContext = e.state.facet(si)
...
function Hh(i, e) {
  ...
  return (
    gr(o.node, o.offset, r, s) && ([t, n, r, s] = [r, s, t, n]),
    { anchorNode: t, anchorOffset: n, focusNode: r, focusOffset: s }
  );
}
function P0(i, e) {
  ...
  constructor(e) {
    ...
    ((this.handlers.textupdate = (n) => {
      let r = e.state.selection.main,
        { anchor: s, head: o } = r,
        l = this.toEditorPos(n.updateRangeStart),
        a = this.toEditorPos(n.updateRangeEnd);
...
`),
      ...
      if (
        (c.from == this.from && s < this.from
          ? (c.from = s)
          : c.to == this.to && s > this.to && (c.to = s),
        c.from == c.to && !c.insert.length)
      ) {
        let h = M.single(
      ...
      if (
        ((F.mac || F.android) &&
          ...
          (c = { from: l, to: a, insert: ee.of([n.text.replace(".", " ")]) }),
        (this.pendingContextChange = c),
        !e.state.readOnly)
      ) {
        ...
        Rc(
          ...
          c,
          M.single(
            this.toEditorPos(n.selectionStart, h),
            this.toEditorPos(n.selectionEnd, h),
          ),
        );
      }
        ...
        for (let s of n.getTextFormats()) {
          ...
          if (o != "None" && l != "None") {
            ...
            if (a < c) {
              ...
              r.push($.mark({ attributes: { style: h } }).range(a, c));
            }
          }
        }
        e.dispatch({ effects: Ad.of($.set(r)) });
      }),
  ...
  applyEdits(e) {
    ...
    return (
      e.changes.iterChanges((s, o, l, a, c) => {
        if (n) return;
        let h = c.length - (o - s);
        if (r && o >= r.to)
...
class q {
  ...
  constructor(e = {}) {
    ...
    ((this.dispatchTransactions =
      ...
      (n && ((r) => r.forEach((s) => n(s, this)))) ||
      ((r) => this.update(r))),
      (this.dispatch = this.dispatch.bind(this)),
      (this._root = e.root || up(e.parent) || document),
      (this.viewState = new qh(e.state || Q.create(e))),
      e.scrollTo &&
        e.scrollTo.is(vs) &&
        (this.viewState.scrollTarget = e.scrollTo.value.clip(
          this.viewState.state,
        )),
      (this.plugins = this.state.facet(cn).map((r) => new Ko(r))));
    for (let r of this.plugins) r.update(this);
    ((this.observer = new A0(this)),
      (this.inputState = new Qp(this)),
      this.inputState.ensureHandlers(this.plugins),
      (this.docView = new vh(this)),
      this.mountStyles(),
      this.updateAttrs(),
      (this.updateState = 0),
      this.requestMeasure(),
  ...
  update(e) {
    ...
    let o = this.hasFocus,
      l = 0,
      a = null;
    e.some((f) => f.annotation(Wd))
      ? ((this.inputState.notifiedFocused = o), (l = 1))
      : o != this.inputState.notifiedFocused &&
        ((this.inputState.notifiedFocused = o), (a = Vd(s, o)), a || (l = 1));
      ...
      (c
        ? (this.observer.clearDelayedAndroidKey(),
          ...
          ((h && !this.state.doc.eq(s.doc)) ||
            ...
            (h = null))
        : this.observer.clear(),
      s.facet(Q.phrases) != this.state.facet(Q.phrases))
    )
      return this.setState(s);
    ((r = io.create(this, s, e)), (r.flags |= l));
    ...
    try {
      ...
      for (let f of e) {
        ...
        for (let d of f.effects) d.is(vs) && (u = d.value.clip(this.state));
      }
      (this.viewState.update(r, u),
        (this.bidiCache = ro.update(this.bidiCache, r.changes)),
      ...
      Promise.resolve().then(() => {
        (a && this.state == a.startState && this.dispatch(a),
          h &&
            !Bd(this, h) &&
            c.force &&
            dn(this.contentDOM, c.key, c.keyCode));
      });
  }
  setState(e) {
    if (this.updateState != 0)
    ...
    try {
      ...
      ((this.viewState = new qh(e)),
        (this.plugins = e.facet(cn).map((n) => new Ko(n))),
  ...
  updatePlugins(e) {
    let t = e.startState.facet(cn),
      n = e.state.facet(cn);
    if (t != n) {
      let r = [];
      for (let s of n) {
        let o = t.indexOf(s);
        if (o < 0) r.push(new Ko(s));
        else {
    ...
    for (let e of this.plugins) {
      ...
      if (t && t.docViewUpdate)
        try {
          ...
          rt(this.state, n, "doc view update listener");
        }
    }
  }
  measure(e = !0) {
    ...
    try {
      for (let l = 0; ; l++) {
        if (o < 0)
          if (nd(n)) ((s = -1), (o = this.viewState.heightMap.height));
          else {
        ...
        let h = c.map((d) => {
            try {
              ...
              return (rt(this.state, g), Wh);
            }
          }),
          u = io.create(this, this.state, []),
          f = !1;
        ((u.flags |= a),
          t ? (t.flags |= a) : (t = u),
          (this.updateState = 2),
        ...
        if (
          ...
          if (this.viewState.editorHeight)
            if (this.viewState.scrollTarget) {
              ...
              if (g > 1 || g < -1) {
                ((r = r + g), (n.scrollTop = r / this.scaleY), (o = -1));
                continue;
              }
            }
          break;
    ...
    if (t && !t.empty) for (let l of this.state.facet(zl)) l(t);
  }
  get themeClasses() {
    return (
      Jl + " " + (this.state.facet(Gl) ? Kd : Ud) + " " + this.state.facet(Ms)
    );
  }
  updateAttrs() {
    let e = Vh(this, Pd, {
    ...
    (this.state.readOnly && (t["aria-readonly"] = "true"), Vh(this, Mc, t));
    let n = this.observer.ignore(() => {
      let r = Fl(this.contentDOM, this.contentAttrs, t),
        s = Fl(this.dom, this.editorAttrs, e);
      return r || s;
    });
  ...
  mountStyles() {
    ...
    ki.mount(
      this.root,
      this.styleModules.concat(T0).reverse(),
      e ? { nonce: e } : void 0,
    );
  }
  readMeasured() {
  ...
  plugin(e) {
    ...
    return (
      (t === void 0 || (t && t.plugin != e)) &&
        this.pluginMap.set(
          e,
          (t = this.plugins.find((n) => n.plugin == e) || null),
        ),
  ...
  moveByChar(e, t, n) {
    return Jo(this, e, xh(this, e, t, n));
  }
  moveByGroup(e, t) {
    return Jo(
      this,
      e,
      xh(this, e, t, (n) => Vp(this, e.head, n)),
    );
  }
  visualLineSide(e, t) {
  ...
  moveVertically(e, t, n) {
    return Jo(this, e, zp(this, e, t, n));
  }
  domAtPos(e) {
  ...
  coordsAtPos(e, t = 1) {
    ...
    let r = this.state.doc.lineAt(e),
      s = this.bidiSpans(r),
      o = s[vi.find(s, e - r.from, -1, t)];
    return Po(n, (o.dir == he.LTR) == t > 0);
  }
  coordsForChar(e) {
  ...
  bidiSpans(e) {
    if (e.length > E0) return bd(e.length);
    ...
    for (let s of this.bidiCache)
      if (
        s.from == e.from &&
        s.dir == t &&
        (s.fresh || yd(s.isolates, (n = bh(this, e))))
      )
        return s.order;
    n || (n = bh(this, e));
    let r = Dp(e.text, t, n);
    return (this.bidiCache.push(new ro(e.from, e.to, t, n, !0, r)), r);
  }
  get hasFocus() {
    var e;
    return (
  ...
  scrollSnapshot() {
    ...
    return vs.of(new gn(M.cursor(n.from), "start", "start", n.top - e, t, !0));
  }
  setTabFocusMode(e) {
    e == null
  ...
  static domEventHandlers(e) {
    return xe.define(() => ({}), { eventHandlers: e });
  }
  static domEventObservers(e) {
    return xe.define(() => ({}), { eventObservers: e });
  }
  static theme(e, t) {
    let n = ki.newName(),
      r = [Ms.of(n), lr.of(Yl(`.${n}`, e))];
    return (t && t.dark && r.push(Gl.of(!0)), r);
  }
  static baseTheme(e) {
    return Ti.lowest(lr.of(Yl("." + Jl, e, Gd)));
  }
...
q.styleModule = lr;
q.inputHandler = xd;
q.clipboardInputFilter = Cc;
q.clipboardOutputFilter = xc;
q.scrollHandler = Rd;
q.focusChangeEffect = Md;
q.perLineTextDirection = Dd;
q.exceptionSink = Cd;
q.updateListener = zl;
q.editable = si;
q.mouseSelectionStyle = kd;
q.dragMovesSelection = Sd;
q.clickAddsSelectionRange = wd;
q.decorations = Cr;
q.outerDecorations = Od;
q.atomicRanges = Dc;
q.bidiIsolatedRanges = Ed;
q.scrollMargins = Ld;
q.darkTheme = Gl;
q.cspNonce = I.define({ combine: (i) => (i.length ? i[0] : "") });
q.contentAttributes = Mc;
q.editorAttributes = Pd;
...
const L0 = F.mac ? "mac" : F.windows ? "win" : F.linux ? "linux" : "key";
function N0(i, e) {
  const t = i.split(/-(?!$)/);
  let n = t[t.length - 1];
  n == "Space" && (n = " ");
...
const _0 = Ti.default(
    q.domEventHandlers({
      keydown(i, e) {
        return Yd(Jd(e.state), i, e, "editor");
      },
    }),
  ),
  Vr = I.define({ enables: _0 }),
  zh = new WeakMap();
function Jd(i) {
  let e = i.facet(Vr),
    t = zh.get(e);
  return (t || zh.set(e, (t = q0(e.reduce((n, r) => n.concat(r), [])))), t);
}
function B0(i, e, t) {
  return Yd(Jd(i.state), e, i, t);
}
let pi = null;
const I0 = 4e3;
function q0(i, e = L0) {
  let t = Object.create(null),
    ...
    s = (o, l, a, c, h) => {
      ...
      let d = t[o] || (t[o] = Object.create(null)),
        g = l.split(/ (?!$)/).map((v) => N0(v, e));
      for (let v = 1; v < g.length; v++) {
        let S = g.slice(0, v).join(" ");
        (r(S, !0),
          d[S] ||
            (d[S] = {
              preventDefault: !0,
              ...
              run: [
                (C) => {
                  let R = (pi = { view: C, prefix: S, scope: o });
                  return (
                    setTimeout(() => {
                      pi == R && (pi = null);
                    }, I0),
      ...
      let b =
        ...
        (d[p] = {
          ...
          stopPropagation: !1,
          run:
            ((f = (u = d._any) === null || u === void 0 ? void 0 : u.run) ===
              null || f === void 0
              ? void 0
              : f.slice()) || [],
        });
  ...
  for (let o of i) {
    ...
    if (o.any)
      for (let c of l) {
        ...
        let { any: u } = o;
        for (let f in h) h[f].run.push((d) => u(d, Xl));
      }
    let a = o[e] || o.key;
    if (a)
      for (let c of l)
        (s(c, a, o.run, o.preventDefault, o.stopPropagation),
          o.shift &&
            s(c, "Shift-" + a, o.shift, o.preventDefault, o.stopPropagation));
  }
  return t;
}
let Xl = null;
function Yd(i, e, t, n) {
  ...
  pi &&
    ...
    pi.scope == n &&
    ((l = pi.prefix + " "),
    qd.indexOf(e.keyCode) < 0 && ((c = !0), (pi = null)));
  let u = new Set(),
    f = (b) => {
      if (b) {
        for (let v of b.run)
          if (!u.has(v) && (u.add(v), v(t)))
            return (b.stopPropagation && (h = !0), !0);
        ...
        : o &&
          ...
          ? (f(d[l + Ds(g, e, !0)]) ||
              (e.shiftKey &&
                ...
                f(d[l + Ds(p, e, !1)]))) &&
            (a = !0)
          : o && e.shiftKey && f(d[l + Ds(r, e, !0)]) && (a = !0),
      !a && f(d._any) && (a = !0)),
    c && (a = !0),
...
class zr {
  ...
  static forRange(e, t, n) {
    if (n.empty) {
      ...
      let s = Xd(e);
      return [
        new zr(t, r.left - s.left, r.top - s.top, null, r.bottom - r.top),
      ];
    } else return F0(e, t, n);
  }
}
function Xd(i) {
...
function $h(i, e, t, n) {
  ...
  if (!r) return n;
  let s = i.dom.getBoundingClientRect(),
    o = (r.top + r.bottom) / 2,
    l = i.posAtCoords({ x: s.left + 1, y: o }),
    a = i.posAtCoords({ x: s.right - 1, y: o });
...
function F0(i, e, t) {
  ...
  let n = Math.max(t.from, i.viewport.from),
    r = Math.min(t.to, i.viewport.to),
    s = i.textDirection == he.LTR,
    o = i.contentDOM,
    ...
    d = Ul(i, n, 1),
    g = Ul(i, r, -1),
    p = d.type == Qe.Text ? d : null,
    b = g.type == Qe.Text ? g : null;
  if (
    (p && (i.lineWrapping || d.widgetLineBreaks) && (p = $h(i, n, 1, p)),
    b && (i.lineWrapping || g.widgetLineBreaks) && (b = $h(i, r, -1, b)),
    p && b && p.from == b.from && p.to == b.to)
  )
    return S(C(t.from, t.to, p));
  {
    let D = p ? C(t.from, null, p) : R(d, !1),
      T = b ? C(null, t.to, b) : R(g, !0),
      A = [];
    return (
      (p || d).to < (b || g).from - (p && b ? 1 : 0) ||
      (d.widgetLineBreaks > 1 && D.bottom + i.defaultLineHeight / 2 < T.top)
        ? A.push(v(u, D.bottom, f, T.top))
        : D.bottom < T.top &&
          i.elementAtHeight((D.bottom + T.top) / 2).type == Qe.Text &&
          (D.bottom = T.top = (D.bottom + T.top) / 2),
      S(D).concat(A).concat(S(T))
    );
  }
  function v(D, T, A, V) {
    return new zr(e, D - a.left, T - a.top, A - D, V - T);
  }
  function S({ top: D, bottom: T, horizontal: A }) {
    let V = [];
    for (let U = 0; U < A.length; U += 2) V.push(v(A[U], D, A[U + 1], T));
    return V;
  }
  function C(D, T, A) {
    let V = 1e9,
      U = -1e9,
      J = [];
    function W(O, B, N, z, Ke) {
      let me = i.coordsAtPos(O, O == A.to ? -2 : 2),
        Le = i.coordsAtPos(N, N == A.from ? 2 : -2);
      !me ||
        !Le ||
        ((V = Math.min(me.top, Le.top, V)),
        (U = Math.max(me.bottom, Le.bottom, U)),
        Ke == he.LTR
          ? J.push(s && B ? u : me.left, s && z ? f : Le.right)
          : J.push(!s && z ? u : Le.left, !s && B ? f : me.right));
    }
    let P = D ?? A.from,
      w = T ?? A.to;
    for (let O of i.visibleRanges)
      if (O.to > P && O.from < w)
        for (let B = Math.max(O.from, P), N = Math.min(O.to, w); ; ) {
          let z = i.state.doc.lineAt(B);
          for (let Ke of i.bidiSpans(z)) {
            let me = Ke.from + z.from,
              Le = Ke.to + z.from;
            if (me >= N) break;
            Le > B &&
              W(
          ...
          if (((B = z.to + 1), B >= N)) break;
        }
    return (
      J.length == 0 && W(P, D == null, w, T == null, i.textDirection),
      { top: V, bottom: U, horizontal: J }
    );
  }
  function R(D, T) {
    let A = l.top + (T ? D.top : D.bottom);
...
class H0 {
  ...
  update(e) {
    (e.startState.facet(Gs) != e.state.facet(Gs) && this.setOrder(e.state),
...
const Gs = I.define();
function Qd(i) {
  return [xe.define((e) => new H0(e, i)), Gs.of(i)];
}
const xr = I.define({
  combine(i) {
    return $t(
...
function W0(i = {}) {
  return [xr.of(i), V0, z0, $0, Td.of(!0)];
}
function Zd(i) {
  return i.startState.facet(xr) != i.state.facet(xr);
}
const V0 = Qd({
  above: !0,
  markers(i) {
    ...
    for (let r of e.selection.ranges) {
      ...
      if (r.empty || t.drawRangeCursor) {
        let o = s
          ...
          l = r.empty ? r : M.cursor(r.head, r.head > r.anchor ? -1 : 1);
        for (let a of zr.forRange(i, o, l)) n.push(a);
      }
    }
    return n;
  },
  update(i, e) {
    ...
    let t = Zd(i);
    return (t && Uh(i.state, e), i.docChanged || i.selectionSet || t);
  },
  mount(i, e) {
    Uh(e.state, i);
  },
...
function Uh(i, e) {
  e.style.animationDuration = i.facet(xr).cursorBlinkRate + "ms";
}
const z0 = Qd({
    above: !1,
    markers(i) {
      return i.state.selection.ranges
        .map((e) =>
          e.empty ? [] : zr.forRange(i, "cm-selectionBackground", e),
        )
        .reduce((e, t) => e.concat(t));
    },
    update(i, e) {
      return i.docChanged || i.selectionSet || i.viewportChanged || Zd(i);
    },
  ...
  hr = Ee.define({
    ...
    update(i, e) {
      return (
        ...
        e.effects.reduce((t, n) => (n.is(eg) ? n.value : t), i)
      );
    },
  }),
  U0 = xe.fromClass(
    class {
      ...
      setDropPos(i) {
        this.view.state.field(hr) != i &&
          this.view.dispatch({ effects: eg.of(i) });
      }
    },
    {
      eventObservers: {
...
function G0(i, e) {
  ...
  for (let { from: r, to: s } of t)
    ((r = Math.max(i.state.doc.lineAt(r).from, r - e)),
      (s = Math.min(i.state.doc.lineAt(s).to, s + e)),
...
class J0 {
  ...
  createDeco(e) {
    ...
    for (let { from: r, to: s } of G0(e, this.maxLength))
      Kh(e.state.doc, this.regexp, r, s, (o, l) => this.addMatch(l, e, o, n));
    return t.finish();
  }
  updateDeco(e, t) {
    let n = 1e9,
  ...
  updateRange(e, t, n, r) {
    for (let s of e.visibleRanges) {
      ...
      if (l >= o) {
        ...
        let f = [],
          d,
          g = (p, b, v) => f.push(v.range(p, b));
        if (a == c)
          for (
            this.regexp.lastIndex = h - a.from;
            (d = this.regexp.exec(a.text)) && d.index < u - a.from;
          )
            this.addMatch(d, e, d.index + a.from, g);
        else
          Kh(e.state.doc, this.regexp, h, u, (p, b) =>
            this.addMatch(b, e, p, g),
          );
        t = t.update({
          filterFrom: h,
          filterTo: u,
...
const Js = I.define({
  combine(i) {
    let e = $t(i, { render: null, specialChars: Y0, addSpecialChars: null });
    return (
      (e.replaceTabs = !Q0()) &&
        (e.specialChars = new RegExp("	|" + e.specialChars.source, Ql)),
      e.addSpecialChars &&
  ...
  return (
    ...
    (Gh = xe.fromClass(
      class {
        constructor(i) {
          ((this.view = i),
            (this.decorations = $.none),
            (this.decorationCache = Object.create(null)),
            (this.decorator = this.makeDecorator(i.state.facet(Js))),
          ...
          return new J0({
            ...
            decoration: (e, t, n) => {
              ...
              return (
                ...
                (this.decorationCache[s] = $.replace({ widget: new ny(i, s) }))
              );
            },
        ...
        update(i) {
          let e = i.state.facet(Js);
          i.startState.facet(Js) != e
  ...
  toDOM(e) {
    let t = iy(this.code),
      n =
        ...
        " " +
        (X0[this.code] || "0x" + this.code.toString(16)),
...
const oy = $.line({ class: "cm-activeLine" }),
  ly = xe.fromClass(
    class {
      constructor(i) {
      ...
      getDeco(i) {
        ...
        for (let n of i.state.selection.ranges) {
          ...
          r.from > e && (t.push(oy.range(r.from)), (e = r.from));
        }
        return $.set(t);
      }
    },
...
function ay(i, e, t) {
  let n = Math.min(e.line, t.line),
    ...
    s = [];
  if (e.off > Zl || t.off > Zl || e.col < 0 || t.col < 0) {
    let o = Math.min(e.off, t.off),
      l = Math.max(e.off, t.off);
    for (let a = n; a <= r; a++) {
      let c = i.doc.line(a);
      c.length <= l && s.push(M.range(c.from + o, c.to + l));
    }
  } else {
    ...
    for (let a = n; a <= r; a++) {
      let c = i.doc.line(a),
        h = Ol(c.text, o, i.tabSize, !0);
      if (h < 0) s.push(M.cursor(c.to));
      else {
        let u = Ol(c.text, l, i.tabSize);
        s.push(M.range(c.from + h, c.from + u));
      }
    }
  }
  return s;
  ...
  let t = i.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
    ...
    s =
      r > Zl
        ...
        : r == n.length
          ? cy(i, e.clientX)
          : Rn(n.text, i.state.tabSize, t - n.from);
  ...
  return t
    ? {
        ...
        get(r, s, o) {
          let l = Jh(i, r);
          if (!l) return n;
          let a = ay(i.state, t, l);
          return a.length
            ? o
              ? M.create(a.concat(n.ranges))
              : M.create(a)
            : n;
        },
      }
...
function uy(i) {
  ...
  return q.mouseSelectionStyle.of((t, n) => (e(n) ? hy(t, n) : null));
}
const fy = {
    Alt: [18, (i) => !!i.altKey],
  ...
  dy = { style: "cursor: crosshair" };
function gy(i = {}) {
  let [e, t] = fy[i.key || "Alt"],
    n = xe.fromClass(
      class {
        constructor(r) {
  ...
  return [
    n,
    q.contentAttributes.of((r) => {
      var s;
      return !((s = r.plugin(n)) === null || s === void 0) && s.isDown
        ? dy
        : null;
    }),
  ];
...
class tg {
  ...
  update(e, t) {
    ...
    return (
      t && (l.forEach((a, c) => (t[c] = a)), (t.length = l.length)),
      (this.input = r),
      (this.tooltips = s),
      (this.tooltipViews = o),
      !0
...
const Zo = I.define({
    combine: (i) => {
      ...
      return {
        position: F.ios
          ? "absolute"
          : ((e = i.find((r) => r.position)) === null || e === void 0
              ? void 0
              : e.position) || "fixed",
        parent:
          ((t = i.find((r) => r.parent)) === null || t === void 0
            ? void 0
            : t.parent) || null,
        tooltipSpace:
          ((n = i.find((r) => r.tooltipSpace)) === null || n === void 0
            ? void 0
            : n.tooltipSpace) || my,
      };
    },
    ...
    class {
      ...
      destroy() {
        ...
        for (let n of this.manager.tooltipViews)
          (n.dom.remove(),
            (i = n.destroy) === null || i === void 0 || i.call(n));
        (this.parent && this.container.remove(),
      ...
      readMeasure() {
        ...
        if (this.position == "fixed" && this.manager.tooltipViews.length) {
          ...
          else if (s.style.top == $n && s.style.left == "0px") {
        ...
        if (t || this.position == "absolute")
          if (this.parent) {
            ...
            s.width &&
              s.height &&
              ((i = s.width / this.parent.offsetWidth),
              (e = s.height / this.parent.offsetHeight));
          } else ({ scaleX: i, scaleY: e } = this.view.viewState);
      ...
      writeMeasure(i) {
        ...
        let { visible: t, space: n, scaleX: r, scaleY: s } = i,
          o = [];
        for (let l = 0; l < this.manager.tooltips.length; l++) {
          ...
          if (
            !u ||
            (a.clip !== !1 &&
              (u.bottom <= Math.max(t.top, n.top) ||
                u.top >= Math.min(t.bottom, n.bottom) ||
                u.right < Math.max(t.left, n.left) - 0.1 ||
                u.left > Math.min(t.right, n.right) + 0.1))
          ) {
            h.style.top = $n;
            continue;
          }
          let d = a.arrow ? c.dom.querySelector(".cm-tooltip-arrow") : null,
            g = d ? 7 : 0,
            p = f.right - f.left,
            b = (e = Yh.get(c)) !== null && e !== void 0 ? e : f.bottom - f.top,
            v = c.offset || yy,
            S = this.view.textDirection == he.LTR,
            C =
              f.width > n.right - n.left
                ...
                : S
                  ? Math.max(
                      n.left,
                      Math.min(u.left - (d ? 14 : 0) + v.x, n.right - p),
                    )
                  : Math.min(
                      Math.max(n.left, u.left - p + (d ? 14 : 0) - v.x),
                      n.right - p,
                    ),
            R = this.above[l];
          !a.strictSide &&
            (R
              ? u.top - b - g - v.y < n.top
              : u.bottom + b + g + v.y > n.bottom) &&
            R == n.bottom - u.bottom > u.top - n.top &&
            (R = this.above[l] = !R);
          let D = (R ? u.top - n.top : n.bottom - u.bottom) - g;
          if (D < b && c.resize !== !1) {
            if (D < this.view.defaultLineHeight) {
              h.style.top = $n;
              continue;
            }
            (Yh.set(c, b), (h.style.height = (b = D) / s + "px"));
          } else h.style.height && (h.style.height = "");
          let T = R ? u.top - b - g - v.y : u.bottom + g + v.y,
            A = C + p;
          if (c.overlap !== !0)
            for (let V of o)
              V.left < A &&
                ...
                V.top < T + b &&
                V.bottom > T &&
                (T = R ? V.top - b - 2 - g : V.bottom + g + 2);
          if (
            (this.position == "absolute"
              ? ((h.style.top = (T - i.parent.top) / s + "px"),
                Xh(h, (C - i.parent.left) / r))
              : ((h.style.top = T / s + "px"), Xh(h, C / r)),
            d)
          ) {
            let V = u.left + (S ? v.x : -v.x) - (C + 14 - 7);
            d.style.left = V / r + "px";
          }
          (c.overlap !== !0 &&
            o.push({ left: C, top: T, right: A, bottom: T + b }),
            h.classList.toggle("cm-tooltip-above", R),
            h.classList.toggle("cm-tooltip-below", !R),
            c.positioned && c.positioned(i.space));
        }
      }
      maybeMeasure() {
        if (
          ...
          for (let i of this.manager.tooltipViews) i.dom.style.top = $n;
      }
    },
    {
      eventObservers: {
...
const py = q.baseTheme({
  ...
  yy = { x: 0, y: 0 },
  Ec = I.define({ enables: [Oc, py] }),
  so = I.define({ combine: (i) => i.reduce((e, t) => e.concat(t), []) });
class Lo {
  static create(e) {
    return new Lo(e);
  }
...
class vy {
  ...
  startHover() {
    ...
    let r,
      s = 1;
    if (n instanceof bi) r = n.posAtStart;
    else {
  ...
  get tooltip() {
    let e = this.view.plugin(Oc),
      t = e ? e.manager.tooltips.findIndex((n) => n.create == Lo.create) : -1;
  ...
  mousemove(e) {
    ...
    if ((r.length && s && !wy(s.dom, e)) || this.pending) {
      let { pos: o } = r[0] || this.pending,
        l =
          (n = (t = r[0]) === null || t === void 0 ? void 0 : t.end) !== null &&
          n !== void 0
            ? n
            : o;
      (o == l
        ? this.view.posAtCoords(this.lastMove) != o
        : !Sy(this.view, o, l, e.clientX, e.clientY)) &&
...
const Ts = 4;
function wy(i, e) {
  let { left: t, right: n, top: r, bottom: s } = i.getBoundingClientRect(),
    o;
...
function ig(i, e = {}) {
        ...
        if (
          ...
          for (let l of r) {
            ...
            if (a != null) {
              ...
              ((c.pos = a),
                c.end != null && (c.end = s.changes.mapPos(c.end)),
                o.push(c));
            }
          }
          r = o;
  ...
  return {
    ...
    extension: [
      n,
      xe.define((r) => new vy(r, i, n, t, e.hoverTime || 300)),
      by,
    ],
  };
}
...
const rg = xe.fromClass(
  class {
    constructor(i) {
      ((this.input = i.state.facet(Dr)),
        (this.specs = this.input.filter((t) => t)),
        (this.panels = this.specs.map((t) => t(i))));
      let e = i.state.facet(Qh);
      ((this.top = new Rs(i, !0, e.topContainer)),
        (this.bottom = new Rs(i, !1, e.bottomContainer)),
    ...
    update(i) {
      ...
      (this.top.container != e.topContainer &&
        (this.top.sync([]), (this.top = new Rs(i.view, !0, e.topContainer))),
        this.bottom.container != e.bottomContainer &&
          (this.bottom.sync([]),
          (this.bottom = new Rs(i.view, !1, e.bottomContainer))),
      ...
      if (t != this.input) {
        ...
        for (let a of n) {
          ...
          (c < 0
            ? ((h = a(i.view)), l.push(h))
            : ((h = this.panels[c]), h.update && h.update(i)),
            r.push(h),
            (h.top ? s : o).push(h));
        }
        ((this.specs = n),
...
hi.prototype.mapMode = Xe.TrackBefore;
...
const Ys = I.define(),
  ...
  pr = I.define();
function My(i) {
  return [sg(), pr.of({ ...xy, ...i })];
}
const eu = I.define({ combine: (i) => i.some((e) => e) });
function sg(i) {
  return [Dy];
}
const Dy = xe.fromClass(
  class {
    constructor(i) {
      ((this.view = i),
        ...
        (this.gutters = i.state.facet(pr).map((e) => new iu(i, e))));
      for (let e of this.gutters) this.dom.appendChild(e.dom);
      ((this.fixed = !i.state.facet(eu)),
    ...
    update(i) {
      ...
      (i.geometryChanged &&
        (this.dom.style.minHeight =
          this.view.contentHeight / this.view.scaleY + "px"),
        this.view.state.facet(eu) != !this.fixed &&
    ...
    syncGutters(i) {
      ...
      i && this.dom.remove();
      let t = Z.iter(this.view.state.facet(Ys), this.view.viewport.from),
        n = [],
        r = this.gutters.map(
          (s) => new Ty(s, this.view.viewport, -this.view.documentPadding.top),
        );
    ...
    updateGutters(i) {
      ...
      if (e == t) for (let r of this.gutters) r.update(i) && (n = !0);
        ...
        for (let s of t) {
          let o = e.indexOf(s);
          o < 0
            ? r.push(new iu(this.view, s))
            : (this.gutters[o].update(i), r.push(this.gutters[o]));
        }
...
class Ty {
  ...
  line(e, t, n) {
    let r = [];
    (ea(this.cursor, r, t.from), n.length && (r = r.concat(n)));
...
class iu {
  constructor(e, t) {
    ...
    ((this.markers = tu(t.markers(e))),
      t.initialSpacer &&
        ((this.spacer = new og(e, 0, 0, [t.initialSpacer(e)])),
  ...
  update(e) {
    let t = this.markers;
    if (
      ((this.markers = tu(this.config.markers(e.view))),
    ...
    return (
      !Z.eq(this.markers, t, n.from, n.to) ||
...
class og {
  ...
  update(e, t, n, r) {
    (this.height != t &&
      ...
      Ry(this.markers, r) || this.setMarkers(e, r));
  }
  setMarkers(e, t) {
    ...
    for (let s = 0, o = 0; ; ) {
      ...
      if (!a) break;
      (a.toDOM &&
        (c ? (r = r.nextSibling) : this.dom.insertBefore(a.toDOM(e), r)),
        c && o++);
    }
...
function tl(i, e) {
  return i.state.facet(hn).formatNumber(e, i.state);
}
const Oy = pr.compute([hn], (i) => ({
  ...
  lineMarker(e, t, n) {
    return n.some((r) => r.toDOM)
      ? null
      : new el(tl(e, e.state.doc.lineAt(t.from).number));
  },
  widgetMarker: (e, t, n) => {
  ...
  initialSpacer(e) {
    return new el(tl(e, nu(e.state.doc.lines)));
  },
  updateSpacer(e, t) {
    let n = tl(t.view, nu(t.view.state.doc.lines));
    return n == e.number ? e : new el(n);
  },
  domEventHandlers: i.facet(hn).domEventHandlers,
}));
function Ey(i = {}) {
  return [hn.of(i), sg(), Oy];
}
function nu(i) {
  let e = 9;
  for (; e < i; ) e = e * 10 + 9;
...
const Ly = new (class extends hi {
    constructor() {
      (super(...arguments), (this.elementClass = "cm-activeLineGutter"));
    }
  })(),
  Ny = Ys.compute(["selection"], (i) => {
    let e = [],
      t = -1;
    for (let n of i.selection.ranges) {
      let r = i.doc.lineAt(n.head).from;
      r > t && ((t = r), e.push(Ly.range(r)));
    }
    return Z.of(e);
  });
function _y() {
...
class Y {
  ...
  add(e) {
    ...
    return (
      typeof e != "function" && (e = vt.match(e)),
      (t) => {
        let n = e(t);
...
class vt {
  ...
  static define(e) {
    let t = e.props && e.props.length ? Object.create(null) : qy,
      n =
        (e.top ? 1 : 0) |
        (e.skipped ? 2 : 0) |
        (e.error ? 4 : 0) |
        (e.name == null ? 8 : 0),
      r = new vt(e.name || "", t, e.id, n);
    if (e.props) {
...
vt.none = new vt("", Object.create(null), 0, 8);
...
class ze {
  ...
  cursor(e = 0) {
    return new ia(this.topNode, e);
  }
  cursorAt(e, t = 0, n = 0) {
    let r = As.get(this) || this.topNode,
      s = new ia(r);
    return (s.moveTo(e, t), As.set(this, s._tree), s);
  }
  get topNode() {
    return new yt(this, 0, 0, null);
  }
  resolve(e, t = 0) {
    let n = Tr(As.get(this) || this.topNode, e, t, !1);
    return (As.set(this, n), n);
  }
  resolveInner(e, t = 0) {
    let n = Tr(ru.get(this) || this.topNode, e, t, !0);
    return (ru.set(this, n), n);
  }
  resolveStack(e, t = 0) {
    return Hy(this, e, t);
  }
  ...
  balance(e = {}) {
    return this.children.length <= 8
      ...
      : _c(
          ...
          0,
          this.length,
          (t, n, r) => new ze(this.type, t, n, r, this.propValues),
          e.makeTree || ((t, n, r) => new ze(vt.none, t, n, r)),
        );
  }
  static build(e) {
    return Wy(e);
...
class Lc {
  ...
  fork() {
    return new Lc(this.buffer, this.index);
  }
}
class Mi {
  constructor(e, t, n) {
  ...
  childString(e) {
    let t = this.buffer[e],
      ...
      s = r.name;
    if (
      (/\W/.test(s) && !r.isError && (s = JSON.stringify(s)), (e += 4), n == e)
    )
      return s;
    let o = [];
  ...
  findChild(e, t, n, r, s) {
    ...
    for (
      let a = e;
      a != t && !(lg(s, r, o[a + 1], o[a + 2]) && ((l = a), n > 0));
      a = o[a + 3]
    );
    return l;
  }
...
class yt extends ag {
  ...
  nextChild(e, t, n, r, s = 0) {
    for (let o = this; ; ) {
      for (
        let { children: l, positions: a } = o._tree, c = t > 0 ? l.length : -1;
        e != c;
        e += t
      ) {
        let h = l[e],
          u = a[e] + o.from;
        if (lg(r, n, u, u + h.length)) {
          if (h instanceof Mi) {
            if (s & qe.ExcludeBuffers) continue;
            let f = h.findChild(0, h.buffer.length, t, n - u, r);
            if (f > -1) return new wi(new Fy(o, h, e, u), null, f);
          } else if (s & qe.IncludeAnonymous || !h.type.isAnonymous || Nc(h)) {
            let f;
            if (!(s & qe.IgnoreMounts) && (f = oo.get(h)) && !f.overlay)
              return new yt(f.tree, u, e, o);
            let d = new yt(h, u, e, o);
            return s & qe.IncludeAnonymous || !d.type.isAnonymous
              ? d
              : d.nextChild(t < 0 ? h.children.length - 1 : 0, t, n, r);
          }
        }
      }
      if (
  ...
  enter(e, t, n = 0) {
    let r;
    if (!(n & qe.IgnoreOverlays) && (r = oo.get(this._tree)) && r.overlay) {
      let s = e - this.from;
      for (let { from: o, to: l } of r.overlay)
        if ((t > 0 ? o <= s : o < s) && (t < 0 ? l >= s : l > s))
          return new yt(r.tree, r.overlay[0].from + this.from, -1, this);
    }
...
class wi extends ag {
  ...
  enter(e, t, n = 0) {
    if (n & qe.ExcludeBuffers) return null;
    let { buffer: r } = this.context,
      s = r.findChild(
        this.index + 4,
        r.buffer[this.index + 3],
  ...
  get nextSibling() {
    ...
    return t <
      ...
      ? new wi(this.context, this._parent, t)
...
function cg(i) {
  ...
  let n = t instanceof yt && t.index < 0 ? null : t.parent,
    r = i.slice();
  return (n ? (r[e] = n) : r.splice(e, 1), new jy(r, t));
}
class jy {
  constructor(e, t) {
...
function Hy(i, e, t) {
  let n = i.resolveInner(e, t),
    r = null;
  for (let s = n instanceof yt ? n : n.context.parent; s; s = s.parent)
    if (s.index < 0) {
      let o = s.parent;
      ...
      if (
        ...
        let l = new yt(o.tree, o.overlay[0].from + s.from, -1, s);
        (r || (r = [n])).push(Tr(l, e, t, !1));
      }
    }
  return r ? cg(r) : n;
}
class ia {
  ...
  atLastNode(e) {
    ...
    for (; n; { index: t, _parent: n } = n)
      if (t > -1)
        for (
          let s = t + e, o = e < 0 ? -1 : n._tree.children.length;
          s != o;
          s += e
        ) {
  ...
  matchContext(e) {
    if (!this.buffer) return ta(this.node.parent, e);
    let { buffer: t } = this.buffer,
      { types: n } = t.set;
    for (let r = e.length - 1, s = this.stack.length - 1; r >= 0; s--) {
      if (s < 0) return ta(this._tree, e, r);
...
function Nc(i) {
  return i.children.some(
    (e) => e instanceof Mi || !e.type.isAnonymous || Nc(e),
  );
}
function Wy(i) {
  var e;
  let {
      buffer: t,
      nodeSet: n,
      maxBufferLength: r = By,
      reused: s = [],
      minRepeatType: o = n.types.length,
    } = i,
    l = Array.isArray(t) ? new Lc(t, t.length) : t,
    a = n.types,
    c = 0,
    h = 0;
  function u(D, T, A, V, U, J) {
    let { id: W, start: P, end: w, size: O } = l,
      B = h,
      N = c;
    for (; O < 0; )
      if ((l.next(), O == -1)) {
        let Ae = s[W];
        (A.push(Ae), V.push(P - D));
        return;
      } else if (O == -3) {
        c = W;
        return;
        ...
        h = W;
        return;
      } else throw new RangeError(`Unrecognized record size: ${O}`);
    let z = a[W],
      Ke,
      me,
      Le = P - D;
    if (w - P <= r && (me = b(l.pos - T, U))) {
      let Ae = new Uint16Array(me.size - me.skip),
        be = l.pos - me.size,
        Pe = Ae.length;
      for (; l.pos > be; ) Pe = v(me.start, Ae, Pe);
      ((Ke = new Mi(Ae, w - me.start, n)), (Le = me.start - D));
    } else {
      let Ae = l.pos - O;
      l.next();
      let be = [],
        ...
        ht = w;
      for (; l.pos > Ae; )
        He >= 0 && l.id == He && l.size >= 0
          ? (l.end <= ht - r &&
              (g(be, Pe, P, et, l.end, ht, He, B, N),
              (et = be.length),
              (ht = l.end)),
            l.next())
          : J > 2500
      ...
      if (
        (He >= 0 &&
          et > 0 &&
          et < be.length &&
          g(be, Pe, P, et, P, ht, He, B, N),
        be.reverse(),
        Pe.reverse(),
        He > -1 && et > 0)
      ) {
        let Kt = d(z, N);
        Ke = _c(z, be, Pe, 0, be.length, 0, w - P, Kt, Kt);
      } else Ke = p(z, be, Pe, w - P, B - w, N);
    }
    (A.push(Ke), V.push(Le));
  }
  function f(D, T, A, V) {
    let U = [],
      ...
      W = -1;
    for (; l.pos > T; ) {
      let { id: P, start: w, end: O, size: B } = l;
      if (B > 4) l.next();
      else {
        if (W > -1 && w < W) break;
        (W < 0 && (W = O - r), U.push(P, w, O), J++, l.next());
      }
    }
    if (J) {
      let P = new Uint16Array(J * 4),
        w = U[U.length - 2];
      for (let O = U.length - 3, B = 0; O >= 0; O -= 3)
        ((P[B++] = U[O]),
          (P[B++] = U[O + 1] - w),
          (P[B++] = U[O + 2] - w),
          (P[B++] = B));
      (A.push(new Mi(P, U[2] - w, n)), V.push(w - D));
    }
  }
  function d(D, T) {
    return (A, V, U) => {
      let J = 0,
        ...
        P,
        w;
      if (W >= 0 && (P = A[W]) instanceof ze) {
        if (!W && P.type == D && P.length == U) return P;
        (w = P.prop(Y.lookAhead)) && (J = V[W] + P.length + w);
      }
      return p(D, A, V, U, J, T);
    };
  }
  function g(D, T, A, V, U, J, W, P, w) {
    let O = [],
      B = [];
    for (; D.length > V; ) (O.push(D.pop()), B.push(T.pop() + A - U));
    (D.push(p(n.types[W], O, B, J - U, P - J, w)), T.push(U - A));
  }
  function p(D, T, A, V, U, J, W) {
    if (J) {
      let P = [Y.contextHash, J];
      W = W ? [P].concat(W) : [P];
    }
    if (U > 25) {
      let P = [Y.lookAhead, U];
  ...
  function b(D, T) {
    ...
    return (
      (T < 0 || V == D) && ((P.size = V), (P.start = U), (P.skip = J)),
      P.size > 4 ? P : void 0
    );
  }
  function v(D, T, A) {
    let { id: V, start: U, end: J, size: W } = l;
    if ((l.next(), W >= 0 && V < o)) {
      let P = A;
      if (W > 4) {
        let w = l.pos - (W - 4);
        for (; l.pos > w; ) A = v(D, T, A);
      }
      ((T[--A] = P), (T[--A] = J - D), (T[--A] = U - D), (T[--A] = V));
    } else W == -3 ? (c = V) : W == -4 && (h = V);
    return A;
  }
  let S = [],
    C = [];
  for (; l.pos > 0; ) u(i.start || 0, i.bufferStart || 0, S, C, -1, 0);
  let R =
    (e = i.length) !== null && e !== void 0
      ...
      : S.length
        ? C[0] + S[0].length
        : 0;
  return new ze(a[i.topID], S.reverse(), C.reverse(), R);
}
const ou = new WeakMap();
function Xs(i, e) {
  if (!i.isAnonymous || e instanceof Mi || e.type != i) return 1;
  let t = ou.get(e);
  if (t == null) {
    t = 1;
    for (let n of e.children) {
      if (n.type != i || !(n instanceof ze)) {
        t = 1;
        break;
      }
      t += Xs(i, n);
...
function _c(i, e, t, n, r, s, o, l, a) {
  let c = 0;
  for (let g = n; g < r; g++) c += Xs(i, e[g]);
  let h = Math.ceil((c * 1.5) / 8),
    u = [],
    f = [];
  function d(g, p, b, v, S) {
    for (let C = b; C < v; ) {
      let R = C,
        D = p[C],
        T = Xs(i, g[C]);
      ...
      if (C == R + 1) {
        if (T > h) {
          let A = g[R];
          d(A.children, A.positions, 0, A.children.length, p[R] + S);
          continue;
        }
        u.push(g[R]);
      } else {
        let A = p[C - 1] + g[C - 1].length - D;
        u.push(_c(i, g, p, R, C, D, A, null, a));
      }
      f.push(D + S - s);
    }
  }
...
class Ki {
  ...
  static addTree(e, t = [], n = !1) {
    let r = [new Ki(0, e.length, e, 0, !1, n)];
      ...
      if (u - a >= n)
        for (; o && o.from < u; ) {
          ...
          if (a >= f.from || u <= f.to || c) {
            let d = Math.max(f.from, a) - c,
              g = Math.min(f.to, u) - c;
            f = d >= g ? null : new Ki(d, g, f.tree, f.offset + c, l > 0, !!h);
          }
...
class Vy {
  startParse(e, t, n) {
    return (
      typeof e == "string" && (e = new zy(e)),
      (n = n
        ? n.length
          ? n.map((r) => new il(r.from, r.to))
          : [new il(0, 0)]
        : [new il(0, e.length)]),
...
class ft {
  ...
  static defineModifier(e) {
    let t = new lo(e);
    return (n) =>
      n.modified.indexOf(t) > -1
        ? n
        : lo.get(
            n.base || n,
            n.modified.concat(t).sort((r, s) => r.id - s.id),
          );
  }
}
let Uy = 0;
class lo {
  constructor(e) {
    ((this.name = e), (this.instances = []), (this.id = Uy++));
  }
  static get(e, t) {
    if (!t.length) return e;
    let n = t[0].instances.find((l) => l.base == e && Ky(t, l.modified));
    if (n) return n;
    let r = [],
      s = new ft(e.name, r, e, t);
    for (let l of t) l.instances.push(s);
    let o = Gy(t);
    for (let l of e.set)
      if (!l.modified.length) for (let a of o) r.push(lo.get(l, a));
    return s;
  }
}
function Ky(i, e) {
...
function Gy(i) {
  let e = [[]];
  for (let t = 0; t < i.length; t++)
    for (let n = 0, r = e.length; n < r; n++) e.push(e[n].concat(i[t]));
  ...
  for (let t in i) {
    ...
    for (let r of t.split(" "))
      if (r) {
        ...
        let h = new ao(n, o, a > 0 ? s.slice(0, a) : null);
        e[c] = h.sort(e[c]);
      }
  }
  return hg.add(e);
...
function Xy(i, e, t, n = 0, r = i.length) {
  let s = new Qy(n, Array.isArray(e) ? e : [e], t);
...
class Qy {
  ...
  highlightRange(e, t, n, r, s) {
    ...
    if (
      (u &&
        (c && (c += " "), (c += u), h.mode == 1 && (r += (r ? " " : "") + u)),
      this.startSpan(Math.max(t, l), c),
      h.opaque)
    )
      return;
    ...
    if (f && f.overlay) {
      let d = e.node.enter(f.overlay[0].from + l, 1),
        g = this.highlighters.filter((b) => !b.scope || b.scope(f.tree.type)),
        p = e.firstChild();
      for (let b = 0, v = l; ; b++) {
        let S = b < f.overlay.length ? f.overlay[b] : null,
          C = S ? S.from + l : a,
          R = Math.max(t, v),
          D = Math.min(n, C);
        if (R < D && p)
          for (
            ;
            e.from < D &&
            (this.highlightRange(e, R, D, r, s),
            this.startSpan(Math.min(D, e.to), c),
...
const L = ft.define,
  ...
  _ = {
    ...
    unit: L(Et),
    modifier: L(Et),
    operatorKeyword: L(Et),
    controlKeyword: L(Et),
    definitionKeyword: L(Et),
    moduleKeyword: L(Et),
    operator: Lt,
    derefOperator: L(Lt),
    arithmeticOperator: L(Lt),
    logicOperator: L(Lt),
    bitwiseOperator: L(Lt),
    compareOperator: L(Lt),
    updateOperator: L(Lt),
    definitionOperator: L(Lt),
    typeOperator: L(Lt),
    controlOperator: L(Lt),
    punctuation: na,
    separator: L(na),
    bracket: Un,
    angleBracket: L(Un),
...
class qt {
  constructor(e, t, n = [], r = "") {
    ((this.data = e),
      (this.name = r),
      Q.prototype.hasOwnProperty("tree") ||
        Object.defineProperty(Q.prototype, "tree", {
          get() {
            return $e(this);
          },
        }),
      ...
      (this.extension = [
        ...
        Q.languageData.of((s, o, l) => {
          ...
          if (u) {
            ...
            for (let d of u)
              if (d.test(f, s)) {
                let g = s.facet(d.facet);
                return d.type == "replace" ? g : g.concat(h);
              }
          }
          return h;
        }),
  ...
  isActiveAt(e, t, n = -1) {
    return cu(e, t, n).type.prop(ur) == this.data;
  }
  findRegions(e) {
    let t = e.facet(Di);
    ...
    let n = [],
      r = (s, o) => {
        if (s.prop(ur) == this.data) {
          n.push({ from: o, to: o + s.length });
          return;
        }
        let l = s.prop(Y.mounted);
        if (l) {
          if (l.tree.prop(ur) == this.data) {
            if (l.overlay)
        ...
        for (let a = 0; a < s.children.length; a++) {
          let c = s.children[a];
          c instanceof ze && r(c, s.positions[a] + o);
        }
      };
    return (r($e(e), 0), n);
  }
...
qt.setState = G.define();
function cu(i, e, t) {
  let n = i.facet(Di),
    r = $e(i).topNode;
  if (!n || n.allowsNesting)
    for (let s = r; s; s = s.enter(e, t, qe.ExcludeBuffers))
      s.type.isTop && (r = s);
  return r;
}
function $e(i) {
...
class co {
  ...
  static create(e, t, n) {
    return new co(e, t, [], ze.empty, 0, n, [], null);
  }
  startParse() {
    return this.parser.startParse(new tb(this.state.doc), this.fragments);
  }
  work(e, t) {
    return (
      t != null && t >= this.state.doc.length && (t = void 0),
      this.tree != ze.empty && this.isDone(t ?? this.state.doc.length)
        ? (this.takeTree(), !0)
        : this.withContext(() => {
            var n;
            if (typeof e == "number") {
              ...
              if (r)
                if (
                  ((this.fragments = this.withoutTempSkipped(
                    Ki.addTree(r, this.fragments, this.parse.stoppedAt != null),
                  )),
                  (this.treeLen =
  ...
  takeTree() {
    ...
    this.parse &&
      ...
      (this.tree = t),
      (this.fragments = this.withoutTempSkipped(
        Ki.addTree(this.tree, this.fragments, !0),
      )),
      (this.parse = null));
  }
  withContext(e) {
  ...
  withoutTempSkipped(e) {
    for (let t; (t = this.tempSkipped.pop()); ) e = hu(e, t.from, t.to);
    return e;
  }
  changes(e, t) {
    ...
    if ((this.takeTree(), !e.empty)) {
      let a = [];
      if (
        (e.iterChangedRanges((c, h, u, f) =>
          a.push({ fromA: c, toA: h, fromB: u, toB: f }),
        ),
        (n = Ki.applyChanges(n, a)),
        (r = ze.empty),
        (s = 0),
    ...
    return new co(this.parser, t, n, r, s, o, l, this.scheduleOn);
  }
  updateViewport(e) {
    ...
    for (let n = 0; n < this.skipped.length; n++) {
      ...
      r < e.to &&
        s > e.from &&
        ((this.fragments = hu(this.fragments, r, s)),
      ...
      createParse(t, n, r) {
        ...
        return {
          ...
          advance() {
            ...
            return ((this.parsedPos = o), new ze(vt.none, [], [], o - s));
          },
          stoppedAt: null,
          stopAt() {},
        };
...
class Sn {
  ...
  apply(e) {
    ...
    return (t.work(20, n) || t.takeTree(), new Sn(t));
  }
  static init(e) {
    let t = Math.min(3e3, e.doc.length),
      n = co.create(e.facet(Di).parser, e, { from: 0, to: t });
    return (n.work(20, t) || n.takeTree(), new Sn(n));
  }
}
qt.state = Ee.define({
  create: Sn.init,
  update(i, e) {
    for (let t of e.effects) if (t.is(qt.setState)) return t.value;
...
const sl =
    typeof navigator < "u" &&
    !((rl = navigator.scheduling) === null || rl === void 0) &&
    rl.isInputPending
      ...
      work(e) {
        ...
        let o =
            ...
            Math.min(
              this.chunkBudget,
              100,
              e && !sl ? Math.max(25, e.timeRemaining() - 5) : 1e9,
            ),
          l = s.context.treeLen < r && n.doc.length > r + 1e3,
          a = s.context.work(
            () => (sl && sl()) || Date.now() > o,
            r + (l ? 0 : 1e5),
          );
        ((this.chunkBudget -= Date.now() - t),
          (a || this.chunkBudget <= 0) &&
            (s.context.takeTree(),
            this.view.dispatch({ effects: qt.setState.of(new Sn(s.context)) })),
...
function Bc(i, e) {
  i instanceof Q && (i = new _o(i));
  for (let n of i.state.facet(nb)) {
    let r = n(i, e);
    if (r !== void 0) return r;
  }
  let t = $e(i.state);
  return t.length >= e ? sb(i, t, e) : null;
}
class _o {
  constructor(e, t = {}) {
  ...
  countColumn(e, t = e.length) {
    return Rn(e, this.state.tabSize, t);
  }
  lineIndent(e, t = 1) {
    let { text: n, from: r } = this.lineAt(e, t),
...
function sb(i, e, t) {
  ...
  if (r != n.node) {
    ...
    for (
      let o = r;
      o && !(o.from == n.node.from && o.type == n.node.type);
      o = o.parent
    )
      s.push(o);
...
function lb(i) {
  let e = i.type.prop(rb);
  if (e) return e;
  let t = i.firstChild,
    n;
  if (t && (n = t.type.prop(Y.closedBy))) {
    let r = i.lastChild,
      s = r && n.indexOf(r.name) > -1;
    return (o) => ub(o, !0, 1, void 0, s && !ob(o) ? r.from : void 0);
  }
  return i.parent == null ? ab : null;
}
function ab() {
  return 0;
}
...
function ub(i, e, t, n, r) {
  let s = i.textAfter,
    o = s.match(/^\s*/)[0].length,
    l = (n && s.slice(o, o + n.length) == n) || r == i.pos + o,
    a = hb(i);
  return a
    ? l
      ? i.column(a.from)
...
const fb = 200;
function db() {
  return Q.transactionFilter.of((i) => {
    if (
      !i.docChanged ||
    ...
    let t = i.newDoc,
      ...
      r = t.lineAt(n);
    if (n > r.from + fb) return i;
    let s = t.sliceString(r.from, n);
    if (!e.some((c) => c.test(s))) return i;
    let { state: o } = i,
      l = -1,
      a = [];
...
function mb(i, e, t) {
  ...
  let r = n.resolveStack(t, 1),
    s = null;
  for (let o = r; o; o = o.next) {
    let l = o.node;
    if (l.to <= t || l.from > t) continue;
    if (s && l.from < e) break;
    let a = l.type.prop(gb);
...
const en = Ee.define({
  ...
  update(i, e) {
    ...
    for (let t of e.effects)
      if (t.is(Bo) && !yb(i, t.value.from, t.value.to)) {
        let { preparePlaceholder: n } = e.state.facet(vg),
          r = n ? $.replace({ widget: new xb(n(e.state, t.value)) }) : uu;
...
function yg(i, e) {
  return i.field(en, !1) ? e : e.concat(G.appendConfig.of(wg()));
}
const bb = (i) => {
    for (let e of pg(i)) {
      let t = uo(i.state, e.from, e.to);
      if (t)
        return (i.dispatch({ effects: yg(i.state, [Bo.of(t), bg(i, t)]) }), !0);
    }
    return !1;
  },
  vb = (i) => {
    if (!i.state.field(en, !1)) return !1;
    let e = [];
    for (let t of pg(i)) {
      let n = fo(i.state, t.from, t.to);
      n && e.push($r.of(n), bg(i, n, !1));
    }
    return (e.length && i.dispatch({ effects: e }), e.length > 0);
  };
function bg(i, e, t = !0) {
  let n = i.state.doc.lineAt(e.from).number,
    r = i.state.doc.lineAt(e.to).number;
  return q.announce.of(
    `${i.state.phrase(t ? "Folded lines" : "Unfolded lines")} ${n} ${i.state.phrase("to")} ${r}.`,
  );
}
const wb = (i) => {
    let { state: e } = i,
    ...
    for (let n = 0; n < e.doc.length; ) {
      let r = i.lineBlockAt(n),
        s = uo(e, r.from, r.to);
      (s && t.push(Bo.of(s)), (n = (s ? i.lineBlockAt(s.to) : r).to + 1));
    }
    return (t.length && i.dispatch({ effects: yg(i.state, t) }), !!t.length);
  },
  Sb = (i) => {
    let e = i.state.field(en, !1);
    if (!e || !e.size) return !1;
    let t = [];
    return (
      e.between(0, i.state.doc.length, (n, r) => {
        t.push($r.of({ from: n, to: r }));
      }),
  ...
  kb = [
    ...
    { key: "Ctrl-Shift-]", mac: "Cmd-Alt-]", run: vb },
    { key: "Ctrl-Alt-[", run: wb },
    { key: "Ctrl-Alt-]", run: Sb },
  ],
  Cb = { placeholderDOM: null, preparePlaceholder: null, placeholderText: "…" },
  vg = I.define({
    combine(i) {
      return $t(i, Cb);
    },
  ...
  let { state: t } = i,
    ...
    r = (o) => {
      let l = i.lineBlockAt(i.posAtDOM(o.target)),
        a = fo(i.state, l.from, l.to);
      (a && i.dispatch({ effects: $r.of(a) }), o.preventDefault());
    };
...
function Db(i = {}) {
  let e = Object.assign(Object.assign({}, Mb), i),
    t = new ol(e, !0),
    n = new ol(e, !1),
    r = xe.fromClass(
      class {
        ...
        update(o) {
          (o.docChanged ||
            o.viewportChanged ||
            o.startState.facet(Di) != o.state.facet(Di) ||
            o.startState.field(en, !1) != o.state.field(en, !1) ||
            $e(o.startState) != $e(o.state) ||
            e.foldingChanged(o)) &&
        ...
        buildMarkers(o) {
          ...
          for (let a of o.viewportLineBlocks) {
            let c = fo(o.state, a.from, a.to)
              ? n
              : uo(o.state, a.from, a.to)
                ? t
                : null;
    ...
    My({
      ...
      domEventHandlers: Object.assign(Object.assign({}, s), {
        click: (o, l, a) => {
          ...
          let c = fo(o.state, l.from, l.to);
          if (c) return (o.dispatch({ effects: $r.of(c) }), !0);
          let h = uo(o.state, l.from, l.to);
          return h ? (o.dispatch({ effects: Bo.of(h) }), !0) : !1;
        },
      }),
    }),
    wg(),
...
function Rb(i, e) {
  ...
  return (
    ...
    e != null && e.fallback
      ...
      : n
        ? t.push(
            ra.computeN([q.darkTheme], (r) =>
              r.facet(q.darkTheme) == (n == "dark") ? [i] : [],
            ),
          )
        : t.push(ra.of(i)),
    t
...
class Ab {
  constructor(e) {
    ((this.markCache = Object.create(null)),
      (this.tree = $e(e.state)),
      (this.decorations = this.buildDeco(e, ll(e.state))),
  ...
  buildDeco(e, t) {
    if (!t || !this.tree.length) return $.none;
    let n = new Vt();
      ...
      Xy(
        ...
        (o, l, a) => {
          n.add(
            o,
            l,
            this.markCache[a] || (this.markCache[a] = $.mark({ class: a })),
          );
        },
        r,
        s,
...
const Pb = Ti.high(xe.fromClass(Ab, { decorations: (i) => i.decorations })),
  Ob = Io.define([
  ...
  Lb = $.mark({ class: "cm-matchingBracket" }),
  Nb = $.mark({ class: "cm-nonmatchingBracket" });
function _b(i) {
  let e = [],
    t = i.matched ? Lb : Nb;
  return (
...
const Bb = Ee.define({
    ...
    update(i, e) {
      ...
      for (let r of e.state.selection.ranges) {
        if (!r.empty) continue;
        let s =
          Ft(e.state, r.head, -1, n) ||
          (r.head > 0 && Ft(e.state, r.head - 1, 1, n)) ||
          (n.afterCursor &&
            (Ft(e.state, r.head, 1, n) ||
              (r.head < e.state.doc.length && Ft(e.state, r.head + 1, -1, n))));
...
function oa(i) {
  let e = i.type.prop(Fb);
  return e ? e(i.node) : i;
}
function Ft(i, e, t, n = {}) {
  let r = n.maxScanDistance || Cg,
    s = n.brackets || xg,
    o = $e(i),
  ...
  for (let a = l; a; a = a.parent) {
    ...
    if (c && a.from < a.to) {
      ...
      if (h && (t > 0 ? e >= h.from && e < h.to : e > h.from && e <= h.to))
        return jb(i, e, t, a, h, c, s);
    }
  }
  return Hb(i, e, t, o, l.type, r, s);
}
function jb(i, e, t, n, r, s, o) {
  let l = n.parent,
    ...
    do
      if (t < 0 ? h.to <= n.from : h.from >= n.to) {
        if (c == 0 && s.indexOf(h.type.name) > -1 && h.from < h.to) {
          ...
          return {
            start: a,
            end: u ? { from: u.from, to: u.to } : void 0,
            matched: !0,
          };
        } else if (sa(h.type, t, o)) c++;
...
function Hb(i, e, t, n, r, s, o) {
  ...
  for (let f = 0; !h.next().done && f <= s; ) {
    ...
    let g = e + f * t;
    for (
      let p = t > 0 ? 0 : d.length - 1, b = t > 0 ? d.length : -1;
      p != b;
      p += t
    ) {
      let v = o.indexOf(d[p]);
      if (!(v < 0 || n.resolveInner(g + p, 1).type != r))
        if ((v % 2 == 0) == t > 0) u++;
        else {
          if (u == 1)
            return {
              start: c,
              end: { from: g + p, to: g + p + 1 },
              matched: v >> 1 == a >> 1,
            };
          u--;
        }
...
for (let [i, e] of [
  ...
  Vb[i] = zb(Wb, e);
function al(i, e) {
  du.indexOf(i) > -1 || (du.push(i), console.warn(e));
}
function zb(i, e) {
  let t = [];
    ...
    for (let c of l.split(".")) {
      ...
      h
        ? typeof h == "function"
          ? a.length
            ? (a = a.map(h))
            : al(c, `Modifier ${c} used at start of tag`)
          : a.length
            ? al(c, `Tag ${c} used as modifier`)
            : (a = Array.isArray(h) ? h : [h])
        : al(c, `Unknown highlighting tag ${c}`);
    }
    for (let c of a) t.push(c);
  }
  ...
  let n = e.replace(/ /g, "_"),
    ...
    s = gu[r];
  if (s) return s.id;
  let o = (gu[r] = vt.define({
    id: fu.length,
    name: n,
    props: [Jy({ [n]: t })],
  }));
  return (fu.push(o), o.id);
}
(he.RTL, he.LTR);
const $b = (i) => {
  let { state: e } = i,
    ...
    n = Fc(i.state, t.from);
  return n.line ? Ub(i) : n.block ? Gb(i) : !1;
};
function qc(i, e) {
...
const Ub = qc(Xb, 0),
  Kb = qc(Dg, 0),
  Gb = qc((i, e) => Dg(i, e, Yb(e)), 0);
function Fc(i, e) {
  let t = i.languageDataAt("commentTokens", e, 1);
  return t.length ? t[0] : {};
}
const Gn = 50;
function Jb(i, { open: e, close: t }, n, r) {
  let s = i.sliceDoc(n - Gn, n),
    o = i.sliceDoc(r, r + Gn),
    l = /\s*$/.exec(s)[0].length,
    a = /^\s*/.exec(o)[0].length,
    c = s.length - l;
  ...
  r - n <= 2 * Gn
    ? (h = u = i.sliceDoc(n, r))
    : ((h = i.sliceDoc(n, n + Gn)), (u = i.sliceDoc(r - Gn, r)));
  let f = /^\s*/.exec(h)[0].length,
    d = /\s*$/.exec(u)[0].length,
    g = u.length - d - t.length;
  return h.slice(f, f + e.length) == e && u.slice(g, g + t.length) == t
    ? {
        open: {
          pos: n + f + e.length,
...
function Yb(i) {
  ...
  for (let t of i.selection.ranges) {
    let n = i.doc.lineAt(t.from),
      r = t.to <= n.to ? n : i.doc.lineAt(t.to);
    r.from > n.from &&
      r.from == t.to &&
      (r = t.to == n.to + 1 ? n : i.doc.lineAt(t.to - 1));
    let s = e.length - 1;
    s >= 0 && e[s].to > n.from
      ? (e[s].to = r.to)
      : e.push({ from: n.from + /^\s*/.exec(n.text)[0].length, to: r.to });
  }
  return e;
}
function Dg(i, e, t = e.selection.ranges) {
  let n = t.map((s) => Fc(e, s.from).block);
  if (!n.every((s) => s)) return null;
  let r = t.map((s, o) => Jb(e, n[o], s.from, s.to));
  if (i != 2 && !r.every((s) => s))
    return {
      changes: e.changes(
        t.map((s, o) =>
    ...
    for (let o = 0, l; o < r.length; o++)
      if ((l = r[o])) {
        let a = n[o],
          { open: c, close: h } = l;
        s.push(
          { from: c.pos - a.open.length, to: c.pos + c.margin },
...
function Xb(i, e, t = e.selection.ranges) {
  let n = [],
    r = -1;
      ...
      for (let h = s; h <= o; ) {
        ...
        if (u.from > r && (s == o || o > u.from)) {
          ...
          let f = /^\s*/.exec(u.text)[0].length,
            d = f == u.length,
            g = u.text.slice(f, f + c.length) == c ? f : -1;
          (f < u.text.length && f < a && (a = f),
            n.push({
              line: u,
              comment: g,
              token: c,
...
const la = ui.define(),
  ...
  Rg = Ee.define({
    ...
    update(i, e) {
      let t = e.state.facet(Tg),
        n = e.annotation(la);
      if (n) {
        let a = st.fromTransaction(e, n.selection),
          c = n.side,
          h = c == 0 ? i.undone : i.done;
        return (
          a
            ? (h = go(h, h.length, t.minDepth, a))
            : (h = Og(h, e.startState.selection)),
          new jt(c == 0 ? n.rest : h, c == 0 ? h : n.rest)
        );
      }
      let r = e.annotation(Qb);
      if (
        ((r == "full" || r == "before") && (i = i.isolate()),
    ...
    fromJSON(i) {
      return new jt(i.done.map(st.fromJSON), i.undone.map(st.fromJSON));
    },
  });
function ev(i = {}) {
  return [
...
class st {
  ...
  static fromJSON(e) {
    return new st(
      e.changes && Te.fromJSON(e.changes),
      [],
      e.mapped && Ht.fromJSON(e.mapped),
      e.startSelection && M.fromJSON(e.startSelection),
      e.selectionsAfter.map(M.fromJSON),
    );
  }
  ...
  static selection(e) {
    return new st(void 0, gt, void 0, void 0, e);
  }
}
function go(i, e, t, n) {
...
function nv(i, e) {
  let t = [],
    n = !1;
  return (
    i.iterChangedRanges((r, s) => t.push(r, s)),
...
function Og(i, e) {
  if (i.length) {
    let t = i[i.length - 1],
      n = t.selectionsAfter.slice(Math.max(0, t.selectionsAfter.length - sv));
    return n.length && n[n.length - 1].eq(e)
      ? i
      : (n.push(e), go(i, i.length - 1, 1e9, t.setSelAfter(n)));
...
function cl(i, e) {
  ...
  return n.length ? [st.selection(n)] : gt;
}
function lv(i, e, t) {
  let n = Pg(
    i.selectionsAfter.length ? i.selectionsAfter.map((l) => l.map(e)) : gt,
    t,
  );
  if (!i.changes) return st.selection(n);
  let r = i.changes.map(e),
    s = e.mapDesc(i.changes, !0),
    o = i.mapped ? i.mapped.composeDesc(s) : s;
  return new st(r, G.mapEffects(i.effects, e), o, i.startSelection.map(s), n);
}
const av = /^(input\.type|delete)($|\.)/;
class jt {
  ...
  addChanges(e, t, n, r, s) {
    ...
    return (
      ...
      ((!l.selectionsAfter.length &&
        ...
        r.joinToEvent(s, nv(l.changes, e.changes))) ||
        ...
        ? (o = go(
            ...
            new st(
              ...
              Pg(G.mapEffects(e.effects, l.changes), l.effects),
              l.mapped,
              l.startSelection,
              gt,
            ),
          ))
        : (o = go(o, o.length, r.minDepth, e)),
      new jt(o, gt, t, n)
    );
  }
  addSelection(e, t, n, r) {
    ...
    return s.length > 0 &&
      ...
      rv(s[s.length - 1], e)
      ? this
      : new jt(Og(this.done, e), this.undone, t, n);
  }
  addMapping(e) {
    return new jt(
      cl(this.done, e),
  ...
  pop(e, t, n) {
    ...
    if (n && s.selectionsAfter.length)
      return t.update({
        ...
        annotations: la.of({ side: e, rest: ov(r), selection: o }),
    ...
    if (s.changes) {
      ...
      return (
        s.mapped && (l = cl(l, s.mapped)),
        t.update({
          changes: s.changes,
          selection: s.startSelection,
          effects: s.effects,
          annotations: la.of({ side: e, rest: l, selection: o }),
          filter: !1,
...
function Dt({ state: i, dispatch: e }, t) {
  let n = An(i.selection, t);
  return n.eq(i.selection, !0) ? !1 : (e(Ut(i, n)), !0);
}
function Fo(i, e) {
  return M.cursor(e ? i.to : i.from);
}
function Eg(i, e) {
  return Dt(i, (t) => (t.empty ? i.moveByChar(t, e) : Fo(t, e)));
}
function Ue(i) {
  return i.textDirectionAt(i.state.selection.main.head) == he.LTR;
}
const Lg = (i) => Eg(i, !Ue(i)),
  Ng = (i) => Eg(i, Ue(i));
function _g(i, e) {
  return Dt(i, (t) => (t.empty ? i.moveByGroup(t, e) : Fo(t, e)));
}
const hv = (i) => _g(i, !Ue(i)),
  uv = (i) => _g(i, Ue(i));
function fv(i, e, t) {
...
function jo(i, e, t) {
  let n = $e(i).resolveInner(e.head),
    r = t ? Y.closedBy : Y.openedBy;
  for (let a = e.head; ; ) {
    let c = t ? n.childAfter(a) : n.childBefore(a);
    if (!c) break;
    fv(i, c, r) ? (n = c) : (a = t ? c.to : c.from);
  }
  let s = n.type.prop(r),
    o,
    l;
  return (
    s && (o = t ? Ft(i, n.from, 1) : Ft(i, n.to, -1)) && o.matched
      ? (l = t ? o.end.to : o.end.from)
      : (l = t ? n.to : n.from),
    M.cursor(l, t ? -1 : 1)
  );
}
const dv = (i) => Dt(i, (e) => jo(i.state, e, !Ue(i))),
  gv = (i) => Dt(i, (e) => jo(i.state, e, Ue(i)));
function Bg(i, e) {
  return Dt(i, (t) => {
    if (!t.empty) return Fo(t, e);
...
function jg(i, e) {
  let t = Fg(i),
    { state: n } = i,
    r = An(n.selection, (o) =>
      o.empty ? i.moveVertically(o, e, t.height) : Fo(o, e),
    );
  ...
  if (t.selfScroll) {
    let o = i.coordsAtPos(n.selection.main.head),
      ...
      a = l.top + t.marginTop,
      c = l.bottom - t.marginBottom;
    o &&
      o.top > a &&
      o.bottom < c &&
      (s = q.scrollIntoView(r.main.head, { y: "start", yMargin: o.top - a }));
  }
  return (i.dispatch(Ut(n, r), { effects: s }), !0);
}
const mu = (i) => jg(i, !1),
  ca = (i) => jg(i, !0);
function Ai(i, e, t) {
  let n = i.lineBlockAt(e.head),
    r = i.moveToLineBoundary(e, t);
  if (
    (r.head == e.head &&
      r.head != (t ? n.to : n.from) &&
      (r = i.moveToLineBoundary(e, t, !1)),
    !t && r.head == n.from && n.length)
  ) {
    let s = /^\s*/.exec(
      i.state.sliceDoc(n.from, Math.min(n.from + 100, n.to)),
    )[0].length;
    s && e.head != n.from + s && (r = M.cursor(n.from + s));
  }
  return r;
}
const mv = (i) => Dt(i, (e) => Ai(i, e, !0)),
  pv = (i) => Dt(i, (e) => Ai(i, e, !1)),
  yv = (i) => Dt(i, (e) => Ai(i, e, !Ue(i))),
  bv = (i) => Dt(i, (e) => Ai(i, e, Ue(i))),
  vv = (i) => Dt(i, (e) => M.cursor(i.lineBlockAt(e.head).from, 1)),
  wv = (i) => Dt(i, (e) => M.cursor(i.lineBlockAt(e.head).to, -1));
function Sv(i, e, t) {
  let n = !1,
    r = An(i.selection, (s) => {
      let o =
        Ft(i, s.head, -1) ||
        Ft(i, s.head, 1) ||
        (s.head > 0 && Ft(i, s.head - 1, 1)) ||
        (s.head < i.doc.length && Ft(i, s.head + 1, -1));
      if (!o || !o.end) return s;
      n = !0;
...
const kv = ({ state: i, dispatch: e }) => Sv(i, e);
function wt(i, e) {
  let t = An(i.state.selection, (n) => {
    let r = e(n);
    return M.range(n.anchor, r.head, r.goalColumn, r.bidiLevel || void 0);
  });
  return t.eq(i.state.selection) ? !1 : (i.dispatch(Ut(i.state, t)), !0);
}
function Hg(i, e) {
  return wt(i, (t) => i.moveByChar(t, e));
}
const Wg = (i) => Hg(i, !Ue(i)),
  Vg = (i) => Hg(i, Ue(i));
function zg(i, e) {
  return wt(i, (t) => i.moveByGroup(t, e));
}
const Cv = (i) => zg(i, !Ue(i)),
  xv = (i) => zg(i, Ue(i)),
  Mv = (i) => wt(i, (e) => jo(i.state, e, !Ue(i))),
  Dv = (i) => wt(i, (e) => jo(i.state, e, Ue(i)));
function $g(i, e) {
  return wt(i, (t) => i.moveVertically(t, e));
}
const Ug = (i) => $g(i, !1),
  Kg = (i) => $g(i, !0);
function Gg(i, e) {
  return wt(i, (t) => i.moveVertically(t, e, Fg(i).height));
}
const pu = (i) => Gg(i, !1),
  yu = (i) => Gg(i, !0),
  Tv = (i) => wt(i, (e) => Ai(i, e, !0)),
  Rv = (i) => wt(i, (e) => Ai(i, e, !1)),
  Av = (i) => wt(i, (e) => Ai(i, e, !Ue(i))),
  Pv = (i) => wt(i, (e) => Ai(i, e, Ue(i))),
  Ov = (i) => wt(i, (e) => M.cursor(i.lineBlockAt(e.head).from)),
  Ev = (i) => wt(i, (e) => M.cursor(i.lineBlockAt(e.head).to)),
  bu = ({ state: i, dispatch: e }) => (e(Ut(i, { anchor: 0 })), !0),
  vu = ({ state: i, dispatch: e }) => (e(Ut(i, { anchor: i.doc.length })), !0),
  wu = ({ state: i, dispatch: e }) => (
    e(Ut(i, { anchor: i.selection.main.anchor, head: 0 })),
    !0
  ),
  Su = ({ state: i, dispatch: e }) => (
    e(Ut(i, { anchor: i.selection.main.anchor, head: i.doc.length })),
    !0
  ),
  ...
  Nv = ({ state: i, dispatch: e }) => {
    let t = Ho(i).map(({ from: n, to: r }) =>
      M.range(n, Math.min(r + 1, i.doc.length)),
    );
    return (e(i.update({ selection: M.create(t), userEvent: "select" })), !0);
  },
  _v = ({ state: i, dispatch: e }) => {
    let t = An(i.selection, (n) => {
      let r = $e(i),
        s = r.resolveStack(n.from, 1);
      if (n.empty) {
    ...
    return t.eq(i.selection) ? !1 : (e(Ut(i, t)), !0);
  },
  Bv = ({ state: i, dispatch: e }) => {
    let t = i.selection,
      n = null;
    return (
      t.ranges.length > 1
        ? (n = M.create([t.main]))
        : t.main.empty || (n = M.create([M.cursor(t.main.head)])),
      n ? (e(Ut(i, n)), !0) : !1
    );
  };
function Ur(i, e) {
  ...
  let t = "delete.selection",
    ...
    r = n.changeByRange((s) => {
      ...
      if (o == l) {
        let a = e(s);
        (a < o
          ? ((t = "delete.backward"), (a = Ls(i, a, !1)))
          : a > o && ((t = "delete.forward"), (a = Ls(i, a, !0))),
          (o = Math.min(o, a)),
          (l = Math.max(l, a)));
      } else ((o = Ls(i, o, !1)), (l = Ls(i, l, !0)));
      return o == l
        ? { range: s }
        : {
            changes: { from: o, to: l },
            range: M.cursor(o, o < s.head ? -1 : 1),
          };
    });
...
function Ls(i, e, t) {
  if (i instanceof q)
    for (let n of i.state.facet(q.atomicRanges).map((r) => r(i)))
      n.between(e, e, (r, s) => {
        r < e && s > e && (e = t ? s : r);
      });
  return e;
...
const Jg = (i, e, t) =>
  ...
  Xg = (i, e) =>
    Ur(i, (t) => {
      ...
      for (let l = null; ; ) {
        ...
        let a = je(s.text, n - s.from, e) + s.from,
          c = s.text.slice(Math.min(n, a) - s.from, Math.max(n, a) - s.from),
          h = o(c);
        if (l != null && h != l) break;
        ((c != " " || n != t.head) && (l = h), (n = a));
      }
  ...
  Wv = ({ state: i, dispatch: e }) => {
    ...
    let t = i.changeByRange((n) => {
      ...
      let r = n.from,
        s = i.doc.lineAt(r),
        o = r == s.from ? r - 1 : je(s.text, r - s.from, !1) + s.from,
        l = r == s.to ? r + 1 : je(s.text, r - s.from, !0) + s.from;
      return {
        changes: {
          from: o,
          to: l,
...
function Ho(i) {
  let e = [],
    t = -1;
  for (let n of i.selection.ranges) {
    let r = i.doc.lineAt(n.from),
      s = i.doc.lineAt(n.to);
    if (
      (!n.empty && n.to == s.from && (s = i.doc.lineAt(n.to - 1)),
      t >= r.number)
    ) {
      let o = e[e.length - 1];
...
function Zg(i, e, t) {
  ...
  for (let s of Ho(i)) {
    ...
    let o = i.doc.lineAt(t ? s.to + 1 : s.from - 1),
      l = o.length + 1;
    if (t) {
      n.push(
        { from: s.to, to: o.to },
        { from: s.from, insert: o.text + i.lineBreak },
      );
      ...
      n.push(
        ...
        { from: s.to, insert: i.lineBreak + o.text },
      );
      for (let a of s.ranges) r.push(M.range(a.anchor - l, a.head - l));
    }
  }
  return n.length
    ? (e(
        i.update({
          changes: n,
          scrollIntoView: !0,
          selection: M.create(r, i.selection.mainIndex),
          userEvent: "move.line",
        }),
      ),
      !0)
...
const Vv = ({ state: i, dispatch: e }) => Zg(i, e, !1),
  zv = ({ state: i, dispatch: e }) => Zg(i, e, !0);
function em(i, e, t) {
  if (i.readOnly) return !1;
  let n = [];
  for (let r of Ho(i))
    t
      ...
      : n.push({ from: r.to, insert: i.lineBreak + i.doc.slice(r.from, r.to) });
  return (
    e(
...
const $v = ({ state: i, dispatch: e }) => em(i, e, !1),
  Uv = ({ state: i, dispatch: e }) => em(i, e, !0),
  Kv = (i) => {
    if (i.state.readOnly) return !1;
    let { state: e } = i,
      t = e.changes(
      ...
      n = An(e.selection, (r) => {
        ...
        if (i.lineWrapping) {
          let o = i.lineBlockAt(r.head),
            l = i.coordsAtPos(r.head, r.assoc || 1);
          l &&
            (s = o.bottom + i.documentTop - l.bottom + i.defaultLineHeight / 2);
        }
...
function Gv(i, e) {
  ...
  return n &&
    ...
    n.to <= e &&
    r.from >= e &&
    (s = n.type.prop(Y.closedBy)) &&
    s.indexOf(r.name) > -1 &&
    i.doc.lineAt(n.to).from == i.doc.lineAt(r.from).from &&
    !/\S/.test(i.sliceDoc(n.to, r.from))
    ? { from: n.to, to: r.from }
    : null;
}
const ku = tm(!1),
...
function tm(i) {
  return ({ state: e, dispatch: t }) => {
    ...
    let n = e.changeByRange((r) => {
      ...
      let c = new _o(e, { simulateBreak: s, simulateDoubleBreak: !!a }),
        h = Bc(c, s);
      for (
        h == null && (h = Rn(/^\s*/.exec(e.doc.lineAt(s).text)[0], e.tabSize));
      ...
      let u = ["", Rr(e, h)];
      return (
        a && u.push(Rr(e, c.lineIndent(l.from, -1))),
        {
          changes: { from: s, to: o, insert: ee.of(u) },
          range: M.cursor(s + 1 + u[1].length),
        }
      );
    });
...
function jc(i, e) {
  ...
  return i.changeByRange((n) => {
    ...
    return {
      changes: r,
      range: M.range(s.mapPos(n.anchor, 1), s.mapPos(n.head, 1)),
    };
  });
}
const Yv = ({ state: i, dispatch: e }) => {
    if (i.readOnly) return !1;
    let t = Object.create(null),
      n = new _o(i, {
      ...
      r = jc(i, (s, o, l) => {
        ...
        let c = /^\s*/.exec(s.text)[0],
          h = Rr(i, a);
        (c != h || l.from < s.from + c.length) &&
          ((t[s.from] = a),
          o.push({ from: s.from, to: s.from + c.length, insert: h }));
      });
    return (r.changes.empty || e(i.update(r, { userEvent: "indent" })), !0);
  },
  im = ({ state: i, dispatch: e }) =>
    i.readOnly
      ? !1
      : (e(
          i.update(
            jc(i, (t, n) => {
              n.push({ from: t.from, insert: i.facet(No) });
            }),
            { userEvent: "input.indent" },
          ),
        ),
        !0),
  nm = ({ state: i, dispatch: e }) =>
    i.readOnly
      ? !1
      : (e(
          i.update(
            jc(i, (t, n) => {
              ...
              if (!r) return;
              let s = Rn(r, i.tabSize),
                o = 0,
                l = Rr(i, Math.max(0, s - ho(i)));
              for (
                ;
                o < r.length &&
                o < l.length &&
        ...
        !0),
  Xv = (i) => (i.setTabFocusMode(), !0),
  Qv = [
    { key: "Ctrl-b", run: Lg, shift: Wg, preventDefault: !0 },
    { key: "Ctrl-f", run: Ng, shift: Vg },
    { key: "Ctrl-p", run: Ig, shift: Ug },
    { key: "Ctrl-n", run: qg, shift: Kg },
    { key: "Ctrl-a", run: vv, shift: Ov },
    { key: "Ctrl-e", run: wv, shift: Ev },
    { key: "Ctrl-d", run: Yg },
    { key: "Ctrl-h", run: ha },
    { key: "Ctrl-k", run: qv },
  ...
  Zv = [
    { key: "ArrowLeft", run: Lg, shift: Wg, preventDefault: !0 },
    {
      key: "Mod-ArrowLeft",
      mac: "Alt-ArrowLeft",
      run: hv,
    ...
    { mac: "Cmd-ArrowLeft", run: yv, shift: Av, preventDefault: !0 },
    { key: "ArrowRight", run: Ng, shift: Vg, preventDefault: !0 },
    {
      key: "Mod-ArrowRight",
      mac: "Alt-ArrowRight",
      run: uv,
    ...
    { mac: "Cmd-ArrowRight", run: bv, shift: Pv, preventDefault: !0 },
    { key: "ArrowUp", run: Ig, shift: Ug, preventDefault: !0 },
    { mac: "Cmd-ArrowUp", run: bu, shift: wu },
    { mac: "Ctrl-ArrowUp", run: mu, shift: pu },
    { key: "ArrowDown", run: qg, shift: Kg, preventDefault: !0 },
    { mac: "Cmd-ArrowDown", run: vu, shift: Su },
    { mac: "Ctrl-ArrowDown", run: ca, shift: yu },
    { key: "PageUp", run: mu, shift: pu },
    { key: "PageDown", run: ca, shift: yu },
    { key: "Home", run: pv, shift: Rv, preventDefault: !0 },
    { key: "Mod-Home", run: bu, shift: wu },
    { key: "End", run: mv, shift: Tv, preventDefault: !0 },
    { key: "Mod-End", run: vu, shift: Su },
    { key: "Enter", run: ku, shift: ku },
    { key: "Mod-a", run: Lv },
    { key: "Backspace", run: ha, shift: ha },
    { key: "Delete", run: Yg },
    { key: "Mod-Backspace", mac: "Alt-Backspace", run: Qg },
    { key: "Mod-Delete", mac: "Alt-Delete", run: Iv },
    { mac: "Mod-Backspace", run: Fv },
    { mac: "Mod-Delete", run: jv },
  ].concat(Qv.map((i) => ({ mac: i.key, run: i.run, shift: i.shift }))),
  ew = [
    { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: dv, shift: Mv },
    { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: gv, shift: Dv },
    { key: "Alt-ArrowUp", run: Vv },
    { key: "Shift-Alt-ArrowUp", run: $v },
    { key: "Alt-ArrowDown", run: zv },
    { key: "Shift-Alt-ArrowDown", run: Uv },
    { key: "Escape", run: Bv },
    { key: "Mod-Enter", run: Jv },
    { key: "Alt-l", mac: "Ctrl-l", run: Nv },
    { key: "Mod-i", run: _v, preventDefault: !0 },
    { key: "Mod-[", run: nm },
    { key: "Mod-]", run: im },
    { key: "Mod-Alt-\\", run: Yv },
    { key: "Shift-Mod-k", run: Kv },
    { key: "Shift-Mod-\\", run: kv },
    { key: "Mod-/", run: $b },
    { key: "Alt-A", run: Kb },
    { key: "Ctrl-m", mac: "Shift-Alt-m", run: Xv },
  ].concat(Zv),
  tw = { key: "Tab", run: im, shift: nm },
  Cu =
...
typeof Symbol < "u" &&
  (kn.prototype[Symbol.iterator] = function () {
    return this;
  });
const rm = { from: -1, to: -1, match: /.*/.exec("") },
  Hc = "gm" + (/x/.unicode == null ? "" : "u");
class sm {
  constructor(e, t, n, r = 0, s = e.length) {
    if (
      ...
      return new om(e, t, n, r, s);
    ((this.re = new RegExp(t, Hc + (n != null && n.ignoreCase ? "i" : ""))),
      (this.test = n == null ? void 0 : n.test),
      (this.iter = e.iter()));
    let o = e.lineAt(r);
    ((this.curLineStart = o.from),
      (this.matchPos = mo(e, r)),
    ...
    for (let e = this.matchPos - this.curLineStart; ; ) {
      ...
      if (t) {
        let n = this.curLineStart + t.index,
          r = n + t[0].length;
        if (
          ((this.matchPos = mo(this.text, r + (n == r ? 1 : 0))),
...
class mn {
  ...
  static get(e, t, n) {
    ...
    if (!r || r.from >= n || r.to <= t) {
      let l = new mn(t, e.sliceString(t, n));
      return (hl.set(e, l), l);
    }
    ...
    return (
      ...
      r.to < n && (s += e.sliceString(r.to, n)),
      hl.set(e, new mn(o, s)),
      new mn(t, s.slice(t - o, n - o))
    );
  }
}
class om {
  constructor(e, t, n, r, s) {
    ((this.text = e),
      ...
      (this.re = new RegExp(t, Hc + (n != null && n.ignoreCase ? "i" : ""))),
      (this.test = n == null ? void 0 : n.test),
      (this.flat = mn.get(e, r, this.chunkEnd(r + 5e3))));
  }
  chunkEnd(e) {
    ...
    for (;;) {
      ...
      if (
        ...
        if (
          ...
          return (
            (this.value = { from: n, to: r, match: t }),
            (this.matchPos = mo(this.text, r + (n == r ? 1 : 0))),
            this
          );
      }
...
typeof Symbol < "u" &&
  (sm.prototype[Symbol.iterator] = om.prototype[Symbol.iterator] =
    function () {
      return this;
    });
function iw(i) {
...
function ua(i) {
  let e = String(i.state.doc.lineAt(i.state.selection.main.head).number),
    t = re("input", { class: "cm-textfield", name: "line", value: e }),
    n = re(
      "form",
      {
        class: "cm-gotoLine",
      ...
      re("label", i.state.phrase("Go to line"), ": ", t),
      " ",
      re(
        "button",
      ...
      re(
        "button",
        {
          name: "close",
          onclick: () => {
            (i.dispatch({ effects: yr.of(!1) }), i.focus());
          },
  ...
  function r() {
    ...
    if (c && u) {
      let b = d / 100;
      (a && (b = b * (a == "-" ? -1 : 1) + l.number / o.doc.lines),
        (d = Math.round(o.doc.lines * b)));
    } else c && a && (d = d * (a == "-" ? -1 : 1) + l.number);
    let g = o.doc.line(Math.max(1, Math.min(o.doc.lines, d))),
      p = M.cursor(g.from + Math.max(0, Math.min(f, g.length)));
    (i.dispatch({
      effects: [yr.of(!1), q.scrollIntoView(p.from, { y: "center" })],
      selection: p,
    }),
      i.focus());
  }
...
const yr = G.define(),
  xu = Ee.define({
    ...
    update(i, e) {
      for (let t of e.effects) t.is(yr) && (i = t.value);
      return i;
    },
    provide: (i) => Dr.from(i, (e) => (e ? ua : null)),
  }),
  nw = (i) => {
    let e = Mr(i, ua);
    if (!e) {
      let t = [yr.of(!0)];
      (i.state.field(xu, !1) == null && t.push(G.appendConfig.of([xu, rw])),
        i.dispatch({ effects: t }),
        (e = Mr(i, ua)));
    }
...
const aw = $.mark({ class: "cm-selectionMatch" }),
  cw = $.mark({ class: "cm-selectionMatch cm-selectionMatch-main" });
function Mu(i, e, t, n) {
  return (
    (t == 0 || i(e.sliceDoc(t - 1, t)) != ue.Word) &&
    (n == e.doc.length || i(e.sliceDoc(n, n + 1)) != ue.Word)
  );
}
function hw(i, e, t, n) {
  return (
    i(e.sliceDoc(t, t + 1)) == ue.Word && i(e.sliceDoc(n - 1, n)) == ue.Word
  );
}
const uw = xe.fromClass(
    class {
      constructor(i) {
        this.decorations = this.getDeco(i);
      }
      ...
      getDeco(i) {
        let e = i.state.facet(ow),
          { state: t } = i,
          n = t.selection;
        if (n.ranges.length > 1) return $.none;
        let r = n.main,
          s,
          o = null;
        if (r.empty) {
          if (!e.highlightWordAroundCursor) return $.none;
          ...
          if (e.wholeWords) {
            if (
              ...
              !(Mu(o, t, r.from, r.to) && hw(o, t, r.from, r.to)))
            )
              return $.none;
          } else if (((s = t.sliceDoc(r.from, r.to)), !s)) return $.none;
        }
        let l = [];
        for (let a of i.visibleRanges) {
          let c = new kn(t.doc, s, a.from, a.to);
          for (; !c.next().done; ) {
            let { from: h, to: u } = c.value;
            if (
              (!o || Mu(o, t, h, u)) &&
              (r.empty && h <= r.from && u >= r.to
                ? l.push(cw.range(h, u))
                : (h >= r.to || u <= r.from) && l.push(aw.range(h, u)),
  ...
  dw = ({ state: i, dispatch: e }) => {
    let { selection: t } = i,
      n = M.create(
        t.ranges.map((r) => i.wordAt(r.head) || M.cursor(r.head)),
        t.mainIndex,
      );
...
function gw(i, e) {
  ...
  for (let o = !1, l = new kn(i.doc, e, n[n.length - 1].to); ; )
    if ((l.next(), l.done)) {
      if (o) return null;
      ((l = new kn(i.doc, e, 0, Math.max(0, n[n.length - 1].from - 1))),
        (o = !0));
    } else {
...
const mw = ({ state: i, dispatch: e }) => {
    let { ranges: t } = i.selection;
    if (t.some((s) => s.from === s.to)) return dw({ state: i, dispatch: e });
    ...
    return r
      ? (e(
          i.update({
            selection: i.selection.addRange(M.range(r.from, r.to), !1),
            effects: q.scrollIntoView(r.to),
          }),
        ),
        !0)
      : !1;
...
class lm {
  constructor(e) {
    ((this.search = e.search),
      ...
      (this.valid = !!this.search && (!this.regexp || iw(this.search))),
...
`
  ...
  create() {
    return this.regexp ? new vw(this) : new yw(this);
  }
  getCursor(e, t = 0, n) {
    let r = e.doc ? e : Q.create({ doc: e });
    return (
      n == null && (n = r.doc.length),
      this.regexp ? an(this, r, t, n) : ln(this, r, t, n)
    );
  }
}
class am {
...
function ln(i, e, t, n) {
  return new kn(
    ...
    i.wholeWord ? pw(e.doc, e.charCategorizer(e.selection.main.head)) : void 0,
  );
}
function pw(i, e) {
  return (t, n, r, s) => (
    (s > t || s + r.length < n) &&
      ((s = Math.max(0, t - 2)),
      (r = i.sliceString(s, Math.min(i.length, n + 2)))),
    (e(po(r, t - s)) != ue.Word || e(yo(r, t - s)) != ue.Word) &&
      (e(yo(r, n - s)) != ue.Word || e(po(r, n - s)) != ue.Word)
  );
}
class yw extends am {
  constructor(e) {
  ...
  nextMatch(e, t, n) {
    let r = ln(this.spec, e, n, e.doc.length).nextOverlapping();
    if (r.done) {
      let s = Math.min(e.doc.length, t + this.spec.unquoted.length);
      r = ln(this.spec, e, 0, s).nextOverlapping();
    }
  ...
  matchAll(e, t) {
    let n = ln(this.spec, e, 0, e.doc.length),
      r = [];
    for (; !n.next().done; ) {
...
function an(i, e, t, n) {
  return new sm(
    ...
    i.search,
    {
      ...
      test: i.wholeWord ? bw(e.charCategorizer(e.selection.main.head)) : void 0,
    },
    t,
    n,
  );
...
function bw(i) {
  return (e, t, n) =>
    !n[0].length ||
    ((i(po(n.input, n.index)) != ue.Word ||
      i(yo(n.input, n.index)) != ue.Word) &&
      (i(yo(n.input, n.index + n[0].length)) != ue.Word ||
        i(po(n.input, n.index + n[0].length)) != ue.Word));
}
class vw extends am {
  nextMatch(e, t, n) {
    let r = an(this.spec, e, n, e.doc.length).next();
    return (
      r.done && (r = an(this.spec, e, 0, t).next()),
      r.done ? null : r.value
    );
  }
  prevMatchInRange(e, t, n) {
    for (let r = 1; ; r++) {
      let s = Math.max(t, n - r * 1e4),
        o = an(this.spec, e, s, n),
        l = null;
    ...
    return this.spec
      ...
      .replace(/\$([$&]|\d+)/g, (t, n) => {
        ...
        for (let r = n.length; r > 0; r--) {
          let s = +n.slice(0, r);
          if (s > 0 && s < e.match.length) return e.match[s] + n.slice(r);
        }
        return t;
      });
  }
  matchAll(e, t) {
    let n = an(this.spec, e, 0, e.doc.length),
      r = [];
    for (; !n.next().done; ) {
      if (r.length >= t) return null;
      r.push(n.value);
...
const Ar = G.define(),
  ...
  Si = Ee.define({
    create(i) {
      return new ul(fa(i).create(), null);
    },
    update(i, e) {
      for (let t of e.effects)
        t.is(Ar)
          ? (i = new ul(t.value.create(), i.panel))
          : t.is(Wc) && (i = new ul(i.query, t.value ? Vc : null));
      return i;
    },
...
const ww = $.mark({ class: "cm-searchMatch" }),
  Sw = $.mark({ class: "cm-searchMatch cm-searchMatch-selected" }),
  kw = xe.fromClass(
    class {
      constructor(i) {
        ((this.view = i),
          (this.decorations = this.highlight(i.state.field(Si))));
      }
      update(i) {
        let e = i.state.field(Si);
        (e != i.startState.field(Si) ||
          i.docChanged ||
          i.selectionSet ||
          i.viewportChanged) &&
      ...
      highlight({ query: i, panel: e }) {
        ...
        for (let r = 0, s = t.visibleRanges, o = s.length; r < o; r++) {
          ...
          i.highlight(t.state, l, a, (c, h) => {
            let u = t.state.selection.ranges.some(
              (f) => f.from == c && f.to == h,
            );
            n.add(c, h, u ? Sw : ww);
          });
...
function Kr(i) {
  return (e) => {
    ...
    return t && t.query.spec.valid ? i(e, t) : um(e);
  };
}
const bo = Kr((i, { query: e }) => {
    let { to: t } = i.state.selection.main,
      n = e.nextMatch(i.state, t, t);
    if (!n) return !1;
    let r = M.single(n.from, n.to),
      s = i.state.facet(Pn);
    return (
      i.dispatch({
        selection: r,
        effects: [zc(i, n), s.scrollToMatch(r.main, i)],
  ...
  vo = Kr((i, { query: e }) => {
    let { state: t } = i,
      ...
      r = e.prevMatch(t, n, n);
    if (!r) return !1;
    let s = M.single(r.from, r.to),
      o = i.state.facet(Pn);
    return (
      i.dispatch({
        selection: s,
        effects: [zc(i, r), o.scrollToMatch(s.main, i)],
        userEvent: "select.search",
      }),
      hm(i),
      !0
  ...
  xw = ({ state: i, dispatch: e }) => {
    let t = i.selection;
    if (t.ranges.length > 1 || t.main.empty) return !1;
    let { from: n, to: r } = t.main,
      s = [],
      o = 0;
    for (let l = new kn(i.doc, i.sliceDoc(n, r)); !l.next().done; ) {
      if (s.length > 1e3) return !1;
      (l.value.from == n && (o = s.length),
        s.push(M.range(l.value.from, l.value.to)));
    }
    return (
      e(
        i.update({
  ...
  Du = Kr((i, { query: e }) => {
    ...
    o.from == n &&
      o.to == r &&
      ((c = t.toText(e.getReplacement(o))),
      l.push({ from: o.from, to: o.to, insert: c }),
    ...
    let u = i.state.changes(l);
    return (
      o &&
        ((a = M.single(o.from, o.to).map(u)),
        h.push(zc(i, o)),
        h.push(t.facet(Pn).scrollToMatch(a.main, i))),
      i.dispatch({
        changes: u,
        selection: a,
        effects: h,
...
function Vc(i) {
  return i.state.facet(Pn).createPanel(i);
}
function fa(i, e) {
  var t, n, r, s, o;
...
const um = (i) => {
    ...
    if (e && e.panel) {
      ...
      i.dispatch({
        effects: [
          Wc.of(!0),
          e ? Ar.of(fa(i.state, e.query.spec)) : G.appendConfig.of(Aw),
        ],
      });
    return !0;
  },
  fm = (i) => {
    ...
    return (
      ...
      i.dispatch({ effects: Wc.of(!1) }),
      !0
    );
  },
  Dw = [
    { key: "Mod-f", run: um, scope: "editor search-panel" },
    {
      key: "F3",
      run: bo,
      shift: vo,
    ...
    { key: "Escape", run: fm, scope: "editor search-panel" },
    { key: "Mod-Shift-l", run: xw },
    { key: "Mod-Alt-g", run: nw },
    { key: "Mod-d", run: mw, preventDefault: !0 },
  ];
class Tw {
  constructor(e) {
    this.view = e;
    ...
    this.dom = re(
      ...
      [
        this.searchField,
        n("next", () => bo(e), [ot(e, "next")]),
        n("prev", () => vo(e), [ot(e, "previous")]),
        n("select", () => Cw(e), [ot(e, "all")]),
        re("label", null, [this.caseField, ot(e, "match case")]),
        re("label", null, [this.reField, ot(e, "regexp")]),
        re("label", null, [this.wordField, ot(e, "by word")]),
        ...(e.state.readOnly
          ? []
          : [
              re("br"),
              this.replaceField,
              n("replace", () => Du(e), [ot(e, "replace")]),
              n("replaceAll", () => Mw(e), [ot(e, "replace all")]),
            ]),
        re(
          "button",
          {
  ...
  keydown(e) {
    B0(this.view, e, "search-panel")
      ? e.preventDefault()
      : e.keyCode == 13 && e.target == this.searchField
        ? (e.preventDefault(), (e.shiftKey ? vo : bo)(this.view))
        : e.keyCode == 13 &&
          e.target == this.replaceField &&
          (e.preventDefault(), Du(this.view));
  }
  update(e) {
    for (let t of e.transactions)
      for (let n of t.effects)
...
const Ns = 30,
  _s = /[\s\.,:;?!]/;
function zc(i, { from: e, to: t }) {
  let n = i.state.doc.lineAt(e),
    r = i.state.doc.lineAt(t).to,
    s = Math.max(n.from, e - Ns),
    o = Math.min(r, t + Ns),
    l = i.state.sliceDoc(s, o);
  if (s != n.from) {
    for (let a = 0; a < Ns; a++)
      if (!_s.test(l[a + 1]) && _s.test(l[a])) {
        l = l.slice(a);
        break;
      }
  }
  if (o != r) {
    for (let a = l.length - 1; a > l.length - Ns; a--)
      if (!_s.test(l[a - 1]) && _s.test(l[a])) {
        l = l.slice(0, a);
        break;
      }
  ...
  return q.announce.of(
    `${i.state.phrase("current match")}. ${l} ${i.state.phrase("on line")} ${n.number}.`,
  );
}
const Rw = q.baseTheme({
    ".cm-panel.cm-search": {
      padding: "2px 6px 4px",
      position: "relative",
      "& [name=close]": {
...
class dm {
  ...
  tokenBefore(e) {
    let t = $e(this.state).resolveInner(this.pos, -1);
...
function Ow(i) {
  let e = i.map((r) => (typeof r == "string" ? { label: r } : r)),
    [t, n] = e.every((r) => /^\w+$/.test(r.label)) ? [/\w*$/, /\w+$/] : Pw(e);
  return (r) => {
    ...
    Object.assign(
      ...
      i.changeByRange((l) => {
        if (
          l != r &&
          t != n &&
          i.sliceDoc(l.from + s, l.from + o) != i.sliceDoc(t, n)
        )
          return { range: l };
        let a = i.toText(e);
        return {
...
class Nw {
  ...
  match(e) {
    ...
    let a = t.length,
      c = 0;
    if (l < 0) {
      for (let S = 0, C = Math.min(e.length, 200); S < C && c < a; ) {
        let R = tt(e, S);
        ((R == t[c] || R == n[c]) && (r[c++] = S), (S += Bt(R)));
      }
      if (c < a) return null;
    }
    let h = 0,
      ...
      b = /[a-z]/.test(e),
      v = !0;
    for (let S = 0, C = Math.min(e.length, 200), R = 0; S < C && u < a; ) {
      let D = tt(e, S);
      l < 0 &&
        (h < a && D == t[h] && (s[h++] = S),
        d < a &&
      ...
      let T,
        A =
          D < 255
            ? (D >= 48 && D <= 57) || (D >= 97 && D <= 122)
              ? 2
              : D >= 65 && D <= 90
                ? 1
                : 0
            : (T = yc(D)) != T.toLowerCase()
              ? 1
              : T != T.toUpperCase()
                ? 2
                : 0;
    ...
    return u == a && o[0] == 0 && v
      ...
      : d == a && g == 0
        ...
        : l > -1
          ...
          : d == a
            ? this.ret(-900 - e.length, [g, p])
            : u == a
              ? this.result(
                  -100 + (f ? -200 : 0) + -700 + (v ? 0 : -1100),
                  o,
                  e,
                )
              : t.length == 2
  ...
  result(e, t, n) {
    let r = [],
      s = 0;
    for (let o of t) {
      let l = o + (this.astral ? Bt(tt(n, o)) : 1);
  ...
  combine(i) {
    return $t(
      ...
      },
      {
        ...
        closeOnBlur: (e, t) => e && t,
        icons: (e, t) => e && t,
        tooltipClass: (e, t) => (n) => Pu(e(n), t(n)),
        optionClass: (e, t) => (n) => Pu(e(n), t(n)),
...
function Bw(i, e, t, n, r, s) {
  let o = i.textDirection == he.RTL,
    l = o,
    a = !1,
    c = "top",
    h,
    ...
    e.push(
      {
        render(t, n, r, s) {
          ...
          for (let c = 0; c < s.length; ) {
            ...
            (f.appendChild(document.createTextNode(l.slice(h, u))),
      ...
      },
      {
        render(t) {
          ...
          return (
            (n.className = "cm-completionDetail"),
            (n.textContent = t.detail),
            n
          );
        },
        position: 80,
...
class qw {
  constructor(e, t, n) {
    ...
    let r = e.state.field(t),
      ...
      l = e.state.facet(Oe);
    ((this.optionContent = Iw(l)),
      (this.optionClass = l.optionClass),
      (this.tooltipClass = l.tooltipClass),
      (this.range = fl(s.length, o, l.maxRenderedOptions)),
      (this.dom = document.createElement("div")),
      ...
      this.dom.addEventListener("focusout", (a) => {
        ...
        c &&
          c.tooltip &&
          e.state.facet(Oe).closeOnBlur &&
          a.relatedTarget != e.contentDOM &&
          e.dispatch({ effects: Pr.of(null) });
      }),
  ...
  update(e) {
    ...
    if ((this.updateTooltipClass(e.state), n != r)) {
      ...
      ((!r.open || r.open.options != s) &&
        ((this.range = fl(s.length, o, e.state.facet(Oe).maxRenderedOptions)),
    ...
    if (
      (((t.selected > -1 && t.selected < this.range.from) ||
        ...
        ((this.range = fl(
          t.options.length,
          t.selected,
          this.view.state.facet(Oe).maxRenderedOptions,
        )),
  ...
  measureInfo() {
    ...
    return r.top > Math.min(s.bottom, t.bottom) - 10 ||
      ...
      ? null
      : this.view.state.facet(Oe).positionInfo(this.view, t, r, n, s, this.dom);
  }
  placeInfo(e) {
    this.info &&
      (e
...
function Fw(i, e) {
  return (t) => new qw(t, i, e);
}
function jw(i, e) {
  let t = i.getBoundingClientRect(),
    n = e.getBoundingClientRect(),
    r = t.height / i.offsetHeight;
  n.top < t.top
    ? (i.scrollTop -= (t.top - n.top) / r)
    : n.bottom > t.bottom && (i.scrollTop += (n.bottom - t.bottom) / r);
}
function Ou(i) {
  return (
    (i.boost || 0) * 100 +
...
function Hw(i, e) {
  let t = [],
    ...
    r = (c) => {
      ...
      if (h) {
        ...
        n.some((f) => f.name == u) ||
          n.push(typeof h == "string" ? { name: u } : h);
      }
    },
    s = e.facet(Oe);
  for (let c of i)
    if (c.hasResult()) {
      ...
      if (c.result.filter === !1)
        for (let u of c.result.options)
          r(new Ru(u, c.source, h ? h(u) : [], 1e9 - t.length));
      else {
        let u = e.sliceDoc(c.from, c.to),
          f,
          d = s.filterStrict ? new _w(u) : new Nw(u);
        for (let g of c.result.options)
          if ((f = d.match(g.label))) {
            let p = g.displayLabel ? (h ? h(g, f.matched) : []) : f.matched;
            r(new Ru(g, c.source, p, f.score + (g.boost || 0)));
          }
      }
    }
  if (n) {
    let c = Object.create(null),
      ...
      u = (f, d) => {
        var g, p;
        return (
          ((g = f.rank) !== null && g !== void 0 ? g : 1e9) -
            ((p = d.rank) !== null && p !== void 0 ? p : 1e9) ||
          (f.name < d.name ? -1 : 1)
        );
      };
    for (let f of n.sort(u)) ((h -= 1e5), (c[f.name] = h));
    for (let f of t) {
  ...
  for (let c of t.sort(
    (h, u) => u.score - h.score || a(h.completion, u.completion),
  )) {
    let h = c.completion;
    (!l ||
    l.label != h.label ||
    ...
    l.boost != h.boost
      ? o.push(c)
      : Ou(c.completion) > Ou(l) && (o[o.length - 1] = c),
      (l = c.completion));
  }
  return o;
}
class un {
  ...
  static build(e, t, n, r, s, o) {
    if (r && !o && e.some((c) => c.isPending)) return r.setDisabled();
    let l = Hw(e, t);
    if (!l.length)
...
class So {
  ...
  update(e) {
    let { state: t } = e,
      n = t.facet(Oe),
      s = (n.override || t.languageDataAt("autocomplete", Gi(t)).map(Lw)).map(
        (a) =>
          (
            this.active.find((h) => h.source == a) ||
            new mt(a, this.active.some((h) => h.state != 0) ? 1 : 0)
          ).update(e, n),
      );
    s.length == this.active.length &&
      s.every((a, c) => a == this.active[c]) &&
      (s = this.active);
    let o = this.open,
      l = e.effects.some((a) => a.is($c));
    (o && e.docChanged && (o = o.map(e.changes)),
      e.selection ||
      s.some((a) => a.hasResult() && e.changes.touchesRange(a.from, a.to)) ||
      !Ww(s, this.active) ||
      l
        ? (o = un.build(s, t, this.id, o, n, l))
        : o && o.disabled && !s.some((a) => a.isPending) && (o = null),
      !o &&
        s.every((a) => !a.isPending) &&
        s.some((a) => a.hasResult()) &&
        (s = s.map((a) => (a.hasResult() ? new mt(a.source, 0) : a))));
    for (let a of e.effects)
      a.is(ym) && (o = o && o.setSelected(a.value, this.id));
    return s == this.active && o == this.open ? this : new So(s, this.id, o);
  }
  get tooltip() {
    return this.open ? this.open.tooltip : null;
  }
  get attrs() {
    return this.open ? this.open.attrs : this.active.length ? Vw : zw;
  }
}
function Ww(i, e) {
  if (i == e) return !0;
...
const Vw = { "aria-autocomplete": "list" },
  zw = {};
function Eu(i, e) {
  let t = {
...
class mt {
  ...
  update(e, t) {
    let n = pm(e, t),
      r = this;
    ((n & 8 || (n & 16 && this.touches(e))) && (r = new mt(r.source, 0)),
      n & 4 && r.state == 0 && (r = new mt(this.source, 1)),
      (r = r.updateFor(e, n)));
    for (let s of e.effects)
      if (s.is(wo)) r = new mt(r.source, 1, s.value);
      else if (s.is(Pr)) r = new mt(r.source, 0);
      else if (s.is($c)) for (let o of s.value) o.source == r.source && (r = o);
    return r;
  }
  updateFor(e, t) {
...
class pn extends mt {
  ...
  updateFor(e, t) {
    ...
    if (
      l > o ||
      !r ||
      (t & 2 && (Gi(e.startState) == this.from || l < this.limit))
    )
      return new mt(this.source, t & 4 ? 1 : 0);
    let a = e.changes.mapPos(this.limit);
    return Uw(r.validFor, e.state, s, o)
      ? new pn(this.source, this.explicit, a, r, s, o)
      : r.update && (r = r.update(r, s, o, new dm(e.state, l, !1)))
        ? new pn(
            this.source,
            this.explicit,
            a,
            r,
            r.from,
            (n = r.to) !== null && n !== void 0 ? n : Gi(e.state),
          )
        : new mt(this.source, 1, this.explicit);
  }
  map(e) {
    return e.empty
      ? this
...
function Uw(i, e, t, n) {
  ...
  return typeof i == "function" ? i(r, t, n, e) : gm(i, !0).test(r);
}
const $c = G.define({
    map(i, e) {
...
function Uc(i, e) {
  ...
  return n instanceof pn
    ? (typeof t == "string"
        ? i.dispatch(
            Object.assign(Object.assign({}, Ew(i.state, t, n.from, n.to)), {
              annotations: mm.of(e.completion),
            }),
          )
...
function Bs(i, e = "option") {
  return (t) => {
    ...
    if (
      ...
      !n.open ||
      n.open.disabled ||
      Date.now() - n.open.timestamp < t.state.facet(Oe).interactionDelay
    )
      return !1;
    let r = 1,
      s;
    e == "page" &&
      (s = ng(t, n.open.tooltip)) &&
      (r = Math.max(
        2,
        Math.floor(
...
const Gw = (i) => {
    ...
    return i.state.readOnly ||
      ...
      e.open.selected < 0 ||
      e.open.disabled ||
      Date.now() - e.open.timestamp < i.state.facet(Oe).interactionDelay
      ? !1
      : Uc(i, e.open.options[e.open.selected]);
  },
  Lu = (i) =>
    i.state.field(nt, !1) ? (i.dispatch({ effects: wo.of(!0) }), !0) : !1,
  Jw = (i) => {
    let e = i.state.field(nt, !1);
    return !e || !e.active.some((t) => t.state != 0)
      ? !1
      : (i.dispatch({ effects: Pr.of(null) }), !0);
  };
class Yw {
  constructor(e, t) {
    ((this.active = e),
...
const Xw = 50,
    ...
    class {
      ...
      update(i) {
        ...
        for (let s = 0; s < this.running.length; s++) {
          ...
          if (
            n ||
            (o.context.abortOnDocChange && i.docChanged) ||
            (o.updates.length + i.transactions.length > Xw &&
              Date.now() - o.time > Qw)
          ) {
        ...
        (this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate),
          i.transactions.some((s) => s.effects.some((o) => o.is(wo))) &&
            (this.pendingStart = !0));
      ...
      startUpdate() {
        ...
        this.running.length &&
          ...
          (this.debounceAccept = setTimeout(
            () => this.accept(),
            this.view.state.facet(Oe).updateSyncTime,
          ));
      }
      startQuery(i) {
        let { state: e } = this.view,
          t = Gi(e),
          n = new dm(e, t, i.explicit, this.view),
          r = new Yw(i, n);
        (this.running.push(r),
          Promise.resolve(i.source(n)).then(
            ...
            (s) => {
              (this.view.dispatch({ effects: Pr.of(null) }),
      ...
      accept() {
        ...
        (this.debounceAccept > -1 && clearTimeout(this.debounceAccept),
          (this.debounceAccept = -1));
        let e = [],
          t = this.view.state.facet(Oe),
          n = this.view.state.field(nt);
          ...
          if ((this.running.splice(r--, 1), s.done)) {
            let l = Gi(
              ...
              c = new pn(
                ...
                s.done,
                s.done.from,
                (i = s.done.to) !== null && i !== void 0 ? i : l,
              );
            for (let h of s.updates) c = c.update(h, t);
            if (c.hasResult()) {
              e.push(c);
              continue;
            }
      ...
      eventHandlers: {
        blur(i) {
          ...
          if (e && e.tooltip && this.view.state.facet(Oe).closeOnBlur) {
            let t = e.open && ng(this.view, e.open.tooltip);
        ...
        compositionend() {
          (this.composing == 3 &&
            setTimeout(() => this.view.dispatch({ effects: wo.of(!1) }), 20),
            (this.composing = 0));
        },
      },
    },
  ),
  e1 = typeof navigator == "object" && /Win/.test(navigator.platform),
  t1 = Ti.highest(
    q.domEventHandlers({
      keydown(i, e) {
  ...
  Ui = G.define({
    map(i, e) {
      let t = e.mapPos(i, -1, Xe.TrackAfter);
      return t ?? void 0;
    },
  }),
  Kc = new (class extends Yi {})();
Kc.startSide = 1;
Kc.endSide = -1;
const bm = Ee.define({
  create() {
  ...
  update(i, e) {
    ...
    for (let t of e.effects)
      t.is(Ui) && (i = i.update({ add: [Kc.range(t.value, t.value + 1)] }));
    return i;
  },
});
function n1() {
...
const dl = "()[]{}<>«»»«［］｛｝";
function vm(i) {
  for (let e = 0; e < dl.length; e += 2)
    if (dl.charCodeAt(e) == i) return dl.charAt(e + 1);
  return yc(i < 128 ? i : i + 1);
}
function wm(i, e) {
  return i.languageDataAt("closeBrackets", e)[0] || Or;
}
const r1 =
    typeof navigator == "object" && /Android\b/.test(navigator.userAgent),
  s1 = q.inputHandler.of((i, e, t, n) => {
    if ((r1 ? i.composing : i.compositionStarted) || i.state.readOnly)
      return !1;
    let r = i.state.selection.main;
    if (
      n.length > 2 ||
      (n.length == 2 && Bt(tt(n, 0)) == 1) ||
      e != r.from ||
      t != r.to
    )
      return !1;
  ...
  o1 = ({ state: i, dispatch: e }) => {
    if (i.readOnly) return !1;
    let n = wm(i, i.selection.main.head).brackets || Or.brackets,
      r = null,
      s = i.changeByRange((o) => {
        if (o.empty) {
          let l = c1(i.doc, o.head);
          for (let a of n)
            if (a == l && Wo(i.doc, o.head) == vm(tt(a, 0)))
              return {
    ...
    return (
      r || e(i.update(s, { scrollIntoView: !0, userEvent: "delete.backward" })),
      !r
    );
  },
  l1 = [{ key: "Backspace", run: o1 }];
function a1(i, e) {
  let t = wm(i, i.selection.main.head),
    n = t.brackets || Or.brackets;
  for (let r of n) {
    let s = vm(tt(r, 0));
    if (e == r)
      return s == r
        ? f1(i, r, n.indexOf(r + r + r) > -1, t)
        : h1(i, r, s, t.before || Or.before);
    if (e == s && Sm(i, i.selection.main.from)) return u1(i, r, s);
  }
  return null;
}
function Sm(i, e) {
  let t = !1;
  return (
    i.field(bm).between(0, i.doc.length, (n) => {
      n == e && (t = !0);
    }),
    t
  );
...
function Wo(i, e) {
  ...
  return t.slice(0, Bt(tt(t, 0)));
}
function c1(i, e) {
  let t = i.sliceString(e - 2, e);
  return Bt(tt(t, 0)) == t.length ? t : t.slice(1);
}
function h1(i, e, t, n) {
  let r = null,
    s = i.changeByRange((o) => {
...
function f1(i, e, t, n) {
  let r = n.stringPrefixes || Or.stringPrefixes,
    s = null,
    o = i.changeByRange((l) => {
      if (!l.empty)
        return {
...
function Nu(i, e) {
  let t = $e(i).resolveInner(e + 1);
  return t.parent && t.from == e;
}
function d1(i, e, t, n) {
  let r = $e(i).resolveInner(e, -1),
    s = n.reduce((o, l) => Math.max(o, l.length), 0);
  for (let o = 0; o < 5; o++) {
    let l = i.sliceDoc(r.from, Math.min(r.to, r.from + t.length + s)),
      a = l.indexOf(t);
    if (!a || (a > -1 && n.indexOf(l.slice(0, a)) > -1)) {
      let h = r.firstChild;
      for (; h && h.from == r.from && h.to - h.from > t.length + a; ) {
        if (i.sliceDoc(h.to - t.length, h.to) == t) return !1;
        h = h.firstChild;
      }
      return !0;
    }
...
function _u(i, e, t) {
  let n = i.charCategorizer(e);
  if (n(i.sliceDoc(e - 1, e)) != ue.Word) return e;
  for (let r of t) {
    let s = e - r.length;
    if (i.sliceDoc(s, e) == r && n(i.sliceDoc(s - 1, s)) != ue.Word) return s;
  }
  return -1;
}
function km(i = {}) {
  return [t1, nt, Oe.of(i), Zw, g1, i1];
}
const Cm = [
    { key: "Ctrl-Space", run: Lu },
    { mac: "Alt-`", run: Lu },
    { key: "Escape", run: Jw },
    { key: "ArrowDown", run: Bs(!0) },
    { key: "ArrowUp", run: Bs(!1) },
    { key: "PageDown", run: Bs(!0, "page") },
    { key: "PageUp", run: Bs(!1, "page") },
    { key: "Enter", run: Gw },
  ],
  g1 = Ti.highest(
    Vr.computeN([Oe], (i) => (i.facet(Oe).defaultKeymap ? [Cm] : [])),
  );
class Bu {
  constructor(e, t, n) {
...
class $i {
  ...
  static init(e, t, n) {
    let r = n.facet(Er).markerFilter;
    r && (e = r(e, n));
    let s = e.slice().sort((h, u) => h.from - u.from || h.to - u.to),
      o = new Vt(),
      l = [],
      a = 0;
    for (let h = 0; ; ) {
      let u = h == s.length ? null : s[h];
      if (!u && !l.length) break;
      let f, d;
      for (
        l.length
          ? ((f = a),
            (d = l.reduce(
              (p, b) => Math.min(p, b.to),
              u && u.from > f ? u.from : 1e8,
            )))
          : ((f = u.from), (d = u.to), l.push(u), h++);
        h < s.length;
      ) {
        let p = s[h];
      ...
      if (
        l.some(
          (p) =>
            p.from == p.to ||
            (p.from == p.to - 1 && n.doc.lineAt(p.from).to == p.from),
        )
      )
        o.add(f, f, $.widget({ widget: new C1(g), diagnostics: l.slice() }));
      else {
        let p = l.reduce(
          (b, v) => (v.markClass ? b + " " + v.markClass : b),
          "",
        );
        o.add(
          f,
          d,
          $.mark({
            class: "cm-lintRange cm-lintRange-" + g + p,
            diagnostics: l.slice(),
    ...
    let c = o.finish();
    return new $i(c, t, Cn(c));
  }
}
function Cn(i, e = null, t = 0) {
  let n = null;
  return (
    i.between(t, 1e9, (r, s, { spec: o }) => {
      if (!(e && o.diagnostics.indexOf(e) < 0))
        if (!n) n = new Bu(r, s, e || o.diagnostics[0]);
        else {
          if (o.diagnostics.indexOf(n.diagnostic) < 0) return !1;
          n = new Bu(n.from, s, n.diagnostic);
        }
    }),
    n
  );
...
function m1(i, e) {
  let t = e.pos,
    n = e.end || t,
    r = i.state.facet(Er).hideOn(i, t, n);
  if (r != null) return r;
  let s = i.startState.doc.lineAt(e.pos);
  return !!(
    i.effects.some((o) => o.is(Gc)) ||
    i.changes.touchesRange(s.from, Math.max(s.to, n))
  );
}
function xm(i, e) {
  return i.field(ct, !1) ? e : e.concat(G.appendConfig.of(R1));
}
function p1(i, e) {
  return { effects: xm(i, [Gc.of(e)]) };
}
const Gc = G.define(),
  Jc = G.define(),
  Mm = G.define(),
    ...
    update(i, e) {
      if (e.docChanged && i.diagnostics.size) {
        ...
        if (i.selected) {
          ...
          n = Cn(t, i.selected.diagnostic, s) || Cn(t, null, s);
        }
        (!t.size && r && e.state.facet(Er).autoPanel && (r = null),
          (i = new $i(t, r, n)));
      }
      for (let t of e.effects)
        if (t.is(Gc)) {
          let n = e.state.facet(Er).autoPanel
            ? t.value.length
              ? Lr.open
              : null
            : i.panel;
          ...
          t.is(Jc)
            ? (i = new $i(i.diagnostics, t.value ? Lr.open : null, i.selected))
            : t.is(Mm) && (i = new $i(i.diagnostics, i.panel, t.value));
      return i;
    },
    provide: (i) => [
      Dr.from(i, (e) => e.panel),
  ...
  y1 = $.mark({ class: "cm-lintRange cm-lintRange-active" });
function b1(i, e, t) {
  let { diagnostics: n } = i.state.field(ct),
    r,
    s = -1,
    o = -1;
  ...
  let l = i.state.facet(Er).tooltipFilter;
  return (
    r && l && (r = l(r, i.state)),
    r
      ? {
...
const w1 = (i) => {
    let e = i.state.field(ct, !1);
    (!e || !e.panel) && i.dispatch({ effects: xm(i.state, [Jc.of(!0)]) });
    let t = Mr(i, Lr.open);
    return (t && t.dom.querySelector(".cm-panel-lint ul").focus(), !0);
  },
  Iu = (i) => {
    let e = i.state.field(ct, !1);
    return !e || !e.panel ? !1 : (i.dispatch({ effects: Jc.of(!1) }), !0);
  },
  S1 = (i) => {
    let e = i.state.field(ct, !1);
    if (!e) return !1;
  ...
  k1 = [
    { key: "Mod-Shift-m", run: w1, preventDefault: !0 },
    { key: "F8", run: S1 },
  ],
  Er = I.define({
    combine(i) {
      ...
      : n.map((s, o) => {
          let l = !1,
            a = (f) => {
              ...
              l = !0;
              let d = Cn(i.state.field(ct).diagnostics, e);
              d && s.apply(i, d.from, d.to);
            },
            { name: c } = s,
            h = r[o] ? c.indexOf(r[o]) : -1,
            u =
              h < 0
                ? c
                : [c.slice(0, h), re("u", c.slice(h, h + 1)), c.slice(h + 1)];
          return re(
            "button",
            {
              type: "button",
...
class Lr {
  constructor(e) {
    ...
    let t = (r) => {
        if (r.keyCode == 27) (Iu(this.view), this.view.focus());
          ...
          for (let l = 0; l < o.length; l++)
            if (o[l].toUpperCase().charCodeAt(0) == r.keyCode) {
              let a = Cn(this.view.state.field(ct).diagnostics, s);
  ...
  update() {
    let { diagnostics: e, selected: t } = this.view.state.field(ct),
      n = 0,
      r = !1,
      s = null,
      o = new Set();
    for (
      e.between(0, this.view.state.doc.length, (l, a, { spec: c }) => {
        for (let h of c.diagnostics) {
          ...
          (u < 0
            ? ((f = new qu(this.view, h)), this.items.splice(n, 0, f), (r = !0))
            : ((f = this.items[u]),
              u > n && (this.items.splice(n, u - n), (r = !0))),
        ...
        ? (this.list.setAttribute("aria-activedescendant", s.id),
          this.view.requestMeasure({
            ...
            write: ({ sel: l, panel: a }) => {
              ...
              l.top < a.top
                ? (this.list.scrollTop -= (a.top - l.top) / c)
                : l.bottom > a.bottom &&
                  (this.list.scrollTop += (l.bottom - a.bottom) / c);
            },
          }))
        : this.selectedIndex < 0 &&
  ...
  moveSelection(e) {
    ...
    let t = this.view.state.field(ct),
      n = Cn(t.diagnostics, this.items[e].diagnostic);
    n &&
      this.view.dispatch({
        selection: { anchor: n.from, head: n.to },
        scrollIntoView: !0,
...
function x1(i, e = 'viewBox="0 0 40 40"') {
...
const M1 = q.baseTheme({
  ...
  ".cm-lintRange-error": { backgroundImage: Is("#d11") },
  ".cm-lintRange-warning": { backgroundImage: Is("orange") },
  ".cm-lintRange-info": { backgroundImage: Is("#999") },
  ".cm-lintRange-hint": { backgroundImage: Is("#66d") },
...
const R1 = [
    ct,
    q.decorations.compute([ct], (i) => {
      let { selected: e, panel: t } = i.field(ct);
      return !e || !t || e.from == e.to
        ? $.none
        : $.set([y1.range(e.from, e.to)]);
    }),
    ig(b1, { hideOn: m1 }),
    M1,
  ],
...
function Rm() {
  ...
  ((ju = 1),
    ...
    (H.Message =
      ...
      H.RequestType =
      H.RequestType0 =
      H.AbstractMessageSignature =
      H.ParameterStructures =
      H.ResponseError =
      H.ErrorCodes =
        void 0));
  const i = Gr();
  ...
  (function (P) {
    ((P.ParseError = -32700),
      (P.InvalidRequest = -32600),
      (P.MethodNotFound = -32601),
      (P.InvalidParams = -32602),
      (P.InternalError = -32603),
      (P.jsonrpcReservedErrorRangeStart = -32099),
      (P.serverErrorStart = -32099),
      (P.MessageWriteError = -32099),
      (P.MessageReadError = -32098),
      (P.PendingResponseRejected = -32097),
      (P.ConnectionInactive = -32096),
      (P.ServerNotInitialized = -32002),
      (P.UnknownErrorCode = -32001),
      (P.jsonrpcReservedErrorRangeEnd = -32e3),
      (P.serverErrorEnd = -32e3));
  })(e || (H.ErrorCodes = e = {}));
  class t extends Error {
    constructor(w, O, B) {
      (super(O),
        (this.code = i.number(w) ? w : e.UnknownErrorCode),
        (this.data = B),
  ...
  class n {
    ...
    static is(w) {
      return w === n.auto || w === n.byName || w === n.byPosition;
    }
    toString() {
      return this.kind;
    }
  }
  ((H.ParameterStructures = n),
    (n.auto = new n("auto")),
    (n.byPosition = new n("byPosition")),
    (n.byName = new n("byName")));
  class r {
    constructor(w, O) {
      ((this.method = w), (this.numberOfParams = O));
    }
    get parameterStructures() {
      return n.auto;
    }
  }
  H.AbstractMessageSignature = r;
  class s extends r {
    constructor(w) {
      super(w, 0);
    }
  ...
  H.RequestType0 = s;
  class o extends r {
    constructor(w, O = n.auto) {
      (super(w, 1), (this._parameterStructures = O));
    }
    get parameterStructures() {
  ...
  H.NotificationType = b;
  class v extends r {
    constructor(w) {
      super(w, 0);
    }
  }
  H.NotificationType0 = v;
  class S extends r {
    constructor(w, O = n.auto) {
      (super(w, 1), (this._parameterStructures = O));
    }
  ...
  H.NotificationType1 = S;
  class C extends r {
    constructor(w) {
      super(w, 2);
    }
  }
  H.NotificationType2 = C;
  class R extends r {
    constructor(w) {
      super(w, 3);
    }
  }
  H.NotificationType3 = R;
  class D extends r {
    constructor(w) {
      super(w, 4);
    }
  }
  H.NotificationType4 = D;
  class T extends r {
    constructor(w) {
      super(w, 5);
    }
  }
  H.NotificationType5 = T;
  class A extends r {
    constructor(w) {
      super(w, 6);
    }
  }
  H.NotificationType6 = A;
  class V extends r {
    constructor(w) {
      super(w, 7);
    }
  }
  H.NotificationType7 = V;
  class U extends r {
    constructor(w) {
      super(w, 8);
    }
  }
  H.NotificationType8 = U;
  class J extends r {
    constructor(w) {
      super(w, 9);
    }
  }
  H.NotificationType9 = J;
  var W;
  return (
    (function (P) {
      function w(N) {
        const z = N;
        return z && i.string(z.method) && (i.string(z.id) || i.number(z.id));
      }
      P.isRequest = w;
      function O(N) {
        const z = N;
        return z && i.string(z.method) && N.id === void 0;
      }
      P.isNotification = O;
      function B(N) {
        const z = N;
        return (
          ...
          (i.string(z.id) || i.number(z.id) || z.id === null)
        );
      }
      P.isResponse = B;
    })(W || (H.Message = W = {})),
...
function Am() {
  ...
  (Object.defineProperty(Yt, "__esModule", { value: !0 }),
    (Yt.LRUCache = Yt.LinkedMap = Yt.Touch = void 0));
  var e;
  (function (r) {
    ((r.None = 0),
      (r.First = 1),
  ...
  class t {
    ...
    set(s, o, l = e.None) {
      ...
      if (a) ((a.value = o), l !== e.None && this.touch(a, l));
        ...
        switch (
          ((a = { key: s, value: o, next: void 0, previous: void 0 }), l)
        ) {
          case e.None:
            this.addItemLast(a);
            break;
    ...
    forEach(s, o) {
      ...
      for (; a; ) {
        if (
          (o ? s.bind(o)(a.value, a.key, this) : s(a.value, a.key, this),
          this._state !== l)
        )
      ...
      const l = {
        ...
        next: () => {
          if (this._state !== s)
            throw new Error("LinkedMap got modified during iteration.");
          if (o) {
            const a = { value: [o.key, o.value], done: !1 };
            return ((o = o.next), a);
          } else return { value: void 0, done: !0 };
        },
      };
      ...
      if (!(o !== e.First && o !== e.Last)) {
        if (o === e.First) {
          ...
          const l = s.next,
            a = s.previous;
          (s === this._tail
            ? ((a.next = void 0), (this._tail = a))
            : ((l.previous = a), (a.next = l)),
            (s.previous = void 0),
            (s.next = this._head),
          ...
          const l = s.next,
            a = s.previous;
          (s === this._head
            ? ((l.previous = void 0), (this._head = l))
            : ((l.previous = a), (a.next = l)),
            (s.next = void 0),
...
function nn() {
  if (Vu) return Fs;
  ((Vu = 1), Object.defineProperty(Fs, "__esModule", { value: !0 }));
  let i;
  function e() {
...
function Jr() {
  ...
  class t {
    add(s, o = null, l) {
      (this._callbacks || ((this._callbacks = []), (this._contexts = [])),
        ...
        this._contexts.push(o),
        Array.isArray(l) && l.push({ dispose: () => this.remove(s, o) }));
    }
    remove(s, o = null) {
      if (!this._callbacks) return;
      let l = !1;
      for (let a = 0, c = this._callbacks.length; a < c; a++)
        if (this._callbacks[a] === s)
    ...
    invoke(...s) {
      if (!this._callbacks) return [];
      const o = [],
        l = this._callbacks.slice(0),
        a = this._contexts.slice(0);
  ...
  class n {
    ...
    get event() {
      return (
        this._event ||
          (this._event = (s, o, l) => {
            (this._callbacks || (this._callbacks = new t()),
              this._options &&
                this._options.onFirstListenerAdd &&
                this._callbacks.isEmpty() &&
                this._options.onFirstListenerAdd(this),
              this._callbacks.add(s, o));
            const a = {
              dispose: () => {
                this._callbacks &&
                  (this._callbacks.remove(s, o),
                  (a.dispose = n._noop),
                  this._options &&
  ...
  return ((_i.Emitter = n), (n._noop = function () {}), _i);
}
var Bi = {},
  $u;
function Yc() {
  ...
  (($u = 1),
    ...
    (Bi.CancellationTokenSource = Bi.CancellationToken = void 0));
  const i = nn(),
    e = Gr(),
    t = Jr();
  var n;
  (function (l) {
    ...
    function a(c) {
      ...
      return (
        ...
        (h === l.None ||
          h === l.Cancelled ||
          (e.boolean(h.isCancellationRequested) && !!h.onCancellationRequested))
      );
    }
    l.is = a;
  })(n || (Bi.CancellationToken = n = {}));
  ...
  class s {
    ...
    get onCancellationRequested() {
      return this._isCancelled
        ? r
        : (this._emitter || (this._emitter = new t.Emitter()),
          this._emitter.event);
    }
    dispose() {
  ...
  return ((Bi.CancellationTokenSource = o), Bi);
}
var Ii = {},
  Uu;
function E1() {
  ...
  ((Uu = 1),
    ...
    (Ii.SharedArrayReceiverStrategy = Ii.SharedArraySenderStrategy = void 0));
  const i = Yc();
  var e;
  (function (o) {
  ...
  class t {
    ...
    enableCancellation(l) {
      ...
      const a = new SharedArrayBuffer(4),
        c = new Int32Array(a, 0, 1);
      ((c[0] = e.Continue),
        this.buffers.set(l.id, a),
        (l.$cancellationData = a));
    }
  ...
  Ii.SharedArraySenderStrategy = t;
  class n {
    constructor(l) {
  ...
  return ((Ii.SharedArrayReceiverStrategy = s), Ii);
}
var Xt = {},
  Yn = {},
  Ku;
  ...
  class e {
    ...
    lock(n) {
      return new Promise((r, s) => {
        (this._waiting.push({ thunk: n, resolve: r, reject: s }),
          this.runNext());
      });
    }
    get active() {
    ...
    runNext() {
      this._waiting.length === 0 ||
        ...
        (0, i.default)().timer.setImmediate(() => this.doRunNext());
    }
    doRunNext() {
...
function L1() {
  ...
  ((Gu = 1),
    ...
    (Xt.ReadableStreamMessageReader =
      Xt.AbstractMessageReader =
      Xt.MessageReader =
        void 0));
  const i = nn(),
    e = Gr(),
  ...
  (function (a) {
    function c(h) {
      ...
      return (
        ...
        e.func(u.onError) &&
        e.func(u.onClose) &&
        e.func(u.onPartialMessage)
      );
    }
    a.is = c;
  })(r || (Xt.MessageReader = r = {}));
  class s {
    constructor() {
      ((this.errorEmitter = new t.Emitter()),
        (this.closeEmitter = new t.Emitter()),
        (this.partialMessageEmitter = new t.Emitter()));
    }
    dispose() {
    ...
    asError(c) {
      return c instanceof Error
        ? c
        : new Error(
            `Reader received error. Reason: ${e.string(c.message) ? c.message : "unknown"}`,
          );
    }
  }
  Xt.AbstractMessageReader = s;
  var o;
  (function (a) {
    function c(h) {
      let u, f;
      ...
      if (h === void 0 || typeof h == "string") u = h ?? "utf-8";
        ...
        if (
          ((u = h.charset ?? "utf-8"),
          h.contentDecoder !== void 0 &&
            ((f = h.contentDecoder), d.set(f.name, f)),
          h.contentDecoders !== void 0)
        )
          for (const b of h.contentDecoders) d.set(b.name, b);
        if (
          (h.contentTypeDecoder !== void 0 &&
            ((g = h.contentTypeDecoder), p.set(g.name, g)),
          h.contentTypeDecoders !== void 0)
        )
          for (const b of h.contentTypeDecoders) p.set(b.name, b);
      }
      return (
        g === void 0 &&
          ((g = (0, i.default)().applicationJson.decoder), p.set(g.name, g)),
        {
          charset: u,
          contentDecoder: f,
          contentDecoders: d,
          contentTypeDecoder: g,
          contentTypeDecoders: p,
        }
      );
    }
    a.fromOptions = c;
  ...
  class l extends s {
    constructor(c, h) {
      (super(),
        (this.readable = c),
        (this.options = o.fromOptions(h)),
        (this.buffer = (0, i.default)().messageBuffer.create(
    ...
    listen(c) {
      ...
      return (
        this.readable.onError((u) => this.fireError(u)),
...
${JSON.stringify(Object.fromEntries(u))}`),
            ...
            if (isNaN(d)) {
              this.fireError(
                new Error(`Content-Length value must be a number. Got ${f}`),
              );
              return;
            }
              ...
              .lock(async () => {
                const u =
                    this.options.contentDecoder !== void 0
                      ? await this.options.contentDecoder.decode(h)
                      : h,
                  f = await this.options.contentTypeDecoder.decode(
                    u,
                    this.options,
                  );
                this.callback(f);
        ...
        !(this._partialMessageTimeout <= 0) &&
          (this.partialMessageTimer = (0, i.default)().timer.setTimeout(
            (c, h) => {
              ((this.partialMessageTimer = void 0),
                c === this.messageToken &&
                  (this.firePartialMessage({ messageToken: c, waitingTime: h }),
                  this.setPartialMessageTimer()));
            },
  ...
  return ((Xt.ReadableStreamMessageReader = l), Xt);
}
var Qt = {},
  Ju;
function N1() {
  ...
  ((Ju = 1),
    ...
    (Qt.WriteableStreamMessageWriter =
      Qt.AbstractMessageWriter =
      Qt.MessageWriter =
        void 0));
  const i = nn(),
    e = Gr(),
...
`;
  ...
  class l {
    ...
    fireError(u, f, d) {
      this.errorEmitter.fire([this.asError(u), f, d]);
    }
    get onClose() {
      return this.closeEmitter.event;
    }
    ...
    asError(u) {
      return u instanceof Error
        ? u
        : new Error(
            `Writer received error. Reason: ${e.string(u.message) ? u.message : "unknown"}`,
          );
    }
  }
  Qt.AbstractMessageWriter = l;
  var a;
  (function (h) {
    function u(f) {
      return f === void 0 || typeof f == "string"
        ...
        : {
            ...
            contentTypeEncoder:
              f.contentTypeEncoder ?? (0, i.default)().applicationJson.encoder,
          };
    }
    h.fromOptions = u;
  })(a || (a = {}));
  class c extends l {
    constructor(u, f) {
      (super(),
        (this.writable = u),
        (this.options = a.fromOptions(f)),
        (this.errorCount = 0),
        (this.writeSemaphore = new t.Semaphore(1)),
        this.writable.onError((d) => this.fireError(d)),
        this.writable.onClose(() => this.fireClose()));
    }
    async write(u) {
      return this.writeSemaphore.lock(async () =>
        this.options.contentTypeEncoder
          .encode(u, this.options)
          .then((d) =>
            this.options.contentEncoder !== void 0
              ? this.options.contentEncoder.encode(d)
              : d,
          )
          .then(
            (d) => {
              const g = [];
              return (
                g.push(r, d.byteLength.toString(), s),
                g.push(s),
                this.doWrite(u, g, d)
              );
            },
    ...
    async doWrite(u, f, d) {
      try {
        return (
          await this.writable.write(f.join(""), "ascii"),
          this.writable.write(d)
        );
      } catch (g) {
        return (this.handleError(g, u), Promise.reject(g));
      }
    }
    handleError(u, f) {
  ...
  return ((Qt.WriteableStreamMessageWriter = c), Qt);
}
var Xn = {},
  Yu;
function _1() {
  ...
  ((Yu = 1),
    ...
    (Xn.AbstractMessageBuffer = void 0));
  const i = 13,
    e = 10,
    t = `\r
`;
  class n {
    ...
    tryReadHeaders(s = !1) {
      ...
      if (o !== 4) return;
      const h = this._read(c + a),
        u = new Map(),
        f = this.toString(h, "ascii").split(t);
...
${g}`);
        const b = g.substr(0, p),
          v = g.substr(p + 1).trim();
        u.set(s ? b.toLowerCase() : b, v);
      }
      return u;
    }
    tryReadBody(s) {
  ...
  return ((Xn.AbstractMessageBuffer = n), Xn);
}
var ml = {},
  Xu;
function B1() {
      ...
      (function (i) {
        (Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.createMessageConnection =
            ...
            i.CancellationSenderStrategy =
            i.CancellationReceiverStrategy =
            i.RequestCancellationReceiverStrategy =
            i.IdCancellationReceiverStrategy =
            i.ConnectionStrategy =
            i.ConnectionError =
            i.ConnectionErrors =
            i.LogTraceNotification =
            i.SetTraceNotification =
            i.TraceFormat =
            i.TraceValues =
            i.Trace =
            i.NullLogger =
        ...
        var l;
        (function (w) {
          w.type = new n.NotificationType("$/cancelRequest");
        })(l || (l = {}));
        var a;
        (function (w) {
          function O(B) {
        ...
        var c;
        (function (w) {
          w.type = new n.NotificationType("$/progress");
        })(c || (c = {}));
        class h {
          constructor() {}
        }
        ...
        (function (w) {
          ((w[(w.Off = 0)] = "Off"),
            (w[(w.Messages = 1)] = "Messages"),
            (w[(w.Compact = 2)] = "Compact"),
            (w[(w.Verbose = 3)] = "Verbose"));
        })(f || (i.Trace = f = {}));
        var d;
        ((function (w) {
          ((w.Off = "off"),
        ...
        var g;
        ((function (w) {
          ((w.Text = "text"), (w.JSON = "json"));
        })(g || (i.TraceFormat = g = {})),
          (function (w) {
            function O(B) {
              return t.string(B)
                ? ((B = B.toLowerCase()), B === "json" ? w.JSON : w.Text)
                : w.Text;
            }
            w.fromString = O;
          })(g || (i.TraceFormat = g = {})));
        var p;
        (function (w) {
          w.type = new n.NotificationType("$/setTrace");
        })(p || (i.SetTraceNotification = p = {}));
        var b;
        (function (w) {
          w.type = new n.NotificationType("$/logTrace");
        })(b || (i.LogTraceNotification = b = {}));
        var v;
        (function (w) {
          ((w[(w.Closed = 1)] = "Closed"),
            (w[(w.Disposed = 2)] = "Disposed"),
            (w[(w.AlreadyListening = 3)] = "AlreadyListening"));
        })(v || (i.ConnectionErrors = v = {}));
        ...
        (function (w) {
          function O(B) {
            const N = B;
            return N && t.func(N.cancelUndispatched);
          }
          w.is = O;
        })(C || (i.ConnectionStrategy = C = {}));
        var R;
        (function (w) {
          function O(B) {
            const N = B;
            return (
              N &&
              (N.kind === void 0 || N.kind === "id") &&
              t.func(N.createCancellationTokenSource) &&
              (N.dispose === void 0 || t.func(N.dispose))
            );
          }
          w.is = O;
        })(R || (i.IdCancellationReceiverStrategy = R = {}));
        var D;
        (function (w) {
          function O(B) {
            const N = B;
          ...
          w.is = O;
        })(D || (i.RequestCancellationReceiverStrategy = D = {}));
        var T;
        (function (w) {
          w.Message = Object.freeze({
            createCancellationTokenSource(B) {
              return new o.CancellationTokenSource();
            },
          });
          function O(B) {
            return R.is(B) || D.is(B);
          }
          w.is = O;
        })(T || (i.CancellationReceiverStrategy = T = {}));
        var A;
        (function (w) {
          w.Message = Object.freeze({
            sendCancellation(B, N) {
              return B.sendNotification(l.type, { id: N });
            },
            cleanup(B) {},
          });
          function O(B) {
            const N = B;
            return N && t.func(N.sendCancellation) && t.func(N.cleanup);
          }
          w.is = O;
        })(A || (i.CancellationSenderStrategy = A = {}));
        var V;
        (function (w) {
          w.Message = Object.freeze({ receiver: T.Message, sender: A.Message });
          function O(B) {
            const N = B;
            return N && T.is(N.receiver) && A.is(N.sender);
          }
          w.is = O;
        })(V || (i.CancellationStrategy = V = {}));
        var U;
        (function (w) {
          function O(B) {
            const N = B;
            return N && t.func(N.handleMessage);
          }
          w.is = O;
        })(U || (i.MessageStrategy = U = {}));
        var J;
        (function (w) {
          function O(B) {
            const N = B;
            return (
              N &&
              (V.is(N.cancellationStrategy) ||
                C.is(N.connectionStrategy) ||
                U.is(N.messageStrategy))
            );
          }
          w.is = O;
        })(J || (i.ConnectionOptions = J = {}));
        var W;
        (function (w) {
          ((w[(w.New = 1)] = "New"),
        ...
        function P(w, O, B, N) {
          const z = B !== void 0 ? B : i.NullLogger;
          let Ke = 0,
            me = 0,
            Le = 0;
          const Ae = "2.0";
          ...
          let Kt,
            ...
            pe,
            St = W.New;
          const rn = new s.Emitter(),
            En = new s.Emitter(),
            Ln = new s.Emitter(),
            Nn = new s.Emitter(),
            _n = new s.Emitter(),
            kt =
              N && N.cancellationStrategy ? N.cancellationStrategy : V.Message;
          function Bn(y) {
            if (y === null)
              throw new Error(
          ...
          function Yr(y) {
            return y === null
              ? "res-unknown-" + (++Le).toString()
              : "res-" + y.toString();
          }
          function Xr() {
            return "not-" + (++me).toString();
          }
          function Qr(y, x) {
            n.Message.isRequest(x)
              ? y.set(Bn(x.id), x)
              : n.Message.isResponse(x)
                ? y.set(Yr(x.id), x)
                : y.set(Xr(), x);
          }
          function Zr(y) {}
          function In() {
            return St === W.Listening;
          }
          function qn() {
            return St === W.Closed;
          }
          function Gt() {
            return St === W.Disposed;
          }
          function Fn() {
            (St === W.New || St === W.Listening) &&
              ((St = W.Closed), En.fire(void 0));
          }
          function es(y) {
            rn.fire([y, void 0, void 0]);
          }
          function ts(y) {
            rn.fire(y);
          }
          (w.onClose(Fn), w.onError(es), O.onClose(Fn), O.onError(ts));
          function jn() {
            Kt ||
              Tt.size === 0 ||
              (Kt = (0, e.default)().timer.setImmediate(() => {
                ((Kt = void 0), is());
              }));
          }
          function Hn(y) {
          ...
          function is() {
            ...
            const y = Tt.shift();
            try {
              const x = N == null ? void 0 : N.messageStrategy;
              U.is(x) ? x.handleMessage(y, Hn) : Hn(y);
            } finally {
              jn();
            }
          }
          const ns = (y) => {
            try {
              if (n.Message.isNotification(y) && y.method === l.type.method) {
                const x = y.params.id,
                  E = Bn(x),
                  j = Tt.get(E);
                if (n.Message.isRequest(j)) {
                  const ne = N == null ? void 0 : N.connectionStrategy,
                    le =
                      ne && ne.cancelUndispatched
                        ? ne.cancelUndispatched(j, Zr)
                        : void 0;
                  if (le && (le.error !== void 0 || le.result !== void 0)) {
                    (Tt.delete(E),
                      ut.delete(x),
                      (le.id = j.id),
                      Oi(le, y.method, Date.now()),
                      O.write(le).catch(() =>
                        z.error(
          ...
          function rs(y) {
            if (Gt()) return;
            function x(X, fe, te) {
              const De = { jsonrpc: Ae, id: y.id };
              (X instanceof n.ResponseError
                ? (De.error = X.toJson())
                : (De.result = X === void 0 ? null : X),
                Oi(De, fe, te),
                O.write(De).catch(() => z.error("Sending response failed.")));
            }
            function E(X, fe, te) {
              const De = { jsonrpc: Ae, id: y.id, error: X.toJson() };
              (Oi(De, fe, te),
                O.write(De).catch(() => z.error("Sending response failed.")));
            }
            function j(X, fe, te) {
              X === void 0 && (X = null);
              const De = { jsonrpc: Ae, id: y.id, result: X };
              (Oi(De, fe, te),
                O.write(De).catch(() => z.error("Sending response failed.")));
            }
            hs(y);
            const ae = Pe.get(y.method);
            let ne, le;
            ae && ((ne = ae.type), (le = ae.handler));
            const Se = Date.now();
            if (le || be) {
              const X = y.id ?? String(Date.now()),
                fe = R.is(kt.receiver)
                  ? kt.receiver.createCancellationTokenSource(X)
                  : kt.receiver.createCancellationTokenSource(y);
              (y.id !== null && Pi.has(y.id) && fe.cancel(),
                y.id !== null && ut.set(X, fe));
              try {
                let te;
                if (le)
                  if (y.params === void 0) {
                    if (ne !== void 0 && ne.numberOfParams !== 0) {
                      E(
                        new n.ResponseError(
                          ...
                          `Request ${y.method} defines ${ne.numberOfParams} params but received none.`,
                        ),
                        y.method,
                        Se,
                      );
                    ...
                    if (
                      ne !== void 0 &&
                      ne.parameterStructures === n.ParameterStructures.byName
                    ) {
                      E(
                        new n.ResponseError(
                          n.ErrorCodes.InvalidParams,
                    ...
                    te = le(...y.params, fe.token);
                  } else {
                    if (
                      ne !== void 0 &&
                      ne.parameterStructures ===
                        n.ParameterStructures.byPosition
                    ) {
                      E(
                        new n.ResponseError(
                          n.ErrorCodes.InvalidParams,
                ...
                else be && (te = be(y.method, y.params, fe.token));
                const De = te;
                te
                  ? De.then
                    ? De.then(
                        (Ge) => {
                          (ut.delete(X), x(Ge, y.method, Se));
                        },
                        (Ge) => {
                          (ut.delete(X),
                            Ge instanceof n.ResponseError
                              ? E(Ge, y.method, Se)
                              : Ge && t.string(Ge.message)
                                ? E(
                                    new n.ResponseError(
                    ...
                    : (ut.delete(X), x(te, y.method, Se))
                  : (ut.delete(X), j(te, y.method, Se));
              } catch (te) {
                (ut.delete(X),
                  te instanceof n.ResponseError
                    ? x(te, y.method, Se)
                    : te && t.string(te.message)
                      ? E(
                          new n.ResponseError(
                            n.ErrorCodes.InternalError,
                            `Request ${y.method} failed with message: ${te.message}`,
                          ),
                          y.method,
                          Se,
                        )
              ...
              E(
                new n.ResponseError(
                  n.ErrorCodes.MethodNotFound,
                  `Unhandled method ${y.method}`,
                ),
                y.method,
                Se,
              );
...
${JSON.stringify(y.error, void 0, 4)}`)
                ...
                if ((us(y, E), E !== void 0)) {
                  ...
                  try {
                    if (y.error) {
                      const j = y.error;
                      E.reject(new n.ResponseError(j.code, j.message, j.data));
                    } else if (y.result !== void 0) E.resolve(y.result);
                    else throw new Error("Should never happen.");
                  } catch (j) {
                    j.message
                      ? z.error(
                          `Response handler '${E.method}' failed with message: ${j.message}`,
                        )
                      : z.error(
                          `Response handler '${E.method}' failed unexpectedly.`,
                        );
                  }
                }
              }
          ...
          function os(y) {
            if (Gt()) return;
            let x, E;
            if (y.method === l.type.method) {
              const j = y.params.id;
              (Pi.delete(j), sn(y));
              return;
            } else {
              const j = et.get(y.method);
              j && ((E = j.handler), (x = j.type));
            }
            if (E || He)
              try {
                if ((sn(y), E))
                  if (y.params === void 0)
                    (x !== void 0 &&
                      x.numberOfParams !== 0 &&
                      x.parameterStructures !== n.ParameterStructures.byName &&
                      z.error(
                        `Notification ${y.method} defines ${x.numberOfParams} params but received none.`,
                      ),
                      E());
                  else if (Array.isArray(y.params)) {
                    const j = y.params;
                    y.method === c.type.method && j.length === 2 && a.is(j[0])
                      ? E({ token: j[0], value: j[1] })
                      : (x !== void 0 &&
                          (x.parameterStructures ===
                            n.ParameterStructures.byName &&
                            z.error(
                              `Notification ${y.method} defines parameters by name but received parameters by position`,
                            ),
                          x.numberOfParams !== y.params.length &&
                            z.error(
                              `Notification ${y.method} defines ${x.numberOfParams} params but received ${j.length} arguments`,
                            )),
                        E(...j));
                  } else
                    (x !== void 0 &&
                      ...
                      E(y.params));
                else He && He(y.method, y.params);
              } catch (j) {
                j.message
                  ? z.error(
                      `Notification handler '${y.method}' failed with message: ${j.message}`,
                    )
                  : z.error(
                      `Notification handler '${y.method}' failed unexpectedly.`,
                    );
              }
            else Ln.fire(y);
          }
...
${JSON.stringify(y, null, 4)}`);
            const x = y;
            if (t.string(x.id) || t.number(x.id)) {
              const E = x.id,
                j = Rt.get(E);
              j &&
                j.reject(
          ...
          function as(y) {
            if (!(ie === f.Off || !pe))
              if (At === g.Text) {
                let x;
                ((ie === f.Verbose || ie === f.Compact) &&
                  y.params &&
                  (x = `Params: ${Ct(y.params)}

`),
                  pe.log(`Sending request '${y.method} - (${y.id})'.`, x));
              } else Jt("send-request", y);
          }
          function cs(y) {
            if (!(ie === f.Off || !pe))
              if (At === g.Text) {
...
`)),
                  pe.log(`Sending notification '${y.method}'.`, x));
              } else Jt("send-notification", y);
          }
          function Oi(y, x, E) {
            if (!(ie === f.Off || !pe))
              if (At === g.Text) {
                ...
                ((ie === f.Verbose || ie === f.Compact) &&
                  (y.error && y.error.data
                    ? (j = `Error data: ${Ct(y.error.data)}

`)
                    : y.result
                      ? (j = `Result: ${Ct(y.result)}

`)
                      : y.error === void 0 &&
                        (j = `No result returned.

`)),
                  pe.log(
                    `Sending response '${x} - (${y.id})'. Processing request took ${Date.now() - E}ms`,
                    j,
                  ));
              } else Jt("send-response", y);
          }
          function hs(y) {
            if (!(ie === f.Off || !pe))
              if (At === g.Text) {
...
`),
                  pe.log(`Received request '${y.method} - (${y.id})'.`, x));
              } else Jt("receive-request", y);
          }
          function sn(y) {
            if (!(ie === f.Off || !pe || y.method === b.type.method))
              if (At === g.Text) {
                let x;
                ((ie === f.Verbose || ie === f.Compact) &&
                  (y.params
...
`)),
                  pe.log(`Received notification '${y.method}'.`, x));
              } else Jt("receive-notification", y);
          }
          function us(y, x) {
            if (!(ie === f.Off || !pe))
              if (At === g.Text) {
                ...
                if (
                  ((ie === f.Verbose || ie === f.Compact) &&
                    (y.error && y.error.data
                      ? (E = `Error data: ${Ct(y.error.data)}

`)
                      : y.result
                        ? (E = `Result: ${Ct(y.result)}
...
`)),
                  ...
                  const j = y.error
                    ? ` Request failed: ${y.error.message} (${y.error.code}).`
                    : "";
                  pe.log(
                    `Received response '${x.method} - (${y.id})' in ${Date.now() - x.timerStart}ms.${j}`,
                    E,
                  );
                } else
                  pe.log(
                    `Received response ${y.id} without active response promise.`,
                    E,
                  );
              } else Jt("receive-response", y);
          }
          function Jt(y, x) {
            if (!pe || ie === f.Off) return;
            const E = {
              isLSPMessage: !0,
              type: y,
              message: x,
          ...
          function fi() {
            if (qn()) throw new S(v.Closed, "Connection is closed.");
            if (Gt()) throw new S(v.Disposed, "Connection is disposed.");
          }
          function fs() {
            if (In())
              throw new S(
          ...
          function ds() {
            if (!In()) throw new Error("Call listen() first.");
          }
          function di(y) {
          ...
          function we(y, x) {
            let E;
            const j = y.numberOfParams;
            switch (j) {
              case 0:
                E = void 0;
                break;
              case 1:
                E = ve(y.parameterStructures, x[0]);
                break;
              default:
                E = [];
                for (let ae = 0; ae < x.length && ae < j; ae++)
                  E.push(di(x[ae]));
                if (x.length < j)
                  for (let ae = x.length; ae < j; ae++) E.push(null);
                break;
            }
            return E;
          }
          const K = {
            sendNotification: (y, ...x) => {
              fi();
              let E, j;
              if (t.string(y)) {
                E = y;
                const ne = x[0];
                let le = 0,
                  Se = n.ParameterStructures.auto;
                n.ParameterStructures.is(ne) && ((le = 1), (Se = ne));
                let X = x.length;
                const fe = X - le;
                switch (fe) {
                  case 0:
                  ...
                  case 1:
                    ...
                    break;
                  default:
                    if (Se === n.ParameterStructures.byName)
                      throw new Error(
                        `Received ${fe} parameters for 'by Name' notification parameter structure.`,
                      );
                    j = x.slice(le, X).map((te) => di(te));
                    break;
                }
              } else {
                const ne = x;
                ((E = y.method), (j = we(y, ne)));
              }
              const ae = { jsonrpc: Ae, method: E, params: j };
              return (
                cs(ae),
                O.write(ae).catch((ne) => {
                  throw (z.error("Sending notification failed."), ne);
                })
              );
            },
            onNotification: (y, x) => {
              ...
              return (
                t.func(y)
                  ...
                  : x &&
                    (t.string(y)
                      ? ((E = y), et.set(y, { type: void 0, handler: x }))
                      : ((E = y.method),
                        et.set(y.method, { type: y, handler: x }))),
                {
                  dispose: () => {
                    E !== void 0 ? et.delete(E) : (He = void 0);
                  },
                }
              );
            },
            onProgress: (y, x, E) => {
              if (ht.has(x))
                throw new Error(
                  `Progress handler for token ${x} already registered`,
                );
              return (
                ht.set(x, E),
                {
            ...
            sendProgress: (y, x, E) =>
              K.sendNotification(c.type, { token: x, value: E }),
            onUnhandledProgress: Nn.event,
            sendRequest: (y, ...x) => {
              (fi(), ds());
              let E, j, ae;
              if (t.string(y)) {
                ...
                const X = x[0],
                  fe = x[x.length - 1];
                let te = 0,
                  De = n.ParameterStructures.auto;
                n.ParameterStructures.is(X) && ((te = 1), (De = X));
                let Ge = x.length;
                o.CancellationToken.is(fe) && ((Ge = Ge - 1), (ae = fe));
                const Pt = Ge - te;
                switch (Pt) {
                  case 0:
                    j = void 0;
                  ...
                  default:
                    if (De === n.ParameterStructures.byName)
                      throw new Error(
                        `Received ${Pt} parameters for 'by Name' request parameter structure.`,
                      );
                    j = x.slice(te, Ge).map((Im) => di(Im));
                    break;
                }
              } else {
                const X = x;
                ((E = y.method), (j = we(y, X)));
                const fe = y.numberOfParams;
                ae = o.CancellationToken.is(X[fe]) ? X[fe] : void 0;
              }
              const ne = Ke++;
              let le;
              ae &&
                (le = ae.onCancellationRequested(() => {
                  const X = kt.sender.sendCancellation(K, ne);
                  return X === void 0
                    ? (z.log(
                        `Received no promise from cancellation strategy when cancelling id ${ne}`,
                      ),
                      Promise.resolve())
                    : X.catch(() => {
                        z.log(
                          `Sending cancellation messages for id ${ne} failed`,
                        );
                      });
                }));
              const Se = { jsonrpc: Ae, id: ne, method: E, params: j };
              return (
                as(Se),
                typeof kt.sender.enableCancellation == "function" &&
                  kt.sender.enableCancellation(Se),
                new Promise(async (X, fe) => {
                  const te = (Pt) => {
                      (X(Pt),
                        kt.sender.cleanup(ne),
                        le == null || le.dispose());
                    },
                    De = (Pt) => {
                      (fe(Pt),
                  ...
                  try {
                    (await O.write(Se), Rt.set(ne, Ge));
                  } catch (Pt) {
                    throw (
                      z.error("Sending request failed."),
                      Ge.reject(
                        new n.ResponseError(
                          n.ErrorCodes.MessageWriteError,
                          Pt.message ? Pt.message : "Unknown reason",
                        ),
                      ),
                      Pt
                    );
              ...
              return (
                u.is(y)
                  ...
                  : t.string(y)
                    ? ((E = null),
                      x !== void 0 &&
                        ((E = y), Pe.set(y, { handler: x, type: void 0 })))
                    : x !== void 0 &&
                      ((E = y.method),
                      Pe.set(y.method, { type: y, handler: x })),
                {
                  dispose: () => {
                    E !== null && (E !== void 0 ? Pe.delete(E) : (be = void 0));
                  },
                }
              );
            },
            hasPendingResponse: () => Rt.size > 0,
            trace: async (y, x, E) => {
              let j = !1,
                ae = g.Text;
              (E !== void 0 &&
                (t.boolean(E)
                  ? (j = E)
                  : ((j = E.sendNotification || !1),
                    (ae = E.traceFormat || g.Text))),
                (ie = y),
                (At = ae),
                ie === f.Off ? (pe = void 0) : (pe = x),
                j &&
                  !qn() &&
                  !Gt() &&
                  (await K.sendNotification(p.type, { value: f.toString(y) })));
            },
            onError: rn.event,
            onClose: En.event,
            onUnhandledNotification: Ln.event,
            onDispose: _n.event,
            end: () => {
              O.end();
            },
            dispose: () => {
              if (Gt()) return;
              ((St = W.Disposed), _n.fire(void 0));
              const y = new n.ResponseError(
                n.ErrorCodes.PendingResponseRejected,
                "Pending response rejected since connection got disposed",
              );
              for (const x of Rt.values()) x.reject(y);
              ((Rt = new Map()),
                (ut = new Map()),
                (Pi = new Set()),
                (Tt = new r.LinkedMap()),
                t.func(O.dispose) && O.dispose(),
                t.func(w.dispose) && w.dispose());
            },
            listen: () => {
              (fi(), fs(), (St = W.Listening), w.listen(ns));
            },
            inspect: () => {
          ...
          return (
            K.onNotification(b.type, (y) => {
              if (ie === f.Off || !pe) return;
              const x = ie === f.Verbose || ie === f.Compact;
              pe.log(y.message, x ? y.verbose : void 0);
            }),
            K.onNotification(c.type, (y) => {
              const x = ht.get(y.token);
              x ? x(y.value) : Nn.fire(y);
            }),
            K
          );
        }
        i.createMessageConnection = P;
      })(ml)),
    ml
  );
}
      ...
      (function (i) {
        (Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.ProgressType =
            ...
            i.ConnectionOptions =
            i.ConnectionStrategy =
            i.AbstractMessageBuffer =
            i.WriteableStreamMessageWriter =
            i.AbstractMessageWriter =
            i.MessageWriter =
            i.ReadableStreamMessageReader =
            i.AbstractMessageReader =
            i.MessageReader =
            i.SharedArrayReceiverStrategy =
            i.SharedArraySenderStrategy =
            i.CancellationToken =
...
function I1() {
  if (Zu) return qs;
  ((Zu = 1), Object.defineProperty(qs, "__esModule", { value: !0 }));
  const i = da();
  class e extends i.AbstractMessageBuffer {
    constructor(a = "utf-8") {
      (super(a), (this.asciiDecoder = new TextDecoder("ascii")));
    }
    emptyBuffer() {
    ...
    toString(a, c) {
      return c === "ascii"
        ? this.asciiDecoder.decode(a)
        : new TextDecoder(c).decode(a);
    }
    asNative(a, c) {
      return c === void 0 ? a : a.slice(0, c);
    }
    allocNative(a) {
  ...
  class t {
    ...
    onClose(a) {
      return (
        ...
        i.Disposable.create(() => this.socket.removeEventListener("close", a))
      );
    }
    onError(a) {
      return (
        this.socket.addEventListener("error", a),
        i.Disposable.create(() => this.socket.removeEventListener("error", a))
      );
    }
    onEnd(a) {
      return (
        this.socket.addEventListener("end", a),
        i.Disposable.create(() => this.socket.removeEventListener("end", a))
      );
    }
    onData(a) {
  ...
  class n {
    ...
    write(a, c) {
      if (typeof a == "string") {
        if (c !== void 0 && c !== "utf-8")
          throw new Error(
            `In a Browser environments only utf-8 text encoding is supported. But got encoding: ${c}`,
          );
        this.socket.send(a);
      } else this.socket.send(a);
  ...
  const r = new TextEncoder(),
    s = Object.freeze({
      messageBuffer: Object.freeze({ create: (l) => new e(l) }),
      applicationJson: Object.freeze({
        encoder: Object.freeze({
          ...
          encode: (l, a) => {
            if (a.charset !== "utf-8")
              throw new Error(
                `In a Browser environments only utf-8 text encoding is supported. But got encoding: ${a.charset}`,
              );
            return Promise.resolve(r.encode(JSON.stringify(l, void 0, 0)));
          },
        }),
        decoder: Object.freeze({
          ...
          decode: (l, a) => {
            ...
            return Promise.resolve(
              JSON.parse(new TextDecoder(a.charset).decode(l)),
            );
          },
        }),
      }),
      stream: Object.freeze({
        asReadableStream: (l) => new t(l),
        asWritableStream: (l) => new n(l),
      }),
      console,
      timer: Object.freeze({
        setTimeout(l, a, ...c) {
          const h = setTimeout(l, a, ...c);
          return { dispose: () => clearTimeout(h) };
        },
        setImmediate(l, ...a) {
          const c = setTimeout(l, 0, ...a);
          return { dispose: () => clearTimeout(c) };
        },
        setInterval(l, a, ...c) {
          const h = setInterval(l, a, ...c);
  ...
  return (
    ef ||
      ...
      (function (i) {
        ...
        class s extends r.AbstractMessageReader {
          constructor(c) {
            (super(),
              ...
              c.addEventListener("error", (h) => this.fireError(h)),
        ...
        function l(a, c, h, u) {
          return (
            h === void 0 && (h = r.NullLogger),
            r.ConnectionStrategy.is(u) && (u = { connectionStrategy: u }),
...
(function (i) {
  function e(n, r) {
    return (
      n === Number.MAX_VALUE && (n = Nr.MAX_VALUE),
      r === Number.MAX_VALUE && (r = Nr.MAX_VALUE),
      { line: n, character: r }
    );
  }
  i.create = e;
  function t(n) {
    let r = n;
    return k.objectLiteral(r) && k.uinteger(r.line) && k.uinteger(r.character);
  }
  i.is = t;
})(dt || (dt = {}));
var ye;
(function (i) {
  function e(n, r, s, o) {
    if (k.uinteger(n) && k.uinteger(r) && k.uinteger(s) && k.uinteger(o))
      return { start: dt.create(n, r), end: dt.create(s, o) };
    if (dt.is(n) && dt.is(r)) return { start: n, end: r };
    throw new Error(
      `Range#create called with invalid arguments[${n}, ${r}, ${s}, ${o}]`,
    );
  }
  i.create = e;
  function t(n) {
    let r = n;
    return k.objectLiteral(r) && dt.is(r.start) && dt.is(r.end);
  }
  i.is = t;
})(ye || (ye = {}));
var _r;
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.objectLiteral(r) &&
      ye.is(r.range) &&
      (k.string(r.uri) || k.undefined(r.uri))
    );
  }
  i.is = t;
})(_r || (_r = {}));
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.objectLiteral(r) &&
      ye.is(r.targetRange) &&
      k.string(r.targetUri) &&
      ye.is(r.targetSelectionRange) &&
      (ye.is(r.originSelectionRange) || k.undefined(r.originSelectionRange))
    );
  }
  i.is = t;
})(pa || (pa = {}));
...
(function (i) {
  function e(n, r, s, o) {
    return { red: n, green: r, blue: s, alpha: o };
  }
  i.create = e;
  function t(n) {
    const r = n;
    return (
      k.objectLiteral(r) &&
      k.numberRange(r.red, 0, 1) &&
      k.numberRange(r.green, 0, 1) &&
      k.numberRange(r.blue, 0, 1) &&
      k.numberRange(r.alpha, 0, 1)
    );
  }
  i.is = t;
})(Co || (Co = {}));
...
(function (i) {
  function e(n, r) {
    return { range: n, color: r };
  }
  i.create = e;
  function t(n) {
    const r = n;
    return k.objectLiteral(r) && ye.is(r.range) && Co.is(r.color);
  }
  i.is = t;
})(ya || (ya = {}));
var ba;
(function (i) {
  function e(n, r, s) {
    return { label: n, textEdit: r, additionalTextEdits: s };
  }
  i.create = e;
  function t(n) {
    const r = n;
    return (
      k.objectLiteral(r) &&
      k.string(r.label) &&
      (k.undefined(r.textEdit) || Wt.is(r)) &&
      (k.undefined(r.additionalTextEdits) ||
        k.typedArray(r.additionalTextEdits, Wt.is))
    );
  }
  i.is = t;
})(ba || (ba = {}));
...
(function (i) {
  function e(n, r, s, o, l, a) {
    const c = { startLine: n, endLine: r };
    return (
      k.defined(s) && (c.startCharacter = s),
      k.defined(o) && (c.endCharacter = o),
      k.defined(l) && (c.kind = l),
      k.defined(a) && (c.collapsedText = a),
      c
    );
  }
  i.create = e;
  function t(n) {
    ...
    return (
      k.objectLiteral(r) &&
      k.uinteger(r.startLine) &&
      k.uinteger(r.startLine) &&
      (k.undefined(r.startCharacter) || k.uinteger(r.startCharacter)) &&
      (k.undefined(r.endCharacter) || k.uinteger(r.endCharacter)) &&
      (k.undefined(r.kind) || k.string(r.kind))
    );
  }
  i.is = t;
})(wa || (wa = {}));
...
(function (i) {
  function e(n, r) {
    return { location: n, message: r };
  }
  i.create = e;
  function t(n) {
    let r = n;
    return k.defined(r) && _r.is(r.location) && k.string(r.message);
  }
  i.is = t;
})(xo || (xo = {}));
var Sa;
...
(function (i) {
  function e(t) {
    const n = t;
    return k.objectLiteral(n) && k.string(n.href);
  }
  i.is = e;
})(Ca || (Ca = {}));
var Br;
(function (i) {
  function e(n, r, s, o, l, a) {
    let c = { range: n, message: r };
    return (
      k.defined(s) && (c.severity = s),
      k.defined(o) && (c.code = o),
      k.defined(l) && (c.source = l),
      k.defined(a) && (c.relatedInformation = a),
      c
    );
  }
  i.create = e;
  function t(n) {
    ...
    return (
      ...
      (k.undefined(s.relatedInformation) ||
        k.typedArray(s.relatedInformation, xo.is))
    );
  }
  i.is = t;
})(Br || (Br = {}));
...
(function (i) {
  function e(n, r, ...s) {
    let o = { title: n, command: r };
    return (k.defined(s) && s.length > 0 && (o.arguments = s), o);
  }
  i.create = e;
  function t(n) {
    let r = n;
    return k.defined(r) && k.string(r.title) && k.string(r.command);
  }
  i.is = t;
})(tn || (tn = {}));
var Wt;
(function (i) {
  ...
  function r(s) {
    const o = s;
    return k.objectLiteral(o) && k.string(o.newText) && ye.is(o.range);
  }
  i.is = r;
})(Wt || (Wt = {}));
var Ji;
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.objectLiteral(r) &&
      k.string(r.label) &&
      (k.boolean(r.needsConfirmation) || r.needsConfirmation === void 0) &&
...
(function (i) {
  ...
  function r(s) {
    const o = s;
    return Wt.is(o) && (Ji.is(o.annotationId) || Fe.is(o.annotationId));
  }
  i.is = r;
})(ri || (ri = {}));
var Ir;
(function (i) {
  function e(n, r) {
    return { textDocument: n, edits: r };
  }
  i.create = e;
  function t(n) {
    let r = n;
    return k.defined(r) && qr.is(r.textDocument) && Array.isArray(r.edits);
  }
  i.is = t;
})(Ir || (Ir = {}));
var xn;
(function (i) {
  ...
  function t(n) {
    ...
    return (
      ...
      k.string(r.uri) &&
      (r.options === void 0 ||
        ((r.options.overwrite === void 0 || k.boolean(r.options.overwrite)) &&
          (r.options.ignoreIfExists === void 0 ||
            k.boolean(r.options.ignoreIfExists)))) &&
      (r.annotationId === void 0 || Fe.is(r.annotationId))
    );
  }
  i.is = t;
})(xn || (xn = {}));
...
(function (i) {
  function e(n, r, s, o) {
    let l = { kind: "rename", oldUri: n, newUri: r };
    return (
      s !== void 0 &&
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      ...
      k.string(r.uri) &&
      (r.options === void 0 ||
        ((r.options.recursive === void 0 || k.boolean(r.options.recursive)) &&
          (r.options.ignoreIfNotExists === void 0 ||
            k.boolean(r.options.ignoreIfNotExists)))) &&
      (r.annotationId === void 0 || Fe.is(r.annotationId))
    );
  }
  i.is = t;
  ...
  function e(t) {
    ...
    return (
      ...
      (n.documentChanges === void 0 ||
        n.documentChanges.every((r) =>
          k.string(r.kind) ? xn.is(r) || Mn.is(r) || Dn.is(r) : Ir.is(r),
        ))
    );
  }
  i.is = e;
...
class q1 {
    ...
    ((this._textEditChanges = Object.create(null)),
      e !== void 0
        ? ((this._workspaceEdit = e),
          e.documentChanges
            ? ((this._changeAnnotations = new rf(e.changeAnnotations)),
              (e.changeAnnotations = this._changeAnnotations.all()),
              e.documentChanges.forEach((t) => {
                if (Ir.is(t)) {
                  const n = new js(t.edits, this._changeAnnotations);
                  this._textEditChanges[t.textDocument.uri] = n;
                }
              }))
            : e.changes &&
              Object.keys(e.changes).forEach((t) => {
                const n = new js(e.changes[t]);
  ...
  getTextEditChange(e) {
    if (qr.is(e)) {
      ...
      if (!n) {
        const r = [],
          s = { textDocument: t, edits: r };
        (this._workspaceEdit.documentChanges.push(s),
          (n = new js(r, this._changeAnnotations)),
  ...
  createFile(e, t, n) {
    ...
    let r;
    Ji.is(t) || Fe.is(t) ? (r = t) : (n = t);
    let s, o;
    if (
      (r === void 0
        ? (s = xn.create(e, n))
        : ((o = Fe.is(r) ? r : this._changeAnnotations.manage(r)),
          (s = xn.create(e, n, o))),
      this._workspaceEdit.documentChanges.push(s),
      o !== void 0)
    )
  ...
  renameFile(e, t, n, r) {
    if (
      ...
      throw new Error("Workspace edit is not configured for document changes.");
    let s;
    Ji.is(n) || Fe.is(n) ? (s = n) : (r = n);
    let o, l;
    if (
      (s === void 0
        ? (o = Mn.create(e, t, r))
        : ((l = Fe.is(s) ? s : this._changeAnnotations.manage(s)),
          (o = Mn.create(e, t, r, l))),
...
(function (i) {
  ...
  function t(n) {
    let r = n;
    return k.defined(r) && k.string(r.uri);
  }
  i.is = t;
})(xa || (xa = {}));
var Ma;
(function (i) {
  function e(n, r) {
    return { uri: n, version: r };
  }
  i.create = e;
  function t(n) {
    let r = n;
    return k.defined(r) && k.string(r.uri) && k.integer(r.version);
  }
  i.is = t;
})(Ma || (Ma = {}));
var qr;
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.defined(r) &&
      k.string(r.uri) &&
      (r.version === null || k.integer(r.version))
    );
  }
  i.is = t;
})(qr || (qr = {}));
...
(function (i) {
  function e(n, r, s, o) {
    return { uri: n, languageId: r, version: s, text: o };
  }
  i.create = e;
  function t(n) {
    let r = n;
...
(function (i) {
  function e(t) {
    const n = t;
    return k.objectLiteral(t) && Do.is(n.kind) && k.string(n.value);
  }
  i.is = e;
})(Tn || (Tn = {}));
var Ta;
...
(function (i) {
  function e(n, r, s) {
    return { newText: n, insert: r, replace: s };
  }
  i.create = e;
  function t(n) {
    const r = n;
    return r && k.string(r.newText) && ye.is(r.insert) && ye.is(r.replace);
  }
  i.is = t;
})(Pa || (Pa = {}));
var Oa;
...
(function (i) {
  function e(t) {
    ...
    return (
      n &&
      (k.string(n.detail) || n.detail === void 0) &&
      (k.string(n.description) || n.description === void 0)
    );
  }
  i.is = e;
})(Ea || (Ea = {}));
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.string(r) ||
      (k.objectLiteral(r) && k.string(r.language) && k.string(r.value))
    );
  }
  i.is = t;
})(Fr || (Fr = {}));
...
(function (i) {
  function e(t) {
    ...
    return (
      ...
      (Tn.is(n.contents) ||
        Fr.is(n.contents) ||
        k.typedArray(n.contents, Fr.is)) &&
      (t.range === void 0 || ye.is(t.range))
    );
  }
  i.is = e;
})(_a || (_a = {}));
...
(function (i) {
  function e(t, n) {
    return n ? { label: t, documentation: n } : { label: t };
  }
  i.create = e;
})(Ba || (Ba = {}));
var Ia;
(function (i) {
  function e(t, n, ...r) {
    let s = { label: t };
    return (
      k.defined(n) && (s.documentation = n),
      k.defined(r) ? (s.parameters = r) : (s.parameters = []),
      s
    );
  }
  i.create = e;
...
(function (i) {
  function e(t, n, r, s, o) {
    let l = { name: t, kind: n, location: { uri: s, range: r } };
...
(function (i) {
  function e(t, n, r, s) {
    return s !== void 0
      ? { name: t, kind: n, location: { uri: r, range: s } }
      : { name: t, kind: n, location: { uri: r } };
  }
  i.create = e;
})(Va || (Va = {}));
var za;
(function (i) {
  function e(n, r, s, o, l, a) {
    let c = { name: n, detail: r, kind: s, range: o, selectionRange: l };
  ...
  function t(n) {
    ...
    return (
      ...
      k.number(r.kind) &&
      ye.is(r.range) &&
      ye.is(r.selectionRange) &&
      (r.detail === void 0 || k.string(r.detail)) &&
      (r.deprecated === void 0 || k.boolean(r.deprecated)) &&
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.defined(r) &&
      k.typedArray(r.diagnostics, Br.is) &&
      (r.only === void 0 || k.typedArray(r.only, k.string)) &&
      (r.triggerKind === void 0 ||
        r.triggerKind === jr.Invoked ||
        r.triggerKind === jr.Automatic)
    );
  }
  i.is = t;
})(Ua || (Ua = {}));
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      r &&
      k.string(r.title) &&
      (r.diagnostics === void 0 || k.typedArray(r.diagnostics, Br.is)) &&
      (r.kind === void 0 || k.string(r.kind)) &&
      (r.edit !== void 0 || r.command !== void 0) &&
      (r.command === void 0 || tn.is(r.command)) &&
      (r.isPreferred === void 0 || k.boolean(r.isPreferred)) &&
      (r.edit === void 0 || Mo.is(r.edit))
    );
  }
  i.is = t;
})(Ka || (Ka = {}));
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.defined(r) &&
      ye.is(r.range) &&
      (k.undefined(r.command) || tn.is(r.command))
    );
  }
  i.is = t;
})(Ga || (Ga = {}));
...
(function (i) {
  function e(n, r) {
    return { tabSize: n, insertSpaces: r };
  }
  i.create = e;
  function t(n) {
    let r = n;
    return k.defined(r) && k.uinteger(r.tabSize) && k.boolean(r.insertSpaces);
  }
  i.is = t;
})(Ja || (Ja = {}));
var Ya;
(function (i) {
  function e(n, r, s) {
    return { range: n, target: r, data: s };
  }
  i.create = e;
  function t(n) {
    let r = n;
    return (
      k.defined(r) &&
      ye.is(r.range) &&
      (k.undefined(r.target) || k.string(r.target))
    );
  }
  i.is = t;
})(Ya || (Ya = {}));
...
(function (i) {
  ((i.namespace = "namespace"),
    ...
    (i.struct = "struct"),
    (i.typeParameter = "typeParameter"),
    (i.parameter = "parameter"),
    (i.variable = "variable"),
    (i.property = "property"),
    (i.enumMember = "enumMember"),
    (i.event = "event"),
    (i.function = "function"),
    (i.method = "method"),
    (i.macro = "macro"),
...
(function (i) {
  ...
  function t(n) {
    const r = n;
    return r != null && ye.is(r.range) && k.string(r.text);
  }
  i.is = t;
})(tc || (tc = {}));
var ic;
(function (i) {
  function e(n, r, s) {
    return { range: n, variableName: r, caseSensitiveLookup: s };
  }
  i.create = e;
  function t(n) {
    const r = n;
    return (
      r != null &&
      ye.is(r.range) &&
      k.boolean(r.caseSensitiveLookup) &&
      (k.string(r.variableName) || r.variableName === void 0)
    );
  }
  i.is = t;
})(ic || (ic = {}));
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      r != null &&
      ye.is(r.range) &&
      (k.string(r.expression) || r.expression === void 0)
    );
  }
  i.is = t;
})(nc || (nc = {}));
...
(function (i) {
  function e(n, r) {
    return { frameId: n, stoppedLocation: r };
  }
  i.create = e;
  function t(n) {
    const r = n;
    return k.defined(r) && ye.is(n.stoppedLocation);
  }
  i.is = t;
})(rc || (rc = {}));
var To;
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      k.objectLiteral(r) &&
      (r.tooltip === void 0 || k.string(r.tooltip) || Tn.is(r.tooltip)) &&
      (r.location === void 0 || _r.is(r.location)) &&
      (r.command === void 0 || tn.is(r.command))
    );
  }
  i.is = t;
...
(function (i) {
  ...
  function t(n) {
    ...
    return (
      (k.objectLiteral(r) &&
        dt.is(r.position) &&
        (k.string(r.label) || k.typedArray(r.label, Ro.is)) &&
        (r.kind === void 0 || To.is(r.kind)) &&
        r.textEdits === void 0) ||
      (k.typedArray(r.textEdits, Wt.is) &&
        (r.tooltip === void 0 || k.string(r.tooltip) || Tn.is(r.tooltip)) &&
        (r.paddingLeft === void 0 || k.boolean(r.paddingLeft)) &&
        (r.paddingRight === void 0 || k.boolean(r.paddingRight)))
    );
  }
  i.is = t;
})(sc || (sc = {}));
...
(function (i) {
  function e(t, n, r, s) {
    return { insertText: t, filterText: n, range: r, command: s };
  }
  i.create = e;
})(lc || (lc = {}));
var ac;
...
(function (i) {
  function e(t, n) {
    return { triggerKind: t, selectedCompletionInfo: n };
  }
  i.create = e;
})(uc || (uc = {}));
var fc;
(function (i) {
  function e(t) {
    const n = t;
    return k.objectLiteral(n) && ko.is(n.uri) && k.string(n.name);
  }
  i.is = e;
})(fc || (fc = {}));
const F1 = [
...
(function (i) {
  ...
  function t(s) {
    ...
    return !!(
      k.defined(o) &&
      k.string(o.uri) &&
      (k.undefined(o.languageId) || k.string(o.languageId)) &&
      k.uinteger(o.lineCount) &&
      k.func(o.getText) &&
      k.func(o.positionAt) &&
      k.func(o.offsetAt)
    );
  ...
  function n(s, o) {
    ...
    for (let h = a.length - 1; h >= 0; h--) {
      let u = a[h],
        f = s.offsetAt(u.range.start),
        d = s.offsetAt(u.range.end);
  ...
  function r(s, o) {
    ...
    let h = 0,
      u = 0,
      f = 0;
    for (; h < a.length && u < c.length; )
      o(a[h], c[u]) <= 0 ? (s[f++] = a[h++]) : (s[f++] = c[u++]);
...
` &&
  ...
  positionAt(e) {
    ...
    let t = this.getLineOffsets(),
      n = 0,
      r = t.length;
    if (r === 0) return dt.create(0, e);
    for (; n < r; ) {
      let o = Math.floor((n + r) / 2);
      t[o] > e ? (r = o) : (n = o + 1);
    }
    let s = n - 1;
    return dt.create(s, e - t[s]);
  }
  offsetAt(e) {
    let t = this.getLineOffsets();
...
(function (i) {
  ...
  function a(d) {
    return (
      e.call(d) === "[object Number]" && -2147483648 <= d && d <= 2147483647
    );
  }
  i.integer = a;
  function c(d) {
...
function ge() {
  ...
  var e;
  (function (l) {
    ((l.clientToServer = "clientToServer"),
      (l.serverToClient = "serverToClient"),
      (l.both = "both"));
  ...
  Je.RegistrationType = t;
  class n extends i.RequestType0 {
    constructor(a) {
      super(a);
    }
  }
  Je.ProtocolRequestType0 = n;
  class r extends i.RequestType {
    constructor(a) {
      super(a, i.ParameterStructures.byName);
    }
  }
  Je.ProtocolRequestType = r;
  class s extends i.NotificationType0 {
    constructor(a) {
      super(a);
    }
  }
  Je.ProtocolNotificationType0 = s;
  class o extends i.NotificationType {
    constructor(a) {
      super(a, i.ParameterStructures.byName);
    }
  }
  return ((Je.ProtocolNotificationType = o), Je);
}
var yl = {},
  ke = {},
  of;
function Qc() {
  ...
  ke.array = s;
  function o(c) {
    return s(c) && c.every((h) => e(h));
  }
  ke.stringArray = o;
  function l(c, h) {
    return Array.isArray(c) && c.every(h);
  }
  ke.typedArray = l;
  function a(c) {
    return c !== null && typeof c == "object";
  }
  return ((ke.objectLiteral = a), ke);
}
var Qn = {},
  lf;
function W1() {
  ...
  ((lf = 1),
    ...
    (Qn.ImplementationRequest = void 0));
  const i = ge();
  var e;
  return (
    (function (t) {
      ((t.method = "textDocument/implementation"),
        (t.messageDirection = i.MessageDirection.clientToServer),
        (t.type = new i.ProtocolRequestType(t.method)));
    })(e || (Qn.ImplementationRequest = e = {})),
    Qn
  );
}
var Zn = {},
...
function V1() {
  ...
  ((af = 1),
    ...
    (Zn.TypeDefinitionRequest = void 0));
  const i = ge();
  var e;
  return (
    (function (t) {
...
function z1() {
  ...
  ((cf = 1),
    ...
    (Fi.DidChangeWorkspaceFoldersNotification = Fi.WorkspaceFoldersRequest =
      void 0));
  const i = ge();
  var e;
  (function (n) {
    ((n.method = "workspace/workspaceFolders"),
      (n.messageDirection = i.MessageDirection.serverToClient),
      (n.type = new i.ProtocolRequestType0(n.method)));
  })(e || (Fi.WorkspaceFoldersRequest = e = {}));
  var t;
  return (
    (function (n) {
      ((n.method = "workspace/didChangeWorkspaceFolders"),
        (n.messageDirection = i.MessageDirection.clientToServer),
        (n.type = new i.ProtocolNotificationType(n.method)));
    })(t || (Fi.DidChangeWorkspaceFoldersNotification = t = {})),
    Fi
  );
}
var er = {},
...
function $1() {
  ...
  ((hf = 1),
    ...
    (er.ConfigurationRequest = void 0));
  const i = ge();
  var e;
  return (
    (function (t) {
      ((t.method = "workspace/configuration"),
        (t.messageDirection = i.MessageDirection.serverToClient),
        (t.type = new i.ProtocolRequestType(t.method)));
    })(e || (er.ConfigurationRequest = e = {})),
    er
  );
}
var ji = {},
...
function U1() {
  ...
  ((uf = 1),
    ...
    (ji.ColorPresentationRequest = ji.DocumentColorRequest = void 0));
  const i = ge();
  var e;
  (function (n) {
    ((n.method = "textDocument/documentColor"),
      (n.messageDirection = i.MessageDirection.clientToServer),
      (n.type = new i.ProtocolRequestType(n.method)));
  })(e || (ji.DocumentColorRequest = e = {}));
  var t;
  return (
    (function (n) {
      ((n.method = "textDocument/colorPresentation"),
        (n.messageDirection = i.MessageDirection.clientToServer),
        (n.type = new i.ProtocolRequestType(n.method)));
    })(t || (ji.ColorPresentationRequest = t = {})),
    ji
  );
}
var Hi = {},
...
function K1() {
  ...
  ((ff = 1),
    ...
    (Hi.FoldingRangeRefreshRequest = Hi.FoldingRangeRequest = void 0));
  const i = ge();
  var e;
  (function (n) {
  ...
  return (
    (function (n) {
      ((n.method = "workspace/foldingRange/refresh"),
        (n.messageDirection = i.MessageDirection.serverToClient),
        (n.type = new i.ProtocolRequestType0(n.method)));
    })(t || (Hi.FoldingRangeRefreshRequest = t = {})),
    Hi
  );
}
var tr = {},
...
function J1() {
  ...
  ((gf = 1),
    ...
    (ir.SelectionRangeRequest = void 0));
  const i = ge();
  var e;
  return (
    (function (t) {
...
function Y1() {
  ...
  ((mf = 1),
    ...
    (Zt.WorkDoneProgressCancelNotification =
      Zt.WorkDoneProgressCreateRequest =
      Zt.WorkDoneProgress =
        void 0));
  const i = On(),
    e = ge();
  var t;
  (function (s) {
    s.type = new i.ProgressType();
    function o(l) {
      return l === s.type;
    }
    s.is = o;
  })(t || (Zt.WorkDoneProgress = t = {}));
  var n;
  (function (s) {
  ...
  })(n || (Zt.WorkDoneProgressCreateRequest = n = {}));
  var r;
  return (
    (function (s) {
    ...
    })(r || (Zt.WorkDoneProgressCancelNotification = r = {})),
    Zt
  );
}
var ei = {},
...
function X1() {
  ...
  ((pf = 1),
    ...
    (ei.CallHierarchyOutgoingCallsRequest =
      ei.CallHierarchyIncomingCallsRequest =
      ei.CallHierarchyPrepareRequest =
        void 0));
  const i = ge();
  var e;
  (function (r) {
    ((r.method = "textDocument/prepareCallHierarchy"),
      (r.messageDirection = i.MessageDirection.clientToServer),
      (r.type = new i.ProtocolRequestType(r.method)));
  })(e || (ei.CallHierarchyPrepareRequest = e = {}));
  var t;
  (function (r) {
    ((r.method = "callHierarchy/incomingCalls"),
      (r.messageDirection = i.MessageDirection.clientToServer),
      (r.type = new i.ProtocolRequestType(r.method)));
  })(t || (ei.CallHierarchyIncomingCallsRequest = t = {}));
  var n;
  return (
    (function (r) {
      ((r.method = "callHierarchy/outgoingCalls"),
        (r.messageDirection = i.MessageDirection.clientToServer),
        (r.type = new i.ProtocolRequestType(r.method)));
    })(n || (ei.CallHierarchyOutgoingCallsRequest = n = {})),
    ei
  );
}
var Ye = {},
...
function Q1() {
  ...
  (function (l) {
    ((l.method = "textDocument/semanticTokens"),
      (l.type = new i.RegistrationType(l.method)));
  })(t || (Ye.SemanticTokensRegistrationType = t = {}));
  var n;
  (function (l) {
    ((l.method = "textDocument/semanticTokens/full"),
      (l.messageDirection = i.MessageDirection.clientToServer),
      (l.type = new i.ProtocolRequestType(l.method)),
      (l.registrationMethod = t.method));
  })(n || (Ye.SemanticTokensRequest = n = {}));
  var r;
  (function (l) {
    ((l.method = "textDocument/semanticTokens/full/delta"),
      ...
      (l.type = new i.ProtocolRequestType(l.method)),
      (l.registrationMethod = t.method));
  })(r || (Ye.SemanticTokensDeltaRequest = r = {}));
  var s;
  (function (l) {
  ...
  return (
    (function (l) {
      ((l.method = "workspace/semanticTokens/refresh"),
        (l.messageDirection = i.MessageDirection.serverToClient),
        (l.type = new i.ProtocolRequestType0(l.method)));
    })(o || (Ye.SemanticTokensRefreshRequest = o = {})),
    Ye
  );
}
var nr = {},
...
function eS() {
  ...
  ((vf = 1),
    ...
    (rr.LinkedEditingRangeRequest = void 0));
  const i = ge();
  var e;
  return (
    (function (t) {
      ((t.method = "textDocument/linkedEditingRange"),
        (t.messageDirection = i.MessageDirection.clientToServer),
        (t.type = new i.ProtocolRequestType(t.method)));
    })(e || (rr.LinkedEditingRangeRequest = e = {})),
    rr
  );
}
var _e = {},
...
function tS() {
  ...
  ((wf = 1),
    ...
    (_e.WillDeleteFilesRequest =
      _e.DidDeleteFilesNotification =
      _e.DidRenameFilesNotification =
      _e.WillRenameFilesRequest =
      _e.DidCreateFilesNotification =
      _e.WillCreateFilesRequest =
      _e.FileOperationPatternKind =
        void 0));
  const i = ge();
  var e;
  (function (a) {
    ((a.file = "file"), (a.folder = "folder"));
  })(e || (_e.FileOperationPatternKind = e = {}));
  var t;
  (function (a) {
    ((a.method = "workspace/willCreateFiles"),
      (a.messageDirection = i.MessageDirection.clientToServer),
      (a.type = new i.ProtocolRequestType(a.method)));
  })(t || (_e.WillCreateFilesRequest = t = {}));
  var n;
  (function (a) {
    ((a.method = "workspace/didCreateFiles"),
      (a.messageDirection = i.MessageDirection.clientToServer),
      (a.type = new i.ProtocolNotificationType(a.method)));
  })(n || (_e.DidCreateFilesNotification = n = {}));
  var r;
  (function (a) {
    ((a.method = "workspace/willRenameFiles"),
      (a.messageDirection = i.MessageDirection.clientToServer),
      (a.type = new i.ProtocolRequestType(a.method)));
  })(r || (_e.WillRenameFilesRequest = r = {}));
  var s;
  (function (a) {
    ((a.method = "workspace/didRenameFiles"),
      (a.messageDirection = i.MessageDirection.clientToServer),
      (a.type = new i.ProtocolNotificationType(a.method)));
  })(s || (_e.DidRenameFilesNotification = s = {}));
  var o;
  (function (a) {
    ((a.method = "workspace/didDeleteFiles"),
      (a.messageDirection = i.MessageDirection.clientToServer),
      (a.type = new i.ProtocolNotificationType(a.method)));
  })(o || (_e.DidDeleteFilesNotification = o = {}));
  var l;
  return (
    (function (a) {
      ((a.method = "workspace/willDeleteFiles"),
        (a.messageDirection = i.MessageDirection.clientToServer),
        (a.type = new i.ProtocolRequestType(a.method)));
    })(l || (_e.WillDeleteFilesRequest = l = {})),
    _e
  );
}
var ti = {},
...
function iS() {
  ...
  (function (r) {
    ((r.document = "document"),
      ...
      (r.scheme = "scheme"),
      (r.global = "global"));
  })(e || (ti.UniquenessLevel = e = {}));
  var t;
  (function (r) {
    ((r.$import = "import"), (r.$export = "export"), (r.local = "local"));
  })(t || (ti.MonikerKind = t = {}));
  var n;
  return (
    (function (r) {
      ((r.method = "textDocument/moniker"),
        (r.messageDirection = i.MessageDirection.clientToServer),
        (r.type = new i.ProtocolRequestType(r.method)));
    })(n || (ti.MonikerRequest = n = {})),
    ti
  );
}
var ii = {},
...
function nS() {
  ...
  ((kf = 1),
    Object.defineProperty(ii, "__esModule", { value: !0 }),
    (ii.TypeHierarchySubtypesRequest =
      ii.TypeHierarchySupertypesRequest =
      ii.TypeHierarchyPrepareRequest =
        void 0));
  const i = ge();
  var e;
  (function (r) {
    ((r.method = "textDocument/prepareTypeHierarchy"),
      (r.messageDirection = i.MessageDirection.clientToServer),
      (r.type = new i.ProtocolRequestType(r.method)));
  })(e || (ii.TypeHierarchyPrepareRequest = e = {}));
  var t;
  (function (r) {
    ((r.method = "typeHierarchy/supertypes"),
      (r.messageDirection = i.MessageDirection.clientToServer),
      (r.type = new i.ProtocolRequestType(r.method)));
  })(t || (ii.TypeHierarchySupertypesRequest = t = {}));
  var n;
  return (
    (function (r) {
      ((r.method = "typeHierarchy/subtypes"),
        (r.messageDirection = i.MessageDirection.clientToServer),
        (r.type = new i.ProtocolRequestType(r.method)));
    })(n || (ii.TypeHierarchySubtypesRequest = n = {})),
    ii
  );
}
var Wi = {},
...
function rS() {
  ...
  ((Cf = 1),
    ...
    (Wi.InlineValueRefreshRequest = Wi.InlineValueRequest = void 0));
  const i = ge();
  var e;
  (function (n) {
  ...
  return (
    (function (n) {
      ((n.method = "workspace/inlineValue/refresh"),
        (n.messageDirection = i.MessageDirection.serverToClient),
        (n.type = new i.ProtocolRequestType0(n.method)));
    })(t || (Wi.InlineValueRefreshRequest = t = {})),
    Wi
  );
}
var ni = {},
...
function sS() {
  ...
  var e;
  (function (r) {
    ((r.method = "textDocument/inlayHint"),
      (r.messageDirection = i.MessageDirection.clientToServer),
      (r.type = new i.ProtocolRequestType(r.method)));
  })(e || (ni.InlayHintRequest = e = {}));
  var t;
  (function (r) {
    ((r.method = "inlayHint/resolve"),
      (r.messageDirection = i.MessageDirection.clientToServer),
      (r.type = new i.ProtocolRequestType(r.method)));
  })(t || (ni.InlayHintResolveRequest = t = {}));
  var n;
  return (
    (function (r) {
      ((r.method = "workspace/inlayHint/refresh"),
        (r.messageDirection = i.MessageDirection.serverToClient),
        (r.type = new i.ProtocolRequestType0(r.method)));
    })(n || (ni.InlayHintRefreshRequest = n = {})),
    ni
  );
}
var lt = {},
...
function oS() {
  ...
  ((Mf = 1),
    ...
    (lt.DiagnosticRefreshRequest =
      lt.WorkspaceDiagnosticRequest =
      lt.DocumentDiagnosticRequest =
      lt.DocumentDiagnosticReportKind =
      lt.DiagnosticServerCancellationData =
        void 0));
  const i = On(),
    e = Qc(),
    t = ge();
  ...
  (function (a) {
    function c(h) {
      const u = h;
      return u && e.boolean(u.retriggerRequest);
    }
    a.is = c;
  })(n || (lt.DiagnosticServerCancellationData = n = {}));
  var r;
  (function (a) {
    ((a.Full = "full"), (a.Unchanged = "unchanged"));
  })(r || (lt.DocumentDiagnosticReportKind = r = {}));
  var s;
  (function (a) {
    ((a.method = "textDocument/diagnostic"),
      (a.messageDirection = t.MessageDirection.clientToServer),
      (a.type = new t.ProtocolRequestType(a.method)),
      (a.partialResult = new i.ProgressType()));
  })(s || (lt.DocumentDiagnosticRequest = s = {}));
  var o;
  (function (a) {
    ((a.method = "workspace/diagnostic"),
      (a.messageDirection = t.MessageDirection.clientToServer),
      (a.type = new t.ProtocolRequestType(a.method)),
      (a.partialResult = new i.ProgressType()));
  })(o || (lt.WorkspaceDiagnosticRequest = o = {}));
  var l;
  return (
    (function (a) {
      ((a.method = "workspace/diagnostic/refresh"),
        (a.messageDirection = t.MessageDirection.serverToClient),
        (a.type = new t.ProtocolRequestType0(a.method)));
    })(l || (lt.DiagnosticRefreshRequest = l = {})),
    lt
  );
}
var de = {},
...
function lS() {
  ...
  ((Df = 1),
    ...
    (de.DidCloseNotebookDocumentNotification =
      de.DidSaveNotebookDocumentNotification =
      de.DidChangeNotebookDocumentNotification =
      de.NotebookCellArrayChange =
      de.DidOpenNotebookDocumentNotification =
      de.NotebookDocumentSyncRegistrationType =
      de.NotebookDocument =
      de.NotebookCell =
      de.ExecutionSummary =
      de.NotebookCellKind =
  ...
  (function (d) {
    ...
    d.is = g;
  })(n || (de.NotebookCellKind = n = {}));
  var r;
  (function (d) {
    function g(v, S) {
      const C = { executionOrder: v };
    ...
    function p(v) {
      ...
      return (
        e.objectLiteral(S) &&
        i.uinteger.is(S.executionOrder) &&
        (S.success === void 0 || e.boolean(S.success))
      );
    }
    d.is = p;
    function b(v, S) {
      return v === S
        ? !0
        : v == null || S === null || S === void 0
          ? !1
          : v.executionOrder === S.executionOrder && v.success === S.success;
    }
    d.equals = b;
  })(r || (de.ExecutionSummary = r = {}));
  var s;
  (function (d) {
    function g(S, C) {
    ...
    function p(S) {
      ...
      return (
        e.objectLiteral(C) &&
        n.is(C.kind) &&
        i.DocumentUri.is(C.document) &&
        (C.metadata === void 0 || e.objectLiteral(C.metadata))
      );
    }
    d.is = p;
    function b(S, C) {
      const R = new Set();
      return (
        S.document !== C.document && R.add("document"),
        S.kind !== C.kind && R.add("kind"),
        S.executionSummary !== C.executionSummary && R.add("executionSummary"),
        (S.metadata !== void 0 || C.metadata !== void 0) &&
          !v(S.metadata, C.metadata) &&
          R.add("metadata"),
        (S.executionSummary !== void 0 || C.executionSummary !== void 0) &&
          !r.equals(S.executionSummary, C.executionSummary) &&
    ...
    function v(S, C) {
      ...
      if (R && D) {
        ...
        for (let T = 0; T < S.length; T++) if (!v(S[T], C[T])) return !1;
      }
      if (e.objectLiteral(S) && e.objectLiteral(C)) {
        const T = Object.keys(S),
          A = Object.keys(C);
        if (T.length !== A.length || (T.sort(), A.sort(), !v(T, A))) return !1;
        for (let V = 0; V < T.length; V++) {
          const U = T[V];
          if (!v(S[U], C[U])) return !1;
        }
      }
      return !0;
    }
  ...
  (function (d) {
    function g(b, v, S, C) {
      return { uri: b, notebookType: v, version: S, cells: C };
    }
    d.create = g;
    function p(b) {
      const v = b;
      return (
        e.objectLiteral(v) &&
        e.string(v.uri) &&
        i.integer.is(v.version) &&
        e.typedArray(v.cells, s.is)
      );
    }
    d.is = p;
  })(o || (de.NotebookDocument = o = {}));
  var l;
  (function (d) {
    ((d.method = "notebookDocument/sync"),
      (d.messageDirection = t.MessageDirection.clientToServer),
      (d.type = new t.RegistrationType(d.method)));
  })(l || (de.NotebookDocumentSyncRegistrationType = l = {}));
  var a;
  (function (d) {
    ((d.method = "notebookDocument/didOpen"),
      (d.messageDirection = t.MessageDirection.clientToServer),
      (d.type = new t.ProtocolNotificationType(d.method)),
      (d.registrationMethod = l.method));
  })(a || (de.DidOpenNotebookDocumentNotification = a = {}));
  var c;
  (function (d) {
    function g(b) {
      const v = b;
      return (
        e.objectLiteral(v) &&
        i.uinteger.is(v.start) &&
        i.uinteger.is(v.deleteCount) &&
        (v.cells === void 0 || e.typedArray(v.cells, s.is))
      );
    }
    d.is = g;
    function p(b, v, S) {
      const C = { start: b, deleteCount: v };
      return (S !== void 0 && (C.cells = S), C);
    }
    d.create = p;
  })(c || (de.NotebookCellArrayChange = c = {}));
  var h;
  (function (d) {
    ((d.method = "notebookDocument/didChange"),
      (d.messageDirection = t.MessageDirection.clientToServer),
      (d.type = new t.ProtocolNotificationType(d.method)),
      (d.registrationMethod = l.method));
  })(h || (de.DidChangeNotebookDocumentNotification = h = {}));
  var u;
  (function (d) {
    ((d.method = "notebookDocument/didSave"),
      (d.messageDirection = t.MessageDirection.clientToServer),
      (d.type = new t.ProtocolNotificationType(d.method)),
      (d.registrationMethod = l.method));
  })(u || (de.DidSaveNotebookDocumentNotification = u = {}));
  var f;
  return (
    (function (d) {
      ((d.method = "notebookDocument/didClose"),
        (d.messageDirection = t.MessageDirection.clientToServer),
        (d.type = new t.ProtocolNotificationType(d.method)),
        (d.registrationMethod = l.method));
    })(f || (de.DidCloseNotebookDocumentNotification = f = {})),
    de
  );
}
var sr = {},
...
function aS() {
  ...
  ((Tf = 1),
    ...
    (sr.InlineCompletionRequest = void 0));
  const i = ge();
  var e;
  return (
    (function (t) {
      ((t.method = "textDocument/inlineCompletion"),
        (t.messageDirection = i.MessageDirection.clientToServer),
        (t.type = new i.ProtocolRequestType(t.method)));
    })(e || (sr.InlineCompletionRequest = e = {})),
    sr
  );
}
var Rf;
function cS() {
  return (
    Rf ||
      ...
      (function (i) {
        (Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.WorkspaceSymbolRequest =
            i.CodeActionResolveRequest =
            i.CodeActionRequest =
            i.DocumentSymbolRequest =
            i.DocumentHighlightRequest =
            i.ReferencesRequest =
            i.DefinitionRequest =
            i.SignatureHelpRequest =
            i.SignatureHelpTriggerKind =
            i.HoverRequest =
            i.CompletionResolveRequest =
            i.CompletionRequest =
            i.CompletionTriggerKind =
            i.PublishDiagnosticsNotification =
            i.WatchKind =
            i.RelativePattern =
            i.FileChangeType =
            i.DidChangeWatchedFilesNotification =
            i.WillSaveTextDocumentWaitUntilRequest =
            i.WillSaveTextDocumentNotification =
            i.TextDocumentSaveReason =
            i.DidSaveTextDocumentNotification =
            i.DidCloseTextDocumentNotification =
            i.DidChangeTextDocumentNotification =
            i.TextDocumentContentChangeEvent =
            i.DidOpenTextDocumentNotification =
            i.TextDocumentSyncKind =
            i.TelemetryEventNotification =
            i.LogMessageNotification =
            i.ShowMessageRequest =
            i.ShowMessageNotification =
            i.MessageType =
            i.DidChangeConfigurationNotification =
            i.ExitNotification =
            i.ShutdownRequest =
            i.InitializedNotification =
            i.InitializeErrorCodes =
            i.InitializeRequest =
            i.WorkDoneProgressOptions =
            i.TextDocumentRegistrationOptions =
            i.StaticRegistrationOptions =
            i.PositionEncodingKind =
            i.FailureHandlingKind =
            i.ResourceOperationKind =
            i.UnregistrationRequest =
            i.RegistrationRequest =
            i.DocumentSelector =
            i.NotebookCellTextDocumentFilter =
            i.NotebookDocumentFilter =
            i.TextDocumentFilter =
              void 0),
          (i.MonikerRequest =
            i.MonikerKind =
            i.UniquenessLevel =
            i.WillDeleteFilesRequest =
            i.DidDeleteFilesNotification =
            i.WillRenameFilesRequest =
            i.DidRenameFilesNotification =
            i.WillCreateFilesRequest =
            i.DidCreateFilesNotification =
            i.FileOperationPatternKind =
            i.LinkedEditingRangeRequest =
            i.ShowDocumentRequest =
            i.SemanticTokensRegistrationType =
            i.SemanticTokensRefreshRequest =
            i.SemanticTokensRangeRequest =
            i.SemanticTokensDeltaRequest =
            i.SemanticTokensRequest =
            i.TokenFormat =
            i.CallHierarchyPrepareRequest =
            i.CallHierarchyOutgoingCallsRequest =
            i.CallHierarchyIncomingCallsRequest =
            i.WorkDoneProgressCancelNotification =
            i.WorkDoneProgressCreateRequest =
            i.WorkDoneProgress =
            i.SelectionRangeRequest =
            i.DeclarationRequest =
            i.FoldingRangeRefreshRequest =
            i.FoldingRangeRequest =
            i.ColorPresentationRequest =
            i.DocumentColorRequest =
            i.ConfigurationRequest =
            i.DidChangeWorkspaceFoldersNotification =
            i.WorkspaceFoldersRequest =
            i.TypeDefinitionRequest =
            i.ImplementationRequest =
            i.ApplyWorkspaceEditRequest =
            i.ExecuteCommandRequest =
            i.PrepareRenameRequest =
            i.RenameRequest =
            i.PrepareSupportDefaultBehavior =
            i.DocumentOnTypeFormattingRequest =
            i.DocumentRangesFormattingRequest =
            i.DocumentRangeFormattingRequest =
            i.DocumentFormattingRequest =
            i.DocumentLinkResolveRequest =
            i.DocumentLinkRequest =
            i.CodeLensRefreshRequest =
            i.CodeLensResolveRequest =
            i.CodeLensRequest =
            i.WorkspaceSymbolResolveRequest =
              void 0),
          (i.InlineCompletionRequest =
            i.DidCloseNotebookDocumentNotification =
            i.DidSaveNotebookDocumentNotification =
            i.DidChangeNotebookDocumentNotification =
            i.NotebookCellArrayChange =
            i.DidOpenNotebookDocumentNotification =
            i.NotebookDocumentSyncRegistrationType =
            i.NotebookDocument =
            i.NotebookCell =
            i.ExecutionSummary =
            i.NotebookCellKind =
            i.DiagnosticRefreshRequest =
            i.WorkspaceDiagnosticRequest =
            i.DocumentDiagnosticRequest =
            i.DocumentDiagnosticReportKind =
            i.DiagnosticServerCancellationData =
            i.InlayHintRefreshRequest =
            i.InlayHintResolveRequest =
            i.InlayHintRequest =
            i.InlineValueRefreshRequest =
            i.InlineValueRequest =
            i.TypeHierarchySupertypesRequest =
            i.TypeHierarchySubtypesRequest =
            i.TypeHierarchyPrepareRequest =
              void 0));
        const e = ge(),
          t = Xc,
          n = Qc(),
        ...
        Object.defineProperty(i, "InlineCompletionRequest", {
          enumerable: !0,
          get: function () {
            return V.InlineCompletionRequest;
          },
        });
        var U;
        (function (m) {
        ...
        (function (m) {
          function ve(we) {
            ...
            return (
              n.objectLiteral(K) &&
              (n.string(K.notebookType) ||
                n.string(K.scheme) ||
                n.string(K.pattern))
            );
          }
          m.is = ve;
        })(J || (i.NotebookDocumentFilter = J = {}));
        var W;
        (function (m) {
          function ve(we) {
            const K = we;
            return (
              n.objectLiteral(K) &&
              (n.string(K.notebook) || J.is(K.notebook)) &&
              (K.language === void 0 || n.string(K.language))
            );
          }
          m.is = ve;
        })(W || (i.NotebookCellTextDocumentFilter = W = {}));
        var P;
        (function (m) {
          function ve(we) {
            if (!Array.isArray(we)) return !1;
            for (let K of we)
              if (!n.string(K) && !U.is(K) && !W.is(K)) return !1;
            return !0;
          }
          m.is = ve;
        })(P || (i.DocumentSelector = P = {}));
        var w;
        (function (m) {
        ...
        })(w || (i.RegistrationRequest = w = {}));
        var O;
        (function (m) {
          ((m.method = "client/unregisterCapability"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(O || (i.UnregistrationRequest = O = {}));
        var B;
        (function (m) {
        ...
        (function (m) {
          ((m.Abort = "abort"),
            ...
            (m.Undo = "undo"));
        })(N || (i.FailureHandlingKind = N = {}));
        var z;
        (function (m) {
          ((m.UTF8 = "utf-8"), (m.UTF16 = "utf-16"), (m.UTF32 = "utf-32"));
        })(z || (i.PositionEncodingKind = z = {}));
        var Ke;
        (function (m) {
          function ve(we) {
            const K = we;
            return K && n.string(K.id) && K.id.length > 0;
          }
          m.hasId = ve;
        })(Ke || (i.StaticRegistrationOptions = Ke = {}));
        var me;
        (function (m) {
          function ve(we) {
            const K = we;
            return (
              K && (K.documentSelector === null || P.is(K.documentSelector))
            );
          }
          m.is = ve;
        })(me || (i.TextDocumentRegistrationOptions = me = {}));
        var Le;
        (function (m) {
          function ve(K) {
            const y = K;
            return (
              n.objectLiteral(y) &&
              (y.workDoneProgress === void 0 || n.boolean(y.workDoneProgress))
            );
          }
          m.is = ve;
          function we(K) {
            const y = K;
            return y && n.boolean(y.workDoneProgress);
          }
          m.hasWorkDoneProgress = we;
        })(Le || (i.WorkDoneProgressOptions = Le = {}));
        var Ae;
        (function (m) {
          ((m.method = "initialize"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(Ae || (i.InitializeRequest = Ae = {}));
        var be;
        (function (m) {
          m.unknownProtocolVersion = 1;
        })(be || (i.InitializeErrorCodes = be = {}));
        var Pe;
        (function (m) {
          ((m.method = "initialized"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(Pe || (i.InitializedNotification = Pe = {}));
        var He;
        (function (m) {
          ((m.method = "shutdown"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType0(m.method)));
        })(He || (i.ShutdownRequest = He = {}));
        var et;
        (function (m) {
          ((m.method = "exit"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType0(m.method)));
        })(et || (i.ExitNotification = et = {}));
        var ht;
        (function (m) {
          ((m.method = "workspace/didChangeConfiguration"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(ht || (i.DidChangeConfigurationNotification = ht = {}));
        var Kt;
        (function (m) {
          ((m.Error = 1),
            (m.Warning = 2),
        ...
        (function (m) {
          ((m.method = "window/showMessage"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(Tt || (i.ShowMessageNotification = Tt = {}));
        var Rt;
        (function (m) {
          ((m.method = "window/showMessageRequest"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(Rt || (i.ShowMessageRequest = Rt = {}));
        var Pi;
        (function (m) {
          ((m.method = "window/logMessage"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(Pi || (i.LogMessageNotification = Pi = {}));
        var ut;
        (function (m) {
          ((m.method = "telemetry/event"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(ut || (i.TelemetryEventNotification = ut = {}));
        var ie;
        (function (m) {
          ((m.None = 0), (m.Full = 1), (m.Incremental = 2));
        })(ie || (i.TextDocumentSyncKind = ie = {}));
        var At;
        (function (m) {
          ((m.method = "textDocument/didOpen"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(At || (i.DidOpenTextDocumentNotification = At = {}));
        var pe;
        (function (m) {
          function ve(K) {
            let y = K;
            return (
              ...
              y.range !== void 0 &&
              (y.rangeLength === void 0 || typeof y.rangeLength == "number")
            );
          }
          m.isIncremental = ve;
          function we(K) {
            ...
            return (
              ...
              typeof y.text == "string" &&
              y.range === void 0 &&
              y.rangeLength === void 0
            );
          }
          m.isFull = we;
        })(pe || (i.TextDocumentContentChangeEvent = pe = {}));
        var St;
        (function (m) {
          ((m.method = "textDocument/didChange"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(St || (i.DidChangeTextDocumentNotification = St = {}));
        var rn;
        (function (m) {
          ((m.method = "textDocument/didClose"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(rn || (i.DidCloseTextDocumentNotification = rn = {}));
        var En;
        (function (m) {
          ((m.method = "textDocument/didSave"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(En || (i.DidSaveTextDocumentNotification = En = {}));
        var Ln;
        (function (m) {
          ((m.Manual = 1), (m.AfterDelay = 2), (m.FocusOut = 3));
        })(Ln || (i.TextDocumentSaveReason = Ln = {}));
        var Nn;
        (function (m) {
          ((m.method = "textDocument/willSave"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(Nn || (i.WillSaveTextDocumentNotification = Nn = {}));
        var _n;
        (function (m) {
          ((m.method = "textDocument/willSaveWaitUntil"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(_n || (i.WillSaveTextDocumentWaitUntilRequest = _n = {}));
        var kt;
        (function (m) {
          ((m.method = "workspace/didChangeWatchedFiles"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(kt || (i.DidChangeWatchedFilesNotification = kt = {}));
        var Bn;
        (function (m) {
          ((m.Created = 1), (m.Changed = 2), (m.Deleted = 3));
        })(Bn || (i.FileChangeType = Bn = {}));
        var Yr;
        (function (m) {
          function ve(we) {
            const K = we;
            return (
              n.objectLiteral(K) &&
              (t.URI.is(K.baseUri) || t.WorkspaceFolder.is(K.baseUri)) &&
              n.string(K.pattern)
            );
          }
          m.is = ve;
        })(Yr || (i.RelativePattern = Yr = {}));
        var Xr;
        (function (m) {
        ...
        (function (m) {
          ((m.method = "textDocument/publishDiagnostics"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolNotificationType(m.method)));
        })(Qr || (i.PublishDiagnosticsNotification = Qr = {}));
        var Zr;
        (function (m) {
          ((m.Invoked = 1),
            (m.TriggerCharacter = 2),
            (m.TriggerForIncompleteCompletions = 3));
        })(Zr || (i.CompletionTriggerKind = Zr = {}));
        var In;
        (function (m) {
          ((m.method = "textDocument/completion"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(In || (i.CompletionRequest = In = {}));
        var qn;
        (function (m) {
          ((m.method = "completionItem/resolve"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(qn || (i.CompletionResolveRequest = qn = {}));
        var Gt;
        (function (m) {
          ((m.method = "textDocument/hover"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(Gt || (i.HoverRequest = Gt = {}));
        var Fn;
        (function (m) {
          ((m.Invoked = 1), (m.TriggerCharacter = 2), (m.ContentChange = 3));
        })(Fn || (i.SignatureHelpTriggerKind = Fn = {}));
        var es;
        (function (m) {
          ((m.method = "textDocument/signatureHelp"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(es || (i.SignatureHelpRequest = es = {}));
        var ts;
        (function (m) {
          ((m.method = "textDocument/definition"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(ts || (i.DefinitionRequest = ts = {}));
        var jn;
        (function (m) {
          ((m.method = "textDocument/references"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(jn || (i.ReferencesRequest = jn = {}));
        var Hn;
        (function (m) {
          ((m.method = "textDocument/documentHighlight"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(Hn || (i.DocumentHighlightRequest = Hn = {}));
        var is;
        (function (m) {
          ((m.method = "textDocument/documentSymbol"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(is || (i.DocumentSymbolRequest = is = {}));
        var ns;
        (function (m) {
          ((m.method = "textDocument/codeAction"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(ns || (i.CodeActionRequest = ns = {}));
        var rs;
        (function (m) {
          ((m.method = "codeAction/resolve"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(rs || (i.CodeActionResolveRequest = rs = {}));
        var ss;
        (function (m) {
          ((m.method = "workspace/symbol"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(ss || (i.WorkspaceSymbolRequest = ss = {}));
        var os;
        (function (m) {
          ((m.method = "workspaceSymbol/resolve"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(os || (i.WorkspaceSymbolResolveRequest = os = {}));
        var ls;
        (function (m) {
          ((m.method = "textDocument/codeLens"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(ls || (i.CodeLensRequest = ls = {}));
        var Ct;
        (function (m) {
          ((m.method = "codeLens/resolve"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(Ct || (i.CodeLensResolveRequest = Ct = {}));
        var as;
        (function (m) {
          ((m.method = "workspace/codeLens/refresh"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolRequestType0(m.method)));
        })(as || (i.CodeLensRefreshRequest = as = {}));
        var cs;
        (function (m) {
          ((m.method = "textDocument/documentLink"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(cs || (i.DocumentLinkRequest = cs = {}));
        var Oi;
        (function (m) {
          ((m.method = "documentLink/resolve"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(Oi || (i.DocumentLinkResolveRequest = Oi = {}));
        var hs;
        (function (m) {
          ((m.method = "textDocument/formatting"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(hs || (i.DocumentFormattingRequest = hs = {}));
        var sn;
        (function (m) {
          ((m.method = "textDocument/rangeFormatting"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(sn || (i.DocumentRangeFormattingRequest = sn = {}));
        var us;
        (function (m) {
          ((m.method = "textDocument/rangesFormatting"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(us || (i.DocumentRangesFormattingRequest = us = {}));
        var Jt;
        (function (m) {
          ((m.method = "textDocument/onTypeFormatting"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(Jt || (i.DocumentOnTypeFormattingRequest = Jt = {}));
        var fi;
        (function (m) {
          m.Identifier = 1;
        })(fi || (i.PrepareSupportDefaultBehavior = fi = {}));
        var fs;
        (function (m) {
          ((m.method = "textDocument/rename"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(fs || (i.RenameRequest = fs = {}));
        var ds;
        (function (m) {
          ((m.method = "textDocument/prepareRename"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(ds || (i.PrepareRenameRequest = ds = {}));
        var di;
        (function (m) {
          ((m.method = "workspace/executeCommand"),
            (m.messageDirection = e.MessageDirection.clientToServer),
            (m.type = new e.ProtocolRequestType(m.method)));
        })(di || (i.ExecuteCommandRequest = di = {}));
        var Wn;
        (function (m) {
          ((m.method = "workspace/applyEdit"),
            (m.messageDirection = e.MessageDirection.serverToClient),
            (m.type = new e.ProtocolRequestType("workspace/applyEdit")));
        })(Wn || (i.ApplyWorkspaceEditRequest = Wn = {}));
      })(yl)),
    yl
  );
}
...
function hS() {
  ...
  ((Af = 1),
    ...
    (or.createProtocolConnection = void 0));
  const i = On();
  function e(t, n, r, s) {
    return (
      i.ConnectionStrategy.is(s) && (s = { connectionStrategy: s }),
      (0, i.createMessageConnection)(t, n, r, s)
    );
  }
  return ((or.createProtocolConnection = e), or);
}
var Pf;
function uS() {
  return (
    Pf ||
      ...
      (function (i) {
        ...
        (Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.LSPErrorCodes = i.createProtocolConnection = void 0),
          t(On(), i),
          t(Xc, i),
          t(ge(), i),
          t(cS(), i));
...
const dS = Object.fromEntries(
    Object.entries(oi.CompletionItemKind).map(([i, e]) => [e, i]),
  ),
  Zc = (i) => i.reduce((e, t) => t, ""),
  Om = I.define({ combine: Zc }),
  Em = I.define({ combine: Zc }),
  Lm = I.define({ combine: Zc }),
  Nm = G.define({});
class gS {
  constructor(e, t) {
    ((this.id = 0),
    ...
    const { capabilities: e } = await this.request("initialize", {
      capabilities: {
        textDocument: {
          ...
          semanticTokens: {
            requests: {},
            tokenTypes: Object.values(oi.SemanticTokenTypes),
            tokenModifiers: [],
            formats: ["relative"],
            overlappingTokenSupport: !0,
          },
          hover: {
  ...
  async close() {
    (await this.request("shutdown", void 0), await this.notify("exit", void 0));
  }
  ...
  textDocumentHover(e) {
    return this.request("textDocument/hover", e);
  }
  textDocumentCompletion(e) {
    return this.request("textDocument/completion", e);
  }
  textDocumentFoldingRange(e) {
    return this.request("textDocument/foldingRange", e);
  }
  textDocumentSemanticTokensFull(e) {
    return this.request("textDocument/semanticTokens/full", e);
  }
  attachPlugin(e) {
    this.plugins.push(e);
  }
  ...
  async request(e, t) {
    ...
    (this.outboundRequests.set(n, { promise: o, resolve: r, reject: s }),
      this.sendMessage({ jsonrpc: "2.0", id: n, method: e, params: t }));
    const l = await o;
    return (this.outboundRequests.delete(n), l);
  }
  async notify(e, t) {
    await this.sendMessage({ jsonrpc: "2.0", method: e, params: t });
  }
  handleMessage(e) {
    if (e.method === "workspace/configuration") {
      const t = e.params;
      let n = [];
      for (const r of t.items)
        r.section === "zls.prefer_ast_check_as_child_process"
          ? n.push(!1)
          : n.push(null);
      this.sendMessage({ jsonrpc: "2.0", id: e.id, result: n });
      return;
    }
    if (e.id !== void 0 && e.method === void 0) {
      const t = this.outboundRequests.get(e.id);
      t
        ? e.error
          ? t.reject(e.error)
          : t.resolve(e.result)
    ...
    for (const t of this.plugins) t.handleMessage(e);
  }
  createPlugin(e, t, n) {
    let r = null;
    const s = Ee.define({
      ...
      update(o, l) {
        for (let a of l.effects) a.is(Nm) && (o = a.value);
        return o;
      },
      provide: (o) => q.decorations.from(o),
    });
    return [
      Om.of(this),
      Em.of(e),
      Lm.of(t),
      s.extension,
      xe.define((o) => (r = new mS(o, n)), {}),
      ig(
        (o, l) =>
          (r == null ? void 0 : r.requestHoverTooltip(o, Ef(o.state.doc, l))) ??
          null,
      ),
      gg.of((o, l, a) => {
        const c = o.doc.lineAt(l),
          h = r == null ? void 0 : r.foldingRangeMap.get(c.number - 1);
        if (h) {
          if (h.endLine > o.doc.lines) return null;
          const u = o.doc.line(h.endLine + 1);
          return {
            from: h.startCharacter != null ? l + h.startCharacter : c.to,
            to: h.endCharacter != null ? u.from + h.endCharacter : u.to,
          };
        }
        return null;
      }),
      km({
        override: [
          async (o) => {
            ...
            const { state: l, pos: a, explicit: c } = o,
              h = l.doc.lineAt(a);
            let u = oi.CompletionTriggerKind.Invoked,
              f;
            return (
              !c &&
                (p =
                  (g =
                    (d = r.client.capabilities) == null
                      ? void 0
                      : d.completionProvider) == null
                    ? void 0
                    : g.triggerCharacters) != null &&
                p.includes(h.text[a - h.from - 1]) &&
                ((u = oi.CompletionTriggerKind.TriggerCharacter),
                (f = h.text[a - h.from - 1])),
              u === oi.CompletionTriggerKind.Invoked && !o.matchBefore(/\w+$/)
                ? null
                : await r.requestCompletion(o, Ef(l.doc, a), {
                    triggerKind: u,
                    triggerCharacter: f,
                  })
            );
...
class mS {
  constructor(e, t) {
    ((this.view = e),
      (this.allowHtmlContent = t),
      (this.client = this.view.state.facet(Om)),
      (this.documentUri = this.view.state.facet(Em)),
      (this.languageId = this.view.state.facet(Lm)),
  ...
  update(e) {
    e.docChanged &&
      ...
      (async () => (
        await this.sendChange({ documentText: this.view.state.doc.toString() }),
  ...
  async initialize({ documentText: e }) {
    (this.client.initializePromise && (await this.client.initializePromise),
  ...
  async updateDecorations() {
    const e = await this.client.textDocumentSemanticTokensFull({
      textDocument: { uri: this.documentUri },
    });
    if (!e) return console.log("No semantic tokens!");
    const t = this.client.capabilities.semanticTokensProvider.legend.tokenTypes,
      n = this.client.capabilities.semanticTokensProvider.legend.tokenModifiers;
    let r = new Vt(),
      s = 0,
      o = 0;
    const l = e.data;
    for (let a = 0; a < l.length; a += 5) {
      const c = l[a],
        h = l[a + 1],
        u = l[a + 2],
        f = l[a + 3],
      ...
      let g = `st-${t[f]}`;
      {
        let b = d,
          v = 0;
        for (; b != 0; )
          (b & 1 && (g += ` sm-${n[v]}`), (b = b >> 1), (v += 1));
      }
      const p = this.view.state.doc.line(s + 1).from;
      r.add(p + o, p + o + u, $.mark({ class: g }));
    }
    ((this.decorations = r.finish()),
      this.view.dispatch({ effects: [Nm.of(this.decorations)] }));
  }
  async updateFoldingRanges() {
    const e = await this.client.textDocumentFoldingRange({
      textDocument: { uri: this.documentUri },
    });
    if ((this.foldingRangeMap.clear(), e))
      for (const t of e) this.foldingRangeMap.set(t.startLine, t);
  }
  async requestFormat(e) {
    const t = await this.client.request("textDocument/formatting", {
      options: { insertSpaces: !0, tabSize: 4 },
      textDocument: { uri: this.documentUri },
    });
    if ((this.foldingRangeMap.clear(), t)) {
      const n = this.view.state.doc;
      let r = [];
      for (const s of t)
        r.push({
          from: Vi(n, s.range.start),
          to: Vi(n, s.range.end),
          insert: s.newText,
        });
      r.length > 0 && this.view.dispatch({ changes: r });
    }
    await this.updateFoldingRanges();
  }
  async requestHoverTooltip(e, { line: t, character: n }) {
    if (!this.client.isOpen || !this.client.capabilities.hoverProvider)
      return null;
    const r = await this.client.textDocumentHover({
      textDocument: { uri: this.documentUri },
      position: { line: t, character: n },
    });
    if (!r) return null;
    const { contents: s, range: o } = r;
    let l = Vi(e.state.doc, { line: t, character: n }),
      a = l;
    return (
      o && ((l = Vi(e.state.doc, o.start)), (a = Vi(e.state.doc, o.end) ?? a)),
      l === null
        ? null
        : {
            pos: l,
            ...
            create() {
              ...
              return ((c.textContent = gc(s)), { dom: c });
            },
            above: !0,
          }
    );
  ...
  async requestCompletion(
    e,
    { line: t, character: n },
    { triggerKind: r, triggerCharacter: s },
  ) {
    if (!this.client.isOpen || !this.client.capabilities.completionProvider)
      return null;
    this.sendChange({ documentText: e.state.doc.toString() });
    const o = await this.client.textDocumentCompletion({
      textDocument: { uri: this.documentUri },
      position: { line: t, character: n },
      context: { triggerKind: r, triggerCharacter: s },
    });
    if (!o) return null;
    let a = ("items" in o ? o.items : o).map(
      ({
        detail: d,
        label: g,
        kind: p,
        ...
        const R = {
          label: g,
          detail: d,
          apply: (b == null ? void 0 : b.newText) ?? g,
          type: p && dS[p].toLowerCase(),
          sortText: S ?? g,
          filterText: C ?? g,
        };
        return (v && (R.info = gc(v)), R);
      },
    );
    const [c, h] = pS(a),
      u = e.matchBefore(h);
    ...
    if (u) {
      ...
      /^\w+$/.test(d) &&
        (a = a
          .filter(({ filterText: g }) => g.toLowerCase().startsWith(d))
          .sort(({ apply: g }, { apply: p }) => {
            switch (!0) {
              case g.startsWith(u.text) && !p.startsWith(u.text):
                return -1;
              case !g.startsWith(u.text) && p.startsWith(u.text):
                return 1;
            }
    ...
    return { from: f, options: a };
  }
  handleMessage(e) {
    try {
      switch (e.method) {
        case "textDocument/publishDiagnostics":
          this.handleDiagnostics(e.params);
          break;
      }
    } catch (t) {
      console.error(t);
  ...
  handleDiagnostics(e) {
    ...
    const t = e.diagnostics
      .map(({ range: n, message: r, severity: s }) => ({
        from: Vi(this.view.state.doc, n.start),
        to: Vi(this.view.state.doc, n.end),
        severity: {
          [oi.DiagnosticSeverity.Error]: "error",
          [oi.DiagnosticSeverity.Warning]: "warning",
          [oi.DiagnosticSeverity.Information]: "info",
          [oi.DiagnosticSeverity.Hint]: "info",
        }[s],
        message: r,
      }))
      .filter(
        ({ from: n, to: r }) =>
          n !== null && r !== null && n !== void 0 && r !== void 0,
      )
      .sort((n, r) => {
        switch (!0) {
          case n.from < r.from:
    ...
    this.view.dispatch(p1(this.view.state, t));
  }
}
function Vi(i, e) {
...
function Ef(i, e) {
  const t = i.lineAt(e);
  return { line: t.number - 1, character: e - t.from };
}
function gc(i) {
...
const yS = q.theme(
  {
    ...
    "&.cm-focused .cm-matchingBracket": { backgroundColor: "#FFFFFF30" },
...
function bS(i) {
  return new Worker("/assets/zls-SS2g02cn.js", {
    name: i == null ? void 0 : i.name,
  });
}
function vS(i) {
  return new Worker("/assets/zig-xEFKY47a.js", {
    name: i == null ? void 0 : i.name,
  });
}
function wS(i) {
  return new Worker("/assets/runner-DTHaRc0a.js", {
    name: i == null ? void 0 : i.name,
  });
}
const SS = `const std = @import("std");
...
class kS extends gS {
        ...
        if (n.method == "window/logMessage") {
          if (!n.stderr)
            switch (n.params.type) {
              case 5:
                console.debug("ZLS --- ", n.params.message);
                break;
              case 4:
                console.log("ZLS --- ", n.params.message);
                break;
              case 3:
                console.info("ZLS --- ", n.params.message);
                break;
              case 2:
                console.warn("ZLS --- ", n.params.message);
                break;
              case 1:
                console.error("ZLS --- ", n.params.message);
                break;
              default:
                console.error(n.params.message);
                break;
            }
        } else console.debug("LSP <<-", n);
  ...
  async close() {
    (super.close(), this.worker.terminate());
  }
}
let Hs = new kS(new bS()),
  CS = (async () => {
    await Hs.initialize();
    let i = new q({
      extensions: [],
      ...
      state: Q.create({
        ...
        extensions: [
          ...
          yS,
          No.of("    "),
          Hs.createPlugin("file:///main.zig", "zig", !0),
          Vr.of([tw]),
        ],
      }),
    });
    return (
      await Hs.plugins[0].updateDecorations(),
      await Hs.plugins[0].updateFoldingRanges(),
      i.update([]),
      i
    );
  })();
function mc() {
  ...
  (i.scrollTo(0, i.scrollHeight),
    parseFloat(ai.style.getPropertyValue("--editor-height-percent")) == 100 &&
      ai.style.setProperty("--editor-height-percent", `${pc}%`));
}
let _m = new vS();
_m.onmessage = (i) => {
  if (i.data.stderr) {
    ((document.querySelector(".zig-output:last-child").textContent +=
      i.data.stderr),
      mc());
    return;
  } else if (i.data.failed) {
    const e = document.createElement("div");
    (e.classList.add("output-split"),
      document.getElementById("output").appendChild(e));
  } else if (i.data.compiled) {
    let e = new wS();
    const t = document.createElement("div");
    (t.classList.add("runner-output"),
      t.classList.add("latest"),
      document.getElementById("output").appendChild(t),
      e.postMessage({ run: i.data.compiled }),
      (e.onmessage = (n) => {
        if (n.data.stderr) {
          ((document.querySelector(".runner-output:last-child").textContent +=
            n.data.stderr),
            mc());
          return;
        } else if (n.data.done) {
          ...
          (r.classList.add("output-split"),
            document.getElementById("output").appendChild(r));
        }
      }));
  }
};
const ai = document.getElementById("split-pane"),
  Bm = document.getElementById("resize-bar");
let pc = 70,
  eh = !1;
Bm.addEventListener("mousedown", (i) => {
  i.buttons & 1 &&
    ((eh = !0),
...
window.addEventListener("mousemove", (i) => {
  if (eh) {
    const e = Math.min(
      Math.max(10, (i.clientY / ai.getBoundingClientRect().height) * 100),
      100,
    );
    ai.style.setProperty("--editor-height-percent", `${e}%`);
  }
});
window.addEventListener("mouseup", (i) => {
  ((eh = !1),
    ...
    parseFloat(ai.style.getPropertyValue("--editor-height-percent")) >= 90 &&
      ai.style.setProperty("--editor-height-percent", "100%"));
});
Bm.addEventListener("dblclick", (i) => {
  const e = parseFloat(ai.style.getPropertyValue("--editor-height-percent"));
  e == 100
    ? ai.style.setProperty("--editor-height-percent", `${pc}%`)
    : ((pc = e), ai.style.setProperty("--editor-height-percent", "100%"));
});
const xS = document.getElementById("run");
xS.addEventListener("click", async () => {
  for (const e of document.querySelectorAll(".zig-output"))
    e.classList.remove("latest");
  for (const e of document.querySelectorAll(".runner-output"))
    e.classList.remove("latest");
  const i = document.createElement("div");
  (i.classList.add("zig-output"),
    i.classList.add("latest"),
    document.getElementById("output").appendChild(i),
    mc(),
    _m.postMessage({ run: (await CS).state.doc.toString() }));
});
