(function () {
  ...
  class U {
    ...
    static read_bytes_array(e, r, s) {
      const u = [];
      for (let t = 0; t < s; t++) u.push(U.read_bytes(e, r + 8 * t));
      return u;
    }
  }
  const $ = 0,
  ...
  class F {
    static dir(e) {
      const r = new F();
      return ((r.tag = re), (r.inner = new ne(e)), r);
    }
    write_bytes(e, r) {
  ...
  let se = class {
    enable(e) {
      this.log = ie(e === void 0 ? !0 : e, this.prefix);
    }
    get enabled() {
  ...
  let fe = class {
    start(e) {
      ...
      try {
        ...
        if (r instanceof W) return r.code;
        throw r;
      }
    }
    initialize(e) {
      ...
      this.wasiImport = {
        ...
        fd_pwrite(n, i, f, a, o) {
          const l = new DataView(t.inst.exports.memory.buffer),
            d = new Uint8Array(t.inst.exports.memory.buffer);
          if (t.fds[n] != null) {
            const c = U.read_bytes_array(l, i, f);
            let R = 0;
            for (const _ of c) {
        ...
        fd_write(n, i, f, a) {
          const o = new DataView(t.inst.exports.memory.buffer),
            l = new Uint8Array(t.inst.exports.memory.buffer);
          if (t.fds[n] != null) {
            const d = U.read_bytes_array(o, i, f);
            let c = 0;
            for (const R of d) {
        ...
        path_open(n, i, f, a, o, l, d, c, R) {
          ...
          if (t.fds[n] != null) {
            ...
            g.log(y);
            const { ret: b, fd_obj: de } = t.fds[n].path_open(i, y, o, l, d, c);
            if (b != 0) return b;
            t.fds.push(de);
            const ce = t.fds.length - 1;
            return (_.setUint32(R, ce, !0), 0);
          } else return 8;
        },
  ...
  class G extends T {
    ...
    fd_readdir_single(e) {
      if (
        ...
        return { ret: 0, dirent: new B(1n, this.dir.ino, ".", E) };
      if (e == 1n)
        return { ret: 0, dirent: new B(2n, this.dir.parent_ino(), "..", E) };
      if (e >= BigInt(this.dir.contents.size) + 2n)
        return { ret: 0, dirent: null };
      const [r, s] = Array.from(this.dir.contents.entries())[Number(e - 2n)];
      return { ret: 0, dirent: new B(e + 1n, s.ino, r, s.stat().filetype) };
    }
    path_filestat_get(e, r) {
    ...
    path_open(e, r, s, u, t, n) {
      ...
      } else if ((s & j) == j) return { ret: 20, fd_obj: null };
      return (s & D) == D && o.stat().filetype !== E
        ? { ret: 54, fd_obj: null }
        : o.path_open(s, u, n);
    }
    path_create_directory(e) {
      return this.path_open(0, e, C | D, 0n, 0n, 0).ret;
    }
    path_link(e, r, s) {
      ...
      if (a != null) {
        ...
        if (o && l)
          ...
          if (o && !l) return 54;
          if (!o && l) return 31;
          if (!(r.stat().filetype == A && a.stat().filetype == A)) return 20;
        }
      }
  ...
  class k extends G {
    fd_prestat_get() {
      return { ret: 0, prestat: F.dir(this.prestat_name) };
    }
    constructor(e, r) {
  ...
  class Y extends w {
    path_open(e, r, s) {
      ...
      const u = new ae(this);
      return (s & te && u.fd_seek(0n, z), { ret: 0, fd_obj: u });
    }
    get size() {
      return BigInt(this.data.byteLength);
    }
    stat() {
      return new I(this.ino, A, this.size);
    }
    constructor(e, r) {
      (super(),
  ...
  class N extends w {
    parent_ino() {
      return this.parent == null ? w.root_ino() : this.parent.ino;
    }
    path_open(e, r, s) {
      return { ret: 0, fd_obj: new G(this) };
    }
    stat() {
      return new I(this.ino, E, 0n);
    }
    ...
    create_entry_for_path(e, r) {
      ...
      let a;
      return (
        r ? (a = new N(new Map())) : (a = new Y(new ArrayBuffer(0))),
        n.contents.set(i, a),
        (f = a),
        { ret: 0, entry: f }
      );
  ...
  class L extends T {
    fd_filestat_get() {
      return { ret: 0, filestat: new I(this.ino, V, BigInt(0)) };
    }
    fd_fdstat_get() {
      const e = new x(V, 0);
...
`);
    ...
    constructor(e) {
      (super(), (this.ino = w.issue_ino()), (this.write = e));
    }
  }
  var P = {},
    M,
  ...
  async function _e() {
    let e = await (
      await fetch(new URL("/assets/zig.tar-D7puyUkM.gz", self.location.href))
    ).arrayBuffer();
    ...
    for (const t of s) {
      ...
      for (const a of i.slice(0, -1))
        (f.has(a) || f.set(a, new Map()), (f = f.get(a)));
  ...
  function X(h) {
    return new N(
      [...h.entries()].map(([e, r]) =>
        r instanceof Uint8Array ? [e, new Y(r)] : [e, X(r)],
      ),
    );
  }
  class q extends T {
  ...
  let O,
    J = [];
  function Z(h) {
    const e = new TextEncoder().encode(h),
      r = O.exports.allocMessage(e.length);
    (new Uint8Array(O.exports.memory.buffer).set(e, r), O.exports.call());
    const s = O.exports.outputMessageCount();
    for (let u = 0; u < s; u++) {
      const t = O.exports.outputMessagePtr(u),
        n = t + O.exports.outputMessageLen(u),
        i = new Uint8Array(O.exports.memory.buffer).slice(t, n);
      postMessage(new TextDecoder().decode(i));
    }
  }
  ((onmessage = (h) => {
    O ? Z(h.data) : J.push(h.data);
  }),
    (async () => {
      let h = await _e(),
        e = ["zls.wasm"],
        ...
        s = [
          new q(),
          new q(),
          L.lineBuffered((n) => postMessage(JSON.stringify({ stderr: n }))),
          new k(".", new Map([])),
          new k("/lib", h.contents),
          new k("/cache", new Map()),
        ],
        u = new fe(e, r, s, { debug: !1 });
      const { instance: t } = await WebAssembly.instantiateStreaming(
        fetch(new URL("/assets/zls-qgOk9fV4.wasm", self.location.href)),
        { wasi_snapshot_preview1: u.wasiImport },
      );
      ((u.inst = t), t.exports.createServer(), (O = t));
      for (const n of J) Z(n);
    })());
})();
