(function () {
      ...
      this.wasiImport = {
        ...
        path_open(n, i, f, a, o, l, d, c, R) {
          ...
          if (t.fds[n] != null) {
            ...
            g.log(y);
            const { ret: w, fd_obj: _e } = t.fds[n].path_open(i, y, o, l, d, c);
            if (w != 0) return w;
            t.fds.push(_e);
  ...
  class H extends F {
    ...
    path_open(e, r, s, u, t, n) {
      ...
      } else if ((s & v) == v) return { ret: 20, fd_obj: null };
      return (s & U) == U && o.stat().filetype !== E
        ? { ret: 54, fd_obj: null }
        : o.path_open(s, u, n);
    }
    path_create_directory(e) {
  ...
  class D extends O {
    path_open(e, r, s) {
      ...
      const u = new Y(this);
      return (s & ee && u.fd_seek(0n, V), { ret: 0, fd_obj: u });
    }
    get size() {
      return BigInt(this.data.byteLength);
    }
    stat() {
      return new x(this.ino, A, this.size);
    }
    constructor(e, r) {
      (super(),
  ...
  class N extends O {
    ...
    create_entry_for_path(e, r) {
      ...
      let a;
      return (
        r ? (a = new N(new Map())) : (a = new D(new ArrayBuffer(0))),
        n.contents.set(i, a),
        (f = a),
        { ret: 0, entry: f }
      );
...
`);
  ...
  async function ue() {
    let e = await (
      await fetch(new URL("./zig.tar-D7puyUkM.gz", self.location.href))
    ).arrayBuffer();
  ...
  function q(h) {
    return new N(
      [...h.entries()].map(([e, r]) =>
        r instanceof Uint8Array ? [e, new D(r)] : [e, q(r)],
      ),
    );
  }
  function Z() {
  ...
  async function le(h) {
    ...
    const e = await ue(),
      r = await fetch(
        new URL("./libcompiler_rt-BdDvk7bF.a", self.location.href),
      );
    let s = [
        "zig.wasm",
        "build-exe",
      ...
      t = [
        ...
        new k(
          ".",
          new Map([
            ["main.zig", new D(new TextEncoder().encode(h))],
            ["libcompiler_rt.a", new D(await r.arrayBuffer())],
          ]),
        ),
        new k("/lib", e.contents),
        new k("/cache", new Map()),
      ],
      n = new ie(s, u, t, { debug: !1 });
    const { instance: i } = await WebAssembly.instantiateStreaming(
      fetch(new URL("./zig-DoiPW68L.wasm", self.location.href)),
      { wasi_snapshot_preview1: n.wasiImport },
    );
    postMessage({
      stderr: `Compiling...
`,
    ...
    try {
      if (n.start(i) == 0) {
        const o = n.fds[3].dir.contents.get("main.wasm");
        o && postMessage({ compiled: o.data });
      }
    } catch (f) {
      (postMessage({ stderr: `${f}` }), postMessage({ failed: !0 }));
    }
    M = !1;
  }
  onmessage = (h) => {
